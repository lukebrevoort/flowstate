    ...
    def parse_io(data: Any, default_key: str = "output") -> dict:
        ...
        if isinstance(data, dict):
            ...
            try:
                ...
                data_ = {default_key: data}
        elif data is not None and hasattr(data, "model_dump") and callable(data.model_dump) and not isinstance(data, type):
            try:
        ...
        if span_data.response is not None:
            ...
            if usage := response.pop("usage", None):
                ...
                if "output_tokens_details" in usage:
                    ...
                    usage["output_token_details"]["reasoning"] = usage["output_token_details"].pop("reasoning_tokens", 0)
                if "input_tokens_details" in usage:
                    usage["input_token_details"] = usage.pop("input_tokens_details")
                    usage["input_token_details"]["cache_read"] = usage["input_token_details"].pop("cached_tokens", 0)
