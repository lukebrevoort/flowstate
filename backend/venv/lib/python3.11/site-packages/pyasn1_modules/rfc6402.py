...
ChangeSubjectName.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType("subject", rfc5280.Name()), namedtype.OptionalNamedType("subjectAlt", rfc5280.GeneralNames())
)
...
CMCStatus.namedValues = namedval.NamedValues(
    ("success", 0), ("failed", 2), ("pending", 3), ("noSupport", 4), ("confirmRequired", 5), ("popRequired", 6), ("partial", 7)
)
...
PendInfo.componentType = namedtype.NamedTypes(
    namedtype.NamedType("pendToken", univ.OctetString()), namedtype.NamedType("pendTime", useful.GeneralizedTime())
)
...
BodyPartReference.componentType = namedtype.NamedTypes(
    namedtype.NamedType("bodyPartID", BodyPartID()), namedtype.NamedType("bodyPartPath", BodyPartPath())
)
...
TaggedCertificationRequest.componentType = namedtype.NamedTypes(
    namedtype.NamedType("bodyPartID", BodyPartID()), namedtype.NamedType("certificationRequest", CertificationRequest())
)
...
TaggedRequest.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "tcr", TaggedCertificationRequest().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0))
    ),
...
TaggedContentInfo.componentType = namedtype.NamedTypes(
    namedtype.NamedType("bodyPartID", BodyPartID()), namedtype.NamedType("contentInfo", rfc5652.ContentInfo())
)
...
CMCStatusInfo.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        ...
        univ.Choice(
            componentType=namedtype.NamedTypes(
                namedtype.NamedType("failInfo", CMCFailInfo()), namedtype.NamedType("pendInfo", PendInfo())
            )
        ),
    ),
)
...
GetCert.componentType = namedtype.NamedTypes(
    namedtype.NamedType("issuerName", rfc5280.GeneralName()), namedtype.NamedType("serialNumber", univ.Integer())
)
