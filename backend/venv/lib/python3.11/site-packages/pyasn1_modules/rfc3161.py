...
MessageImprint.componentType = namedtype.NamedTypes(
    namedtype.NamedType("hashAlgorithm", AlgorithmIdentifier()), namedtype.NamedType("hashedMessage", univ.OctetString())
)
...
TSTInfo.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "tsa", GeneralName().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
    ),
    namedtype.OptionalNamedType(
        "extensions", Extensions().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
)
...
TimeStampReq.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "extensions", Extensions().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
    ),
)
...
TimeStampResp.componentType = namedtype.NamedTypes(
    namedtype.NamedType("status", PKIStatusInfo()), namedtype.OptionalNamedType("timeStampToken", TimeStampToken())
)
