...
TerminalType.namedValues = namedval.NamedValues(
    ("telex", 3), ("teletex", 4), ("g3-facsimile", 5), ("g4-facsimile", 6), ("ia5-terminal", 7), ("videotex", 8)
)
...
UnformattedPostalAddress.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "teletex-string",
        char.TeletexString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_unformatted_address_length)),
    ),
)
...
X520OrganizationName.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "teletexString", char.TeletexString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_organization_name))
    ),
    namedtype.NamedType(
        "printableString", char.PrintableString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_organization_name))
    ),
    namedtype.NamedType(
        "universalString", char.UniversalString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_organization_name))
    ),
    namedtype.NamedType(
        "utf8String", char.UTF8String().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_organization_name))
    ),
    namedtype.NamedType(
        "bmpString", char.BMPString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_organization_name))
    ),
)
...
PostalCode.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "numeric-code", char.NumericString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_postal_code_length))
    ),
    namedtype.NamedType(
        "printable-code", char.PrintableString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_postal_code_length))
    ),
)
...
PDSParameter.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType(
        "printable-string",
        char.PrintableString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_pds_parameter_length)),
    ),
    namedtype.OptionalNamedType(
        "teletex-string", char.TeletexString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_pds_parameter_length))
    ),
)
...
TeletexDomainDefinedAttribute.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "type",
        char.TeletexString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_domain_defined_attribute_type_length)),
    ),
    namedtype.NamedType(
        "value",
        char.TeletexString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_domain_defined_attribute_value_length)),
    ),
)
...
X520LocalityName.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "teletexString", char.TeletexString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_locality_name))
    ),
    namedtype.NamedType(
        "printableString", char.PrintableString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_locality_name))
    ),
    namedtype.NamedType(
        "universalString", char.UniversalString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_locality_name))
    ),
    namedtype.NamedType(
        "utf8String", char.UTF8String().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_locality_name))
    ),
    namedtype.NamedType(
        "bmpString", char.BMPString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_locality_name))
    ),
)
...
PersonalName.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        ...
        char.PrintableString()
        .subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_generation_qualifier_length))
...
class AlgorithmIdentifier(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.OptionalNamedType("parameters", univ.Any(), openType=opentype.OpenType("algorithm", algorithmIdentifierMap)),
    )
...
Time.componentType = namedtype.NamedTypes(
    namedtype.NamedType("utcTime", useful.UTCTime()), namedtype.NamedType("generalTime", useful.GeneralizedTime())
)
...
class AttributeTypeAndValue(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType("value", AttributeValue(), openType=opentype.OpenType("type", certificateAttributesMap)),
    )
...
class ExtensionAttribute(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType(
            ...
            univ.Integer()
            .subtype(subtypeSpec=constraint.ValueRangeConstraint(0, ub_extension_attributes))
            .subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0)),
        ),
        namedtype.NamedType(
...
SubjectPublicKeyInfo.componentType = namedtype.NamedTypes(
    namedtype.NamedType("algorithm", AlgorithmIdentifier()), namedtype.NamedType("subjectPublicKey", univ.BitString())
)
...
TBSCertificate.componentType = namedtype.NamedTypes(
    namedtype.DefaultedNamedType(
        "version", Version().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0)).subtype(value="v1")
    ),
    ...
    namedtype.OptionalNamedType(
        "issuerUniqueID", UniqueIdentifier().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
    namedtype.OptionalNamedType(
        "subjectUniqueID", UniqueIdentifier().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2))
    ),
    namedtype.OptionalNamedType(
...
X520name.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "printableString", char.PrintableString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_name))
    ),
    namedtype.NamedType(
        "universalString", char.UniversalString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_name))
    ),
...
X520Pseudonym.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "teletexString", char.TeletexString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_pseudonym))
    ),
    namedtype.NamedType(
        "printableString", char.PrintableString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_pseudonym))
    ),
    namedtype.NamedType(
        "universalString", char.UniversalString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_pseudonym))
    ),
...
AdministrationDomainName.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "numeric", char.NumericString().subtype(subtypeSpec=constraint.ValueSizeConstraint(0, ub_domain_name_length))
    ),
    namedtype.NamedType(
        "printable", char.PrintableString().subtype(subtypeSpec=constraint.ValueSizeConstraint(0, ub_domain_name_length))
    ),
)
...
PresentationAddress.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType(
        "pSelector", univ.OctetString().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
    ),
    namedtype.OptionalNamedType(
        "sSelector", univ.OctetString().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
    namedtype.OptionalNamedType(
        "tSelector", univ.OctetString().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2))
    ),
    namedtype.NamedType(
        "nAddresses",
        univ.SetOf(componentType=univ.OctetString()).subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 3)),
    ),
)
...
ExtendedNetworkAddress.componentType = namedtype.NamedTypes(
        ...
        univ.Sequence(
            componentType=namedtype.NamedTypes(
                namedtype.NamedType(
                    "number",
                    char.NumericString()
                    .subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_e163_4_number_length))
                    .subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0)),
                ),
                namedtype.OptionalNamedType(
                    "sub-address",
                    char.NumericString()
                    .subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_e163_4_sub_address_length))
                    .subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1)),
                ),
            )
        ),
    ...
    namedtype.NamedType(
        "psap-address", PresentationAddress().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0))
    ),
)
...
X520OrganizationalUnitName.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "teletexString",
        char.TeletexString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_organizational_unit_name)),
    ),
    namedtype.NamedType(
        "printableString",
        char.PrintableString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_organizational_unit_name)),
    ),
    namedtype.NamedType(
        "universalString",
        char.UniversalString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_organizational_unit_name)),
    ),
    namedtype.NamedType(
        "utf8String", char.UTF8String().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_organizational_unit_name))
    ),
    namedtype.NamedType(
        "bmpString", char.BMPString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_organizational_unit_name))
    ),
)
...
X520Title.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "teletexString", char.TeletexString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_title))
    ),
    namedtype.NamedType(
        "printableString", char.PrintableString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_title))
    ),
    namedtype.NamedType(
        "universalString", char.UniversalString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_title))
    ),
...
X520StateOrProvinceName.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "teletexString", char.TeletexString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_state_name))
    ),
    namedtype.NamedType(
        "printableString", char.PrintableString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_state_name))
    ),
    namedtype.NamedType(
        "universalString", char.UniversalString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_state_name))
    ),
...
class Attribute(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType("type", AttributeType()),
        namedtype.NamedType(
            "values", univ.SetOf(componentType=AttributeValue()), openType=opentype.OpenType("type", certificateAttributesMap)
        ),
    )
...
BuiltInDomainDefinedAttribute.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "type",
        char.PrintableString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_domain_defined_attribute_type_length)),
    ),
    namedtype.NamedType(
        "value",
        char.PrintableString().subtype(
...
X520CommonName.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "teletexString", char.TeletexString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_common_name))
    ),
    namedtype.NamedType(
        "printableString", char.PrintableString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_common_name))
    ),
    namedtype.NamedType(
        "universalString", char.UniversalString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_common_name))
    ),
    namedtype.NamedType(
        "utf8String", char.UTF8String().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_common_name))
    ),
...
PrivateDomainName.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "numeric", char.NumericString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_domain_name_length))
    ),
    namedtype.NamedType(
        "printable", char.PrintableString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_domain_name_length))
    ),
)
...
BuiltInStandardAttributes.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "network-address", NetworkAddress().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
    ),
    namedtype.OptionalNamedType(
        "terminal-identifier", TerminalIdentifier().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
    namedtype.OptionalNamedType(
        "private-domain-name",
        PrivateDomainName().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 2)),
    ),
    namedtype.OptionalNamedType(
        "organization-name", OrganizationName().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 3))
    ),
    namedtype.OptionalNamedType(
        "numeric-user-identifier",
        NumericUserIdentifier().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 4)),
    ),
    namedtype.OptionalNamedType(
        "personal-name", PersonalName().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 5))
    ),
    namedtype.OptionalNamedType(
        "organizational-unit-names",
        OrganizationalUnitNames().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 6)),
    ),
)
...
PrivateKeyUsagePeriod.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType(
        "notBefore", useful.GeneralizedTime().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
    ),
    namedtype.OptionalNamedType(
        "notAfter", useful.GeneralizedTime().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
)
...
EDIPartyName.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType(
        "nameAssigner", DirectoryString().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0))
    ),
    namedtype.NamedType(
        "partyName", DirectoryString().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 1))
    ),
)
...
GeneralName.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "otherName", AnotherName().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0))
    ),
    namedtype.NamedType(
        "rfc822Name", char.IA5String().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
    ...
    namedtype.NamedType(
        "directoryName", Name().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 4))
    ),
    namedtype.NamedType(
        "ediPartyName", EDIPartyName().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 5))
    ),
    namedtype.NamedType(
        "uniformResourceIdentifier", char.IA5String().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 6))
    ),
    namedtype.NamedType(
        "iPAddress", univ.OctetString().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 7))
    ),
    namedtype.NamedType(
        "registeredID", univ.ObjectIdentifier().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 8))
    ),
)
...
GeneralSubtree.componentType = namedtype.NamedTypes(
    ...
    namedtype.DefaultedNamedType(
        "minimum", BaseDistance().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0)).subtype(value=0)
    ),
    namedtype.OptionalNamedType(
        "maximum", BaseDistance().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
)
...
DistributionPointName.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        ...
        RelativeDistinguishedName().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1)),
    ),
)
...
IssuingDistributionPoint.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType(
        "distributionPoint",
        DistributionPointName().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0)),
    ),
    namedtype.DefaultedNamedType(
        "onlyContainsUserCerts",
        univ.Boolean().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1)).subtype(value=0),
    ),
    namedtype.DefaultedNamedType(
        "onlyContainsCACerts",
        univ.Boolean().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2)).subtype(value=0),
    ),
    namedtype.OptionalNamedType(
        "onlySomeReasons", ReasonFlags().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 3))
    ),
    namedtype.DefaultedNamedType(
        "indirectCRL",
        univ.Boolean().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 4)).subtype(value=0),
    ),
    namedtype.DefaultedNamedType(
        "onlyContainsAttributeCerts",
        univ.Boolean().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 5)).subtype(value=0),
    ),
)
...
AccessDescription.componentType = namedtype.NamedTypes(
    namedtype.NamedType("accessMethod", univ.ObjectIdentifier()), namedtype.NamedType("accessLocation", GeneralName())
)
...
DistributionPoint.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "reasons", ReasonFlags().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
    namedtype.OptionalNamedType(
        "cRLIssuer", GeneralNames().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2))
    ),
)
...
NameConstraints.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType(
        "permittedSubtrees", GeneralSubtrees().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
    ),
    namedtype.OptionalNamedType(
        "excludedSubtrees", GeneralSubtrees().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
)
...
UserNotice.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType("noticeRef", NoticeReference()), namedtype.OptionalNamedType("explicitText", DisplayText())
)
...
class PolicyQualifierInfo(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType("qualifier", univ.Any(), openType=opentype.OpenType("policyQualifierId", policyQualifierInfoMap)),
    )
...
BasicConstraints.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "pathLenConstraint", univ.Integer().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, MAX))
    ),
)
...
PolicyMappings.componentType = univ.Sequence(
    componentType=namedtype.NamedTypes(
        namedtype.NamedType("issuerDomainPolicy", CertPolicyId()), namedtype.NamedType("subjectDomainPolicy", CertPolicyId())
    )
)
...
AuthorityKeyIdentifier.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType(
        "keyIdentifier", KeyIdentifier().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
    ),
    namedtype.OptionalNamedType(
        "authorityCertIssuer", GeneralNames().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
    namedtype.OptionalNamedType(
        "authorityCertSerialNumber",
        CertificateSerialNumber().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2)),
    ),
)
...
PolicyConstraints.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType(
        "requireExplicitPolicy", SkipCerts().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
    ),
    namedtype.OptionalNamedType(
        "inhibitPolicyMapping", SkipCerts().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
)
