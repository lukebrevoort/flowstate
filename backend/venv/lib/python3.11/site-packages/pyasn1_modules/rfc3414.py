...
class UsmSecurityParameters(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType(
            "msgAuthoritativeEngineBoots", univ.Integer().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 2147483647))
        ),
        namedtype.NamedType(
            "msgAuthoritativeEngineTime", univ.Integer().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, 2147483647))
        ),
