...
AttrConstraint.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "attrValues", univ.SetOf(componentType=AttributeValue()).subtype(subtypeSpec=constraint.ValueSizeConstraint(1, MAX))
    ),
)
...
ContentTypeGeneration.namedValues = namedval.NamedValues(("canSource", 0), ("cannotSource", 1))
