...
class AttributeValueAssertion(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType("attributeDesc", AttributeDescription()), namedtype.NamedType("assertionValue", AssertionValue())
    )
...
class SaslCredentials(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType("mechanism", LDAPString()), namedtype.OptionalNamedType("credentials", univ.OctetString())
    )
...
class AuthenticationChoice(univ.Choice):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType(
            "simple", univ.OctetString().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
        ),
        namedtype.NamedType(
            "reserved-1", univ.OctetString().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
        ),
        namedtype.NamedType(
            "reserved-2", univ.OctetString().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2))
        ),
        namedtype.NamedType(
            "sasl", SaslCredentials().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 3))
        ),
    )
...
class SearchResultEntry(univ.Sequence):
    ...
    componentType = namedtype.NamedTypes(
        namedtype.NamedType("objectName", LDAPDN()), namedtype.NamedType("attributes", PartialAttributeList())
    )
...
class MatchingRuleAssertion(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.OptionalNamedType(
            "matchingRule", MatchingRuleId().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
        ),
        namedtype.OptionalNamedType(
            "type", AttributeDescription().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2))
        ),
        namedtype.NamedType(
            "matchValue", AssertionValue().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 3))
        ),
        namedtype.DefaultedNamedType(
            "dnAttributes", univ.Boolean("False").subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 4))
        ),
    )
...
class Filter3(univ.Choice):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType(
            "substrings", SubstringFilter().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 4))
        ),
        namedtype.NamedType(
            "greaterOrEqual",
        ...
        namedtype.NamedType(
            "present", AttributeDescription().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 7))
        ),
        namedtype.NamedType(
            "approxMatch",
...
class Filter2(univ.Choice):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType(
            "and",
            univ.SetOf(componentType=Filter3()).subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0)),
        ),
        namedtype.NamedType(
            "or",
            univ.SetOf(componentType=Filter3()).subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 1)),
        ),
...
class Filter(univ.Choice):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType(
            "and",
            univ.SetOf(componentType=Filter2()).subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0)),
        ),
        namedtype.NamedType(
            "or",
            univ.SetOf(componentType=Filter2()).subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 1)),
        ),
...
class SearchRequest(univ.Sequence):
    ...
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType(
            "scope",
            univ.Enumerated(namedValues=namedval.NamedValues(("baseObject", 0), ("singleLevel", 1), ("wholeSubtree", 2))),
        ),
        namedtype.NamedType(
            "derefAliases",
            univ.Enumerated(
...
class BindResponse(univ.Sequence):
    ...
    componentType = namedtype.NamedTypes(
        ...
        namedtype.OptionalNamedType(
            "referral", Referral().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 3))
        ),
        namedtype.OptionalNamedType(
            "serverSaslCreds",
            univ.OctetString().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 7)),
        ),
    )
            ...
            univ.SequenceOf(
                componentType=univ.Sequence(
                    componentType=namedtype.NamedTypes(
                        namedtype.NamedType(
                            "operation",
                            univ.Enumerated(namedValues=namedval.NamedValues(("add", 0), ("delete", 1), ("replace", 2))),
                        ),
...
class AddRequest(univ.Sequence):
    ...
    componentType = namedtype.NamedTypes(
        namedtype.NamedType("entry", LDAPDN()), namedtype.NamedType("attributes", AttributeList())
    )
...
class CompareRequest(univ.Sequence):
    ...
    componentType = namedtype.NamedTypes(
        namedtype.NamedType("entry", LDAPDN()), namedtype.NamedType("ava", AttributeValueAssertion())
    )
...
class ExtendedResponse(univ.Sequence):
    ...
    componentType = namedtype.NamedTypes(
        ...
        namedtype.OptionalNamedType(
            "responseName", LDAPOID().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 10))
        ),
        namedtype.OptionalNamedType(
            "response", univ.OctetString().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 11))
        ),
    )
...
class LDAPMessage(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.OptionalNamedType(
            "controls", Controls().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0))
        ),
    )
