...
class AttributeValueAssertion(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType("attributeValue", AttributeValue(), openType=opentype.OpenType("type", certificateAttributesMap)),
    )
...
class EncryptedContentInfo(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.OptionalNamedType(
            "encryptedContent",
            EncryptedContent().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0)),
...
class EncryptedData(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType("version", Version()), namedtype.NamedType("encryptedContentInfo", EncryptedContentInfo())
    )
...
class IssuerAndSerialNumber(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType("issuer", Name()), namedtype.NamedType("serialNumber", CertificateSerialNumber())
    )
...
class CRLEntry(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType("userCertificate", SerialNumber()), namedtype.NamedType("revocationDate", useful.UTCTime())
    )
...
class SignedAndEnvelopedData(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.OptionalNamedType(
            "crls", CertificateRevocationLists().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 1))
        ),
...
class DigestInfo(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType("digestAlgorithm", DigestAlgorithmIdentifier()), namedtype.NamedType("digest", Digest())
    )
