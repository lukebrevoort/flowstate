...
class KMACwithSHAKE128_params(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.DefaultedNamedType("kMACOutputLength", univ.Integer().subtype(value=256)),
        namedtype.DefaultedNamedType("customizationString", univ.OctetString().subtype(value="")),
    )
...
class KMACwithSHAKE256_params(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.DefaultedNamedType("kMACOutputLength", univ.Integer().subtype(value=512)),
        namedtype.DefaultedNamedType("customizationString", univ.OctetString().subtype(value="")),
    )
