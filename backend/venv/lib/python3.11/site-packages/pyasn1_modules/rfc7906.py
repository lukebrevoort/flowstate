...
KeyAlgorithm.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "checkWordAlg", univ.ObjectIdentifier().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
    namedtype.OptionalNamedType(
        "crcAlg", univ.ObjectIdentifier().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2))
    ),
)
...
KeyPkgReceiver.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "sirEntity", SIREntityName().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
    ),
    namedtype.NamedType(
        "community", CommunityIdentifier().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
)
...
CharEditionRange.componentType = namedtype.NamedTypes(
    namedtype.NamedType("firstCharEdition", CharEdition()), namedtype.NamedType("lastCharEdition", CharEdition())
)
...
NumEditionRange.componentType = namedtype.NamedTypes(
    namedtype.NamedType("firstNumEdition", NumEdition()), namedtype.NamedType("lastNumEdition", NumEdition())
)
...
EditionID.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        ...
        univ.Choice(
            componentType=namedtype.NamedTypes(
                namedtype.NamedType(
                    "charEdition", CharEdition().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
                ),
                namedtype.NamedType(
                    "charEditionRange",
                    CharEditionRange().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 2)),
                ),
            )
        ),
    ),
    namedtype.NamedType(
        ...
        univ.Choice(
            componentType=namedtype.NamedTypes(
                namedtype.NamedType(
                    "numEdition", NumEdition().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 3))
                ),
                namedtype.NamedType(
                    "numEditionRange",
                    NumEditionRange().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 4)),
                ),
            )
        ),
    ),
...
RegisterRange.componentType = namedtype.NamedTypes(
    namedtype.NamedType("firstRegister", Register()), namedtype.NamedType("lastRegister", Register())
)
...
RegisterID.componentType = namedtype.NamedTypes(
    namedtype.NamedType("register", Register().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 5))),
    namedtype.NamedType(
        "registerRange", RegisterRange().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 6))
    ),
)
...
SegmentRange.componentType = namedtype.NamedTypes(
    namedtype.NamedType("firstSegment", SegmentNumber()), namedtype.NamedType("lastSegment", SegmentNumber())
)
...
SegmentID.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "segmentNumber", SegmentNumber().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 7))
    ),
    namedtype.NamedType(
        "segmentRange", SegmentRange().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 8))
    ),
)
...
KeyPurpose.namedValues = namedval.NamedValues(
    ("n-a", 0), ("a", 65), ("b", 66), ("l", 76), ("m", 77), ("r", 82), ("s", 83), ("t", 84), ("v", 86), ("x", 88), ("z", 90)
)
...
KeyDistPeriod.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType(
        "doNotDistBefore", BinaryTime().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
    ),
...
KeyValidityPeriod.componentType = namedtype.NamedTypes(
    namedtype.NamedType("doNotUseBefore", BinaryTime()), namedtype.OptionalNamedType("doNotUseAfter", BinaryTime())
)
...
KeyDuration.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType("days", univ.Integer().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, ub_KeyDuration_days))),
    namedtype.NamedType(
        "weeks",
        univ.Integer()
...
InformativeTag.componentType = namedtype.NamedTypes(
    namedtype.NamedType("tagName", univ.ObjectIdentifier()), namedtype.NamedType("attributes", FreeFormField())
)
...
SplitID.componentType = namedtype.NamedTypes(
    namedtype.NamedType("half", univ.Enumerated(namedValues=namedval.NamedValues(("a", 0), ("b", 1)))),
