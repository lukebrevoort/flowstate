...
CommunityIdentifier.componentType = namedtype.NamedTypes(
    namedtype.NamedType("communityOID", univ.ObjectIdentifier()), namedtype.NamedType("hwModuleList", HardwareModules())
)
...
PreferredOrLegacyPackageIdentifier.componentType = namedtype.NamedTypes(
    namedtype.NamedType("preferred", PreferredPackageIdentifier()), namedtype.NamedType("legacy", univ.OctetString())
)
...
FirmwarePackageMessageDigest.componentType = namedtype.NamedTypes(
    namedtype.NamedType("algorithm", rfc5280.AlgorithmIdentifier()), namedtype.NamedType("msgDigest", univ.OctetString())
)
...
FirmwarePackageLoadReceipt.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "decryptKeyID", univ.OctetString().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
)
...
HardwareModuleName.componentType = namedtype.NamedTypes(
    namedtype.NamedType("hwType", univ.ObjectIdentifier()), namedtype.NamedType("hwSerialNum", univ.OctetString())
)
