...
CertPathControls.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "certificate", Certificate().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
    ),
    namedtype.OptionalNamedType(
        "policySet", CertificatePolicies().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
    namedtype.OptionalNamedType(
        "policyFlags", CertPolicyFlags().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2))
    ),
    namedtype.OptionalNamedType(
        "nameConstr", NameConstraints().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 3))
    ),
    namedtype.OptionalNamedType(
        "pathLenConstraint",
        univ.Integer()
...
TrustAnchorInfo.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "exts", Extensions().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
    namedtype.OptionalNamedType(
        "taTitleLangTag", char.UTF8String().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2))
    ),
)
...
TrustAnchorChoice.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType("tbsCert", TBSCertificate().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))),
    namedtype.NamedType(
        "taInfo", TrustAnchorInfo().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 2))
    ),
)
