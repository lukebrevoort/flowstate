...
class RSAKeyCapabilities(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType("minKeySize", RSAKeySize()), namedtype.OptionalNamedType("maxKeySize", RSAKeySize())
    )
            ...
            univ.Sequence(
                componentType=namedtype.NamedTypes(
                    ...
                    namedtype.OptionalNamedType(
                        "maxSizeP", univ.Integer().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
                    ),
                    namedtype.OptionalNamedType(
                        "maxSizeQ", univ.Integer().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2))
                    ),
                    namedtype.OptionalNamedType(
                        "maxSizeG", univ.Integer().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 3))
                    ),
                )
            ).subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0)),
        ),
        namedtype.NamedType(
            "keyParams", Dss_Parms().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 1))
        ),
    )
