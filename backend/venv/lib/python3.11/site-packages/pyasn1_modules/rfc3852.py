...
OtherRevocationInfoFormat.componentType = namedtype.NamedTypes(
    namedtype.NamedType("otherRevInfoFormat", univ.ObjectIdentifier()), namedtype.NamedType("otherRevInfo", univ.Any())
)
...
OtherKeyAttribute.componentType = namedtype.NamedTypes(
    namedtype.NamedType("keyAttrId", univ.ObjectIdentifier()), namedtype.OptionalNamedType("keyAttr", univ.Any())
)
...
OtherRecipientInfo.componentType = namedtype.NamedTypes(
    namedtype.NamedType("oriType", univ.ObjectIdentifier()), namedtype.NamedType("oriValue", univ.Any())
)
...
IssuerAndSerialNumber.componentType = namedtype.NamedTypes(
    namedtype.NamedType("issuer", rfc3280.Name()), namedtype.NamedType("serialNumber", rfc3280.CertificateSerialNumber())
)
...
OriginatorPublicKey.componentType = namedtype.NamedTypes(
    namedtype.NamedType("algorithm", rfc3280.AlgorithmIdentifier()), namedtype.NamedType("publicKey", univ.BitString())
)
...
OtherCertificateFormat.componentType = namedtype.NamedTypes(
    namedtype.NamedType("otherCertFormat", univ.ObjectIdentifier()), namedtype.NamedType("otherCert", univ.Any())
)
    ...
    namedtype.NamedType(
        ...
        univ.Choice(
            componentType=namedtype.NamedTypes(
                ...
                namedtype.NamedType(
                    "subjectName",
                    rfc3280.GeneralNames().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1)),
                ),
            )
        ),
    ),
