    ...
    namedtype.NamedType(
        ...
        univ.Sequence(
            componentType=namedtype.NamedTypes(
                namedtype.NamedType("low", univ.OctetString()), namedtype.NamedType("high", univ.OctetString())
            )
        ),
    ),
)
...
HardwareModules.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "hwSerialEntries",
        univ.SequenceOf(componentType=HardwareSerialEntry()).subtype(subtypeSpec=constraint.ValueSizeConstraint(1, MAX)),
    ),
)
...
TargetIdentifier.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "hwModules", HardwareModuleIdentifierList().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
    namedtype.NamedType(
        "communities", CommunityIdentifierList().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2))
    ),
    namedtype.NamedType("allModules", univ.Null().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 3))),
    namedtype.NamedType("uri", char.IA5String().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 4))),
    namedtype.NamedType("otherName", AnotherName().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 5))),
)
...
TAMPMsgRef.componentType = namedtype.NamedTypes(
    namedtype.NamedType("target", TargetIdentifier()), namedtype.NamedType("seqNum", SeqNumber())
)
...
TAMPStatusQuery.componentType = namedtype.NamedTypes(
    namedtype.DefaultedNamedType(
        "version", TAMPVersion().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0)).subtype(value="v2")
    ),
    namedtype.DefaultedNamedType(
        "terse",
        TerseOrVerbose().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1)).subtype(value="verbose"),
    ),
...
TAMPSequenceNumber.componentType = namedtype.NamedTypes(
    namedtype.NamedType("keyId", KeyIdentifier()), namedtype.NamedType("seqNumber", SeqNumber())
)
...
TerseStatusResponse.componentType = namedtype.NamedTypes(
    namedtype.NamedType("taKeyIds", KeyIdentifiers()), namedtype.OptionalNamedType("communities", CommunityIdentifierList())
)
...
VerboseStatusResponse.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        ...
        AlgorithmIdentifier().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0)),
    ),
    namedtype.OptionalNamedType(
        "communities", CommunityIdentifierList().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
    namedtype.OptionalNamedType(
        "tampSeqNumbers", TAMPSequenceNumbers().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2))
    ),
)
...
StatusResponse.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "terseResponse", TerseStatusResponse().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0))
    ),
    namedtype.NamedType(
        "verboseResponse",
        VerboseStatusResponse().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 1)),
    ),
)
...
TBSCertificateChangeInfo.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "signature", AlgorithmIdentifier().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
    ),
    namedtype.OptionalNamedType("issuer", Name().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))),
    namedtype.OptionalNamedType(
        "validity", Validity().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2))
    ),
    namedtype.OptionalNamedType("subject", Name().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 3))),
    namedtype.NamedType(
        "subjectPublicKeyInfo",
        SubjectPublicKeyInfo().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 4)),
    ),
    namedtype.OptionalNamedType(
        "exts", Extensions().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 5))
    ),
)
...
TrustAnchorChangeInfo.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "exts", Extensions().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
)
...
TrustAnchorChangeInfoChoice.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "tbsCertChange",
        TBSCertificateChangeInfo().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0)),
    ),
    namedtype.NamedType(
        "taChange", TrustAnchorChangeInfo().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 1))
    ),
)
...
TrustAnchorUpdate.componentType = namedtype.NamedTypes(
    namedtype.NamedType("add", TrustAnchorChoice().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))),
    namedtype.NamedType(
        "remove", SubjectPublicKeyInfo().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2))
    ),
    namedtype.NamedType(
        "change", TrustAnchorChangeInfoChoice().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 3))
    ),
)
...
TAMPUpdate.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "updates",
        univ.SequenceOf(componentType=TrustAnchorUpdate()).subtype(subtypeSpec=constraint.ValueSizeConstraint(1, MAX)),
    ),
    namedtype.OptionalNamedType(
        "tampSeqNumbers", TAMPSequenceNumbers().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2))
    ),
...
UpdateConfirm.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "terseConfirm", TerseUpdateConfirm().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
    ),
    namedtype.NamedType(
        "verboseConfirm", VerboseUpdateConfirm().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 1))
    ),
)
...
VerboseApexUpdateConfirm.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType("taInfo", TrustAnchorChoiceList()),
    namedtype.OptionalNamedType(
        "communities", CommunityIdentifierList().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
    ),
    namedtype.OptionalNamedType(
        "tampSeqNumbers", TAMPSequenceNumbers().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
)
...
ApexUpdateConfirm.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "terseApexConfirm", TerseApexUpdateConfirm().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
    ),
    namedtype.NamedType(
        "verboseApexConfirm",
        VerboseApexUpdateConfirm().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 1)),
    ),
)
...
CommunityUpdates.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType(
        "remove", CommunityIdentifierList().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
    namedtype.OptionalNamedType(
        "add", CommunityIdentifierList().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2))
    ),
)
...
VerboseCommunityConfirm.componentType = namedtype.NamedTypes(
    namedtype.NamedType("status", StatusCode()), namedtype.OptionalNamedType("communities", CommunityIdentifierList())
)
...
CommunityConfirm.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "terseCommConfirm", TerseCommunityConfirm().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
    ),
    namedtype.NamedType(
        "verboseCommConfirm",
        VerboseCommunityConfirm().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 1)),
    ),
)
...
ApexContingencyKey.componentType = namedtype.NamedTypes(
    namedtype.NamedType("wrapAlgorithm", AlgorithmIdentifier()), namedtype.NamedType("wrappedContinPubKey", univ.OctetString())
)
