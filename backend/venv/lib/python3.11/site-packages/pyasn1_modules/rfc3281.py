...
Target.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "targetName", rfc3280.GeneralName().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
    ),
    namedtype.NamedType(
        "targetGroup", rfc3280.GeneralName().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
    namedtype.NamedType(
...
Clearance.componentType = namedtype.NamedTypes(
    ...
    namedtype.DefaultedNamedType(
        "classList",
        ClassList().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1)).subtype(value="unclassified"),
    ),
    namedtype.OptionalNamedType(
        "securityCategories",
        univ.SetOf(componentType=SecurityCategory()).subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2)),
    ),
)
...
V2Form.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "objectDigestInfo", ObjectDigestInfo().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 1))
    ),
)
...
Holder.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "entityName", rfc3280.GeneralNames().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
    namedtype.OptionalNamedType(
        "objectDigestInfo", ObjectDigestInfo().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 2))
    ),
)
...
RoleSyntax.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType(
        "roleAuthority", rfc3280.GeneralNames().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
    ),
    namedtype.NamedType(
        "roleName", rfc3280.GeneralName().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
)
