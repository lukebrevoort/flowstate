...
HashAlgAndValue.componentType = namedtype.NamedTypes(
    namedtype.NamedType("hashAlg", rfc5280.AlgorithmIdentifier()), namedtype.NamedType("hashValue", univ.OctetString())
)
...
LogotypeDetails.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "logotypeHash",
        univ.SequenceOf(componentType=HashAlgAndValue()).subtype(sizeSpec=constraint.ValueSizeConstraint(1, MAX)),
    ),
    namedtype.NamedType(
        "logotypeURI", univ.SequenceOf(componentType=char.IA5String()).subtype(sizeSpec=constraint.ValueSizeConstraint(1, MAX))
    ),
)
...
LogotypeAudioInfo.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "sampleRate", univ.Integer().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 3))
    ),
    namedtype.OptionalNamedType(
        "language", char.IA5String().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 4))
    ),
)
...
LogotypeAudio.componentType = namedtype.NamedTypes(
    namedtype.NamedType("audioDetails", LogotypeDetails()), namedtype.OptionalNamedType("audioInfo", LogotypeAudioInfo())
)
...
LogotypeImageResolution.componentType = namedtype.NamedTypes(
    namedtype.NamedType("numBits", univ.Integer().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))),
    namedtype.NamedType("tableSize", univ.Integer().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2))),
)
...
LogotypeImageInfo.componentType = namedtype.NamedTypes(
    namedtype.DefaultedNamedType(
        "type",
        LogotypeImageType().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0)).subtype(value="color"),
    ),
    namedtype.NamedType("fileSize", univ.Integer()),
...
LogotypeImage.componentType = namedtype.NamedTypes(
    namedtype.NamedType("imageDetails", LogotypeDetails()), namedtype.OptionalNamedType("imageInfo", LogotypeImageInfo())
)
...
LogotypeData.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType("image", univ.SequenceOf(componentType=LogotypeImage())),
    namedtype.OptionalNamedType(
        "audio",
...
LogotypeReference.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "refStructURI",
        univ.SequenceOf(componentType=char.IA5String()).subtype(sizeSpec=constraint.ValueSizeConstraint(1, MAX)),
    ),
)
...
LogotypeInfo.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "direct", LogotypeData().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0))
    ),
    namedtype.NamedType(
        "indirect", LogotypeReference().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 1))
    ),
)
...
OtherLogotypeInfo.componentType = namedtype.NamedTypes(
    namedtype.NamedType("logotypeType", univ.ObjectIdentifier()), namedtype.NamedType("info", LogotypeInfo())
)
...
LogotypeExtn.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "issuerLogo", LogotypeInfo().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 1))
    ),
    namedtype.OptionalNamedType(
        "subjectLogo", LogotypeInfo().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 2))
    ),
    namedtype.OptionalNamedType(
        "otherLogos",
