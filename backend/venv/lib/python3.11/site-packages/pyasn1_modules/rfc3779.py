...
IPAddressOrRange.componentType = namedtype.NamedTypes(
    namedtype.NamedType("addressPrefix", IPAddress()), namedtype.NamedType("addressRange", IPAddressRange())
)
...
ASIdentifiers.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType(
        "asnum", ASIdentifierChoice().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0))
    ),
    namedtype.OptionalNamedType(
        "rdi", ASIdentifierChoice().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 1))
    ),
)
