...
class Certificates(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.OptionalNamedType(
            "pKC", Certificate().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
        ),
        namedtype.OptionalNamedType(
            "aC",
        ...
        namedtype.OptionalNamedType(
            "certPath", CertificateSet().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2))
        ),
    )
...
class GLInfo(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType("glName", GeneralName()), namedtype.NamedType("glAddress", GeneralName())
    )
...
requested_algorithm = SMIMECapability().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 4))
...
class GLKeyAttributes(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.DefaultedNamedType(
            ...
            univ.Boolean().subtype(value=0, implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0)),
        ),
        namedtype.DefaultedNamedType(
            "recipientsNotMutuallyAware",
            univ.Boolean().subtype(value=1, implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1)),
        ),
        namedtype.DefaultedNamedType(
            "duration", univ.Integer().subtype(value=0, implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2))
        ),
        namedtype.DefaultedNamedType(
            "generationCounter",
            univ.Integer().subtype(value=2, implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 3)),
        ),
...
class GLUseKEK(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType(
            "glOwnerInfo",
            univ.SequenceOf(componentType=GLOwnerInfo()).subtype(subtypeSpec=constraint.ValueSizeConstraint(1, MAX)),
        ),
        namedtype.DefaultedNamedType("glAdministration", GLAdministration().subtype(value=1)),
...
class GLAddMember(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType("glName", GeneralName()), namedtype.NamedType("glMember", GLMember())
    )
...
class GLDeleteMember(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType("glName", GeneralName()), namedtype.NamedType("glMemberToDelete", GeneralName())
    )
...
class GLNewKeyAttributes(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.OptionalNamedType(
            "rekeyControlledByGLO", univ.Boolean().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
        ),
        namedtype.OptionalNamedType(
            "recipientsNotMutuallyAware",
            univ.Boolean().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1)),
        ),
        namedtype.OptionalNamedType(
            "duration", univ.Integer().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2))
        ),
        namedtype.OptionalNamedType(
            "generationCounter", univ.Integer().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 3))
        ),
        namedtype.OptionalNamedType(
            "requestedAlgorithm",
...
class GLOwnerAdministration(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType("glName", GeneralName()), namedtype.NamedType("glOwnerInfo", GLOwnerInfo())
    )
...
class Date(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType("start", useful.GeneralizedTime()), namedtype.OptionalNamedType("end", useful.GeneralizedTime())
    )
...
class GLKRefresh(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType("glName", GeneralName()),
        namedtype.NamedType(
            "dates", univ.SequenceOf(componentType=Date()).subtype(subtypeSpec=constraint.ValueSizeConstraint(1, MAX))
        ),
    )
...
class GLAQueryRequest(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType("glaRequestValue", univ.Any(), openType=opentype.OpenType("glaRequestType", glaQueryRRMap)),
    )
...
class GLAQueryResponse(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType("glaResponseValue", univ.Any(), openType=opentype.OpenType("glaResponseType", glaQueryRRMap)),
    )
