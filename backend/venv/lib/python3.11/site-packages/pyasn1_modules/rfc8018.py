...
PBEParameter.componentType = namedtype.NamedTypes(
    namedtype.NamedType("salt", univ.OctetString().subtype(subtypeSpec=constraint.ValueSizeConstraint(8, 8))),
    ...
    namedtype.NamedType(
        ...
        univ.Choice(
            componentType=namedtype.NamedTypes(
                namedtype.NamedType("specified", univ.OctetString()), namedtype.NamedType("otherSource", AlgorithmIdentifier())
            )
        ),
    ),
    namedtype.NamedType("iterationCount", univ.Integer().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, MAX))),
    namedtype.OptionalNamedType("keyLength", univ.Integer().subtype(subtypeSpec=constraint.ValueRangeConstraint(1, MAX))),
...
RC2_CBC_Parameter.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType("iv", univ.OctetString().subtype(subtypeSpec=constraint.ValueSizeConstraint(8, 8))),
)
...
RC5_CBC_Parameters.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "version",
        univ.Integer(namedValues=namedval.NamedValues(("v1_0", 16))).subtype(subtypeSpec=constraint.SingleValueConstraint(16)),
    ),
    namedtype.NamedType("rounds", univ.Integer().subtype(subtypeSpec=constraint.ValueRangeConstraint(8, 127))),
    namedtype.NamedType("blockSizeInBits", univ.Integer().subtype(subtypeSpec=constraint.SingleValueConstraint(64, 128))),
