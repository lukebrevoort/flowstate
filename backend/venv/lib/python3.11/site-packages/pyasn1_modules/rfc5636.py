...
class TACTokenandBlindHash(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType("token", Token()), namedtype.NamedType("blinded", BlinedCertificateHash())
    )


class TACTokenandPartiallySignedCertificateHash(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType("token", Token()), namedtype.NamedType("partially", PartiallySignedCertificateHash())
    )
