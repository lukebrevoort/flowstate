...
Encoding.namedValues = namedval.NamedValues(
    ("dec", "DECIMAL"), ("hex", "HEXADECIMAL"), ("alpha", "ALPHANUMERIC"), ("b64", "BASE64"), ("bin", "BINARY")
)
...
ChallengeFormat.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType("min", univ.Integer().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, MAX))),
    namedtype.NamedType("max", univ.Integer().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, MAX))),
)
...
ResponseFormat.componentType = namedtype.NamedTypes(
    namedtype.NamedType("encoding", Encoding()),
    namedtype.NamedType("length", univ.Integer().subtype(subtypeSpec=constraint.ValueRangeConstraint(0, MAX))),
    namedtype.DefaultedNamedType("checkDigit", univ.Boolean().subtype(value=0)),
)
...
PSKCAlgorithmParameters.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "challengeFormat", ChallengeFormat().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0))
    ),
    namedtype.NamedType(
        "responseFormat", ResponseFormat().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 1))
    ),
)
...
ValueMac.componentType = namedtype.NamedTypes(
    namedtype.NamedType("macAlgorithm", char.UTF8String()), namedtype.NamedType("mac", char.UTF8String())
)
...
PINUsageMode.namedValues = namedval.NamedValues(
    ("local", "Local"), ("prepend", "Prepend"), ("append", "Append"), ("algorithmic", "Algorithmic")
)
...
PINPolicy.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType(
        "pinKeyId", char.UTF8String().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
    ),
    namedtype.NamedType(
        "pinUsageMode", PINUsageMode().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
    namedtype.OptionalNamedType(
        "maxFailedAttempts",
        univ.Integer()
    ...
    namedtype.OptionalNamedType(
        "pinEncoding", Encoding().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 5))
    ),
)
...
SKeyAttribute.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "attrValues", univ.SetOf(componentType=AttributeValue()), openType=opentype.OpenType("attrType", sKeyAttributesMap)
    ),
)
...
SKeyPkgAttribute.componentType = namedtype.NamedTypes(
    namedtype.NamedType("attrType", AttributeType()),
    namedtype.NamedType(
        "attrValues", univ.SetOf(componentType=AttributeValue()), openType=opentype.OpenType("attrType", sKeyPkgAttributesMap)
    ),
)
...
OneSymmetricKey.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType(
        "sKeyAttrs", univ.SequenceOf(componentType=SKeyAttribute()).subtype(subtypeSpec=constraint.ValueSizeConstraint(1, MAX))
    ),
