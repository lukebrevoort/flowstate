...
SinglePubInfo.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "pubMethod", univ.Integer(namedValues=namedval.NamedValues(("dontCare", 0), ("x500", 1), ("web", 2), ("ldap", 3)))
    ),
...
PKMACValue.componentType = namedtype.NamedTypes(
    namedtype.NamedType("algId", rfc3280.AlgorithmIdentifier()), namedtype.NamedType("value", univ.BitString())
)
    ...
    namedtype.NamedType(
        ...
        univ.Choice(
            componentType=namedtype.NamedTypes(
                namedtype.NamedType(
                    "sender",
                    rfc3280.GeneralName().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0)),
                ),
...
POPOSigningKey.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType(
        "poposkInput", POPOSigningKeyInput().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0))
    ),
...
EncryptedValue.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType(
        "intendedAlg", rfc3280.AlgorithmIdentifier().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
    ),
    namedtype.OptionalNamedType(
        "symmAlg", rfc3280.AlgorithmIdentifier().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
    namedtype.OptionalNamedType(
        "encSymmKey", univ.BitString().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2))
    ),
    namedtype.OptionalNamedType(
        "keyAlg", rfc3280.AlgorithmIdentifier().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 3))
    ),
    namedtype.OptionalNamedType(
        "valueHint", univ.OctetString().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 4))
    ),
...
EncryptedKey.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "envelopedData", rfc3852.EnvelopedData().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
    ),
)
...
PKIArchiveOptions.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "encryptedPrivKey", EncryptedKey().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0))
    ),
    namedtype.NamedType(
        "keyGenParameters", KeyGenParameters().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
    namedtype.NamedType(
        "archiveRemGenPrivKey", univ.Boolean().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2))
    ),
)
...
SubsequentMessage.namedValues = namedval.NamedValues(("encrCert", 0), ("challengeResp", 1))
...
AttributeTypeAndValue.componentType = namedtype.NamedTypes(
    namedtype.NamedType("type", univ.ObjectIdentifier()), namedtype.NamedType("value", univ.Any())
)
...
POPOPrivKey.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "thisMessage", univ.BitString().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
    ),
    namedtype.NamedType(
        "subsequentMessage", SubsequentMessage().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
    namedtype.NamedType("dhMAC", univ.BitString().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2))),
    namedtype.NamedType(
        "agreeMAC", PKMACValue().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 3))
    ),
    namedtype.NamedType(
        "encryptedKey", rfc3852.EnvelopedData().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 4))
    ),
)
...
ProofOfPossession.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "signature", POPOSigningKey().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 1))
    ),
    namedtype.NamedType(
        "keyEncipherment", POPOPrivKey().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 2))
    ),
    namedtype.NamedType(
        "keyAgreement", POPOPrivKey().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 3))
    ),
)
...
OptionalValidity.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType(
        "notBefore", rfc3280.Time().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0))
    ),
    namedtype.OptionalNamedType(
        "notAfter", rfc3280.Time().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 1))
    ),
)
...
CertTemplate.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType(
        "version", rfc3280.Version().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
    ),
    namedtype.OptionalNamedType(
        "serialNumber", univ.Integer().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
    namedtype.OptionalNamedType(
        "signingAlg", rfc3280.AlgorithmIdentifier().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2))
    ),
    namedtype.OptionalNamedType(
        "issuer", rfc3280.Name().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 3))
    ),
    namedtype.OptionalNamedType(
        "validity", OptionalValidity().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 4))
    ),
    namedtype.OptionalNamedType(
        "subject", rfc3280.Name().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 5))
    ),
    namedtype.OptionalNamedType(
        "publicKey", rfc3280.SubjectPublicKeyInfo().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 6))
    ),
    namedtype.OptionalNamedType(
        "issuerUID", rfc3280.UniqueIdentifier().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 7))
    ),
    namedtype.OptionalNamedType(
        "subjectUID", rfc3280.UniqueIdentifier().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 8))
    ),
    namedtype.OptionalNamedType(
        "extensions", rfc3280.Extensions().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 9))
    ),
)
...
CertId.componentType = namedtype.NamedTypes(
    namedtype.NamedType("issuer", rfc3280.GeneralName()), namedtype.NamedType("serialNumber", univ.Integer())
)
...
EncKeyWithID.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        ...
        univ.Choice(
            componentType=namedtype.NamedTypes(
                namedtype.NamedType("string", char.UTF8String()), namedtype.NamedType("generalName", rfc3280.GeneralName())
            )
        ),
    ),
)
