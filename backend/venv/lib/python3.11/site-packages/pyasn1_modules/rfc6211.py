...
CMSAlgorithmProtection.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "signatureAlgorithm",
        SignatureAlgorithmIdentifier().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1)),
    ),
    namedtype.OptionalNamedType(
        "macAlgorithm",
        MessageAuthenticationCodeAlgorithm().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2)),
    ),
)
