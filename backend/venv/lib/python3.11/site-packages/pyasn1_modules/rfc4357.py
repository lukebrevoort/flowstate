...
Gost28147_89_EncryptedKey.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "maskKey", Gost28147_89_Key().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
    ),
...
Gost28147_89_ParamSetParameters.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "mode",
        univ.Integer(namedValues=namedval.NamedValues(("gost28147-89-CNT", 0), ("gost28147-89-CFB", 1), ("cryptoPro-CBC", 2))),
    ),
    namedtype.NamedType("shiftBits", univ.Integer(namedValues=namedval.NamedValues(("gost28147-89-block", 64)))),
...
Gost28147_89_Parameters.componentType = namedtype.NamedTypes(
    namedtype.NamedType("iv", Gost28147_89_IV()), namedtype.NamedType("encryptionParamSet", Gost28147_89_ParamSet())
)
...
GostR3410_2001_PublicKeyParameters.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "digestParamSet",
        univ.ObjectIdentifier().subtype(
            subtypeSpec=constraint.SingleValueConstraint(id_GostR3411_94_TestParamSet, id_GostR3411_94_CryptoProParamSet)
        ),
    ),
    namedtype.DefaultedNamedType(
        "encryptionParamSet", Gost28147_89_ParamSet().subtype(value=id_Gost28147_89_CryptoPro_A_ParamSet)
    ),
)
...
GostR3411_94_ParamSetParameters.componentType = namedtype.NamedTypes(
    namedtype.NamedType("hUZ", Gost28147_89_UZ()), namedtype.NamedType("h0", GostR3411_94_Digest())
)
