...
SingleAttribute.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType("attrValues", AttributeValues(), openType=opentype.OpenType("attrType", rfc5652.cmsAttributesMap)),
)
...
ErrorCodeChoice.componentType = namedtype.NamedTypes(
    namedtype.NamedType("enum", EnumeratedErrorCode()), namedtype.NamedType("oid", univ.ObjectIdentifier())
)
...
KeyPkgIdentifier.componentType = namedtype.NamedTypes(
    namedtype.NamedType("pkgID", KeyPkgID()), namedtype.NamedType("attribute", SingleAttribute())
)
...
KeyPackageError.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "errorOf", KeyPkgIdentifier().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0))
    ),
...
KeyPkgReceiptReq.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "receiptsFrom", SIREntityNames().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
    ),
...
KeyPkgIdentifierAndReceiptReq.componentType = namedtype.NamedTypes(
    namedtype.NamedType("pkgID", KeyPkgID()), namedtype.OptionalNamedType("receiptReq", KeyPkgReceiptReq())
)
