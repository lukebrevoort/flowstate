...
class Gender(char.PrintableString):
    subtypeSpec = constraint.ConstraintsIntersection(
        constraint.ValueSizeConstraint(1, 1), constraint.SingleValueConstraint("M", "F", "m", "f")
    )
...
class QCStatement(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.OptionalNamedType("statementInfo", univ.Any(), openType=opentype.OpenType("statementId", qcStatementMap)),
    )
...
class SemanticsInformation(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.OptionalNamedType("nameRegistrationAuthorities", NameRegistrationAuthorities()),
    )
    subtypeSpec = constraint.ConstraintsUnion(
        constraint.WithComponentsConstraint(("semanticsIndentifier", constraint.ComponentPresentConstraint())),
        constraint.WithComponentsConstraint(("nameRegistrationAuthorities", constraint.ComponentPresentConstraint())),
    )
