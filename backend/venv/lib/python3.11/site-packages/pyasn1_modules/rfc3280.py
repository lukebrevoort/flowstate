...
AlgorithmIdentifier.componentType = namedtype.NamedTypes(
    namedtype.NamedType("algorithm", univ.ObjectIdentifier()), namedtype.OptionalNamedType("parameters", univ.Any())
)
...
ExtensionAttribute.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "extension-attribute-value", univ.Any().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
)
...
Attribute.componentType = namedtype.NamedTypes(
    namedtype.NamedType("type", AttributeType()), namedtype.NamedType("values", univ.SetOf(componentType=AttributeValue()))
)
...
EDIPartyName.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType(
        "nameAssigner", DirectoryString().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
    ),
    namedtype.NamedType(
        "partyName", DirectoryString().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
)
...
PolicyQualifierInfo.componentType = namedtype.NamedTypes(
    namedtype.NamedType("policyQualifierId", PolicyQualifierId()), namedtype.NamedType("qualifier", univ.Any())
)
