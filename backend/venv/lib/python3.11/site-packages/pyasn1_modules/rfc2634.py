...
IssuerSerial.componentType = namedtype.NamedTypes(
    namedtype.NamedType("issuer", GeneralNames()), namedtype.NamedType("serialNumber", CertificateSerialNumber())
)
...
ESSCertID.componentType = namedtype.NamedTypes(
    namedtype.NamedType("certHash", Hash()), namedtype.OptionalNamedType("issuerSerial", IssuerSerial())
)
...
MLReceiptPolicy.componentType = namedtype.NamedTypes(
    namedtype.NamedType("none", univ.Null().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))),
    namedtype.NamedType(
        "insteadOf",
...
ESSPrivacyMark.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "pString", char.PrintableString().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, ub_privacy_mark_length))
    ),
...
SecurityClassification.namedValues = namedval.NamedValues(
    ("unmarked", 0), ("unclassified", 1), ("restricted", 2), ("confidential", 3), ("secret", 4), ("top-secret", 5)
)
...
ContentHints.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType(
        "contentDescription", char.UTF8String().subtype(subtypeSpec=constraint.ValueSizeConstraint(1, MAX))
    ),
    namedtype.NamedType("contentType", ContentType()),
)
...
AllOrFirstTier.namedValues = namedval.NamedValues(("allReceipts", 0), ("firstTierRecipients", 1))
...
ReceiptsFrom.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        "allOrFirstTier", AllOrFirstTier().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
    ),
    namedtype.NamedType(
        "receiptList",
...
ReceiptRequest.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "receiptsTo",
        univ.SequenceOf(componentType=GeneralNames()).subtype(sizeSpec=constraint.ValueSizeConstraint(1, ub_receiptsTo)),
    ),
)
