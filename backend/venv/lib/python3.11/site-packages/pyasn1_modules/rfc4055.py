...
RSAPublicKey.componentType = namedtype.NamedTypes(
    namedtype.NamedType("modulus", univ.Integer()), namedtype.NamedType("publicExponent", univ.Integer())
)
...
RSAES_OAEP_params.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType(
        "hashFunc",
        rfc5280.AlgorithmIdentifier().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0)),
    ),
    namedtype.OptionalNamedType(
        "maskGenFunc",
        rfc5280.AlgorithmIdentifier().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 1)),
    ),
    namedtype.OptionalNamedType(
        "pSourceFunc",
        rfc5280.AlgorithmIdentifier().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 2)),
    ),
)
...
RSASSA_PSS_params.componentType = namedtype.NamedTypes(
    ...
    namedtype.DefaultedNamedType(
        "saltLength", univ.Integer(value=20).subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2))
    ),
    namedtype.DefaultedNamedType(
        "trailerField", univ.Integer(value=1).subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 3))
    ),
)
