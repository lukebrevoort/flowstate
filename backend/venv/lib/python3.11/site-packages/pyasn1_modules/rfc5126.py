...
class OtherHashAlgAndValue(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType("hashAlgorithm", AlgorithmIdentifier()), namedtype.NamedType("hashValue", OtherHashValue())
    )


class OtherHash(univ.Choice):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType("sha1Hash", OtherHashValue()), namedtype.NamedType("otherHash", OtherHashAlgAndValue())
    )


class OtherCertID(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType("otherCertHash", OtherHash()), namedtype.OptionalNamedType("issuerSerial", IssuerSerial())
    )
...
class SigPolicyQualifierInfo(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType("sigQualifier", univ.Any(), openType=opentype.OpenType("sigPolicyQualifierId", sigQualifiersMap)),
    )
...
class CommitmentTypeQualifier(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType(
            "qualifier", univ.Any(), openType=opentype.OpenType("commitmentTypeIdentifier", commitmentQualifierMap)
        ),
    )
...
class SignerLocation(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.OptionalNamedType(
            "countryName", DirectoryString().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
        ),
        namedtype.OptionalNamedType(
            "localityName", DirectoryString().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
        ),
        namedtype.OptionalNamedType(
            "postalAdddress", PostalAddress().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2))
        ),
    )
...
class SignerAttribute(univ.SequenceOf):
    componentType = univ.Choice(
        componentType=namedtype.NamedTypes(
            namedtype.NamedType(
                "claimedAttributes",
                ClaimedAttributes().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0)),
            ),
            namedtype.NamedType(
                "certifiedAttributes",
                CertifiedAttributes().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1)),
            ),
        )
    )
...
class CrlValidatedID(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType("crlHash", OtherHash()), namedtype.OptionalNamedType("crlIdentifier", CrlIdentifier())
    )


class CRLListID(univ.Sequence):
    componentType = namedtype.NamedTypes(namedtype.NamedType("crls", univ.SequenceOf(componentType=CrlValidatedID())))


class OcspIdentifier(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType("ocspResponderID", ResponderID()), namedtype.NamedType("producedAt", useful.GeneralizedTime())
    )


class OcspResponsesID(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType("ocspIdentifier", OcspIdentifier()), namedtype.OptionalNamedType("ocspRepHash", OtherHash())
    )


class OcspListID(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.NamedType("ocspResponses", univ.SequenceOf(componentType=OcspResponsesID()))
    )
...
class OtherRevRefs(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType("otherRevRefs", univ.Any(), openType=opentype.OpenType("otherRevRefType", otherRevRefMap)),
    )
...
class CrlOcspRef(univ.Sequence):
    componentType = namedtype.NamedTypes(
        namedtype.OptionalNamedType(
            "crlids", CRLListID().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0))
        ),
        namedtype.OptionalNamedType(
            "ocspids", OcspListID().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 1))
        ),
        namedtype.OptionalNamedType(
            "otherRev", OtherRevRefs().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 2))
        ),
    )
...
class OtherRevVals(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.NamedType("otherRevVals", univ.Any(), openType=opentype.OpenType("otherRevValType", otherRevValMap)),
    )
...
class RevocationValues(univ.Sequence):
    componentType = namedtype.NamedTypes(
        ...
        namedtype.OptionalNamedType(
            "otherRevVals", OtherRevVals().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 2))
        ),
    )
