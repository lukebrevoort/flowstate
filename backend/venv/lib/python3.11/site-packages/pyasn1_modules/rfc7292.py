...
Pkcs_12PbeParams.componentType = namedtype.NamedTypes(
    namedtype.NamedType("salt", univ.OctetString()), namedtype.NamedType("iterations", univ.Integer())
)
...
BAG_TYPE.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType("unnamed1", univ.Any(), openType=opentype.OpenType("attrType", pkcs12BagTypeMap)),
)
...
SafeBag.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType("bagAttributes", univ.SetOf(componentType=PKCS12Attribute())),
)
...
PFX.componentType = namedtype.NamedTypes(
    namedtype.NamedType("version", univ.Integer(namedValues=namedval.NamedValues(("v3", 3)))),
