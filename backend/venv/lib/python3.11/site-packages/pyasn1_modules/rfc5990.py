...
GenericHybridParameters.componentType = namedtype.NamedTypes(
    namedtype.NamedType("kem", KeyEncapsulationMechanism()), namedtype.NamedType("dem", DataEncapsulationMechanism())
)
...
RsaKemParameters.componentType = namedtype.NamedTypes(
    namedtype.NamedType("keyDerivationFunction", KeyDerivationFunction()), namedtype.NamedType("keyLength", KeyLength())
)
