        ...
        univ.Choice(
            componentType=namedtype.NamedTypes(
                namedtype.NamedType(
                    ...
                    ContentType_ShortForm().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0)),
                ),
                namedtype.NamedType(
                    "contentType-OID",
                    univ.ObjectIdentifier().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1)),
                ),
            )
        ),
    ),
    namedtype.NamedType(
        "compressedContent", univ.OctetString().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
    ),
)
...
CompressionAlgorithmIdentifier.componentType = namedtype.NamedTypes(
    namedtype.NamedType(
        ...
        AlgorithmID_ShortForm().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0)),
    ),
    namedtype.NamedType(
        "algorithmID-OID", univ.ObjectIdentifier().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
)
