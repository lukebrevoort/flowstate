    ...
    namedtype.NamedType(
        ...
        univ.Choice(
            componentType=namedtype.NamedTypes(
                namedtype.NamedType(
                    "baseCertificateID",
                    rfc3281.IssuerSerial().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0)),
                ),
                namedtype.NamedType(
                    "subjectName",
                    rfc5280.GeneralNames().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1)),
                ),
            )
        ),
    ),
...
Attribute.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "attrValues", univ.SetOf(componentType=AttributeValue()), openType=opentype.OpenType("attrType", cmsAttributesMap)
    ),
)
...
OtherKeyAttribute.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType("keyAttr", univ.Any(), openType=opentype.OpenType("keyAttrId", otherKeyAttributesMap)),
)
...
IssuerAndSerialNumber.componentType = namedtype.NamedTypes(
    namedtype.NamedType("issuer", rfc5280.Name()), namedtype.NamedType("serialNumber", rfc5280.CertificateSerialNumber())
)
...
KeyAgreeRecipientIdentifier.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "rKeyId", RecipientKeyIdentifier().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0))
    ),
)
...
RecipientEncryptedKey.componentType = namedtype.NamedTypes(
    namedtype.NamedType("rid", KeyAgreeRecipientIdentifier()), namedtype.NamedType("encryptedKey", EncryptedKey())
)
...
CMSVersion.namedValues = namedval.NamedValues(("v0", 0), ("v1", 1), ("v2", 2), ("v3", 3), ("v4", 4), ("v5", 5))
...
OtherCertificateFormat.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType("otherCert", univ.Any(), openType=opentype.OpenType("otherCertFormat", otherCertFormatMap)),
)
...
CertificateChoices.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "extendedCertificate",
        ExtendedCertificate().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0)),
    ),
    namedtype.NamedType(
        "v1AttrCert", AttributeCertificateV1().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
    namedtype.NamedType(
        "v2AttrCert", AttributeCertificateV2().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2))
    ),
    namedtype.NamedType(
        "other", OtherCertificateFormat().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 3))
    ),
)
...
OtherRevocationInfoFormat.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType("otherRevInfo", univ.Any(), openType=opentype.OpenType("otherRevInfoFormat", otherRevInfoFormatMap)),
)
...
RevocationInfoChoice.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "other", OtherRevocationInfoFormat().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 1))
    ),
)
...
OriginatorInfo.componentType = namedtype.NamedTypes(
    namedtype.OptionalNamedType(
        "certs", CertificateSet().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
    ),
    namedtype.OptionalNamedType(
        "crls", RevocationInfoChoices().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
)
...
EncryptedContentInfo.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "encryptedContent", EncryptedContent().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
    ),
)
...
PasswordRecipientInfo.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        ...
        KeyDerivationAlgorithmIdentifier().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0)),
    ),
    namedtype.NamedType("keyEncryptionAlgorithm", KeyEncryptionAlgorithmIdentifier()),
    namedtype.NamedType("encryptedKey", EncryptedKey()),
)
...
RecipientIdentifier.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        ...
        SubjectKeyIdentifier().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0)),
    ),
)
...
OriginatorPublicKey.componentType = namedtype.NamedTypes(
    namedtype.NamedType("algorithm", rfc5280.AlgorithmIdentifier()), namedtype.NamedType("publicKey", univ.BitString())
)
...
OriginatorIdentifierOrKey.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "originatorKey", OriginatorPublicKey().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 1))
    ),
)
...
KeyAgreeRecipientInfo.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "originator",
        OriginatorIdentifierOrKey().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0)),
    ),
    namedtype.OptionalNamedType(
        "ukm", UserKeyingMaterial().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
    namedtype.NamedType("keyEncryptionAlgorithm", KeyEncryptionAlgorithmIdentifier()),
...
OtherRecipientInfo.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType("oriValue", univ.Any(), openType=opentype.OpenType("oriType", otherRecipientInfoMap)),
)
...
RecipientInfo.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "kari", KeyAgreeRecipientInfo().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 1))
    ),
    namedtype.NamedType(
        "kekri", KEKRecipientInfo().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 2))
    ),
    namedtype.NamedType(
        "pwri", PasswordRecipientInfo().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 3))
    ),
    namedtype.NamedType(
        "ori", OtherRecipientInfo().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 4))
    ),
)
...
EnvelopedData.componentType = namedtype.NamedTypes(
    namedtype.NamedType("version", CMSVersion()),
    namedtype.OptionalNamedType(
        "originatorInfo", OriginatorInfo().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0))
    ),
    namedtype.NamedType("recipientInfos", RecipientInfos()),
    namedtype.NamedType("encryptedContentInfo", EncryptedContentInfo()),
    namedtype.OptionalNamedType(
        "unprotectedAttrs", UnprotectedAttributes().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
)
...
SignerInfo.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "signedAttrs", SignedAttributes().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
    ),
    namedtype.NamedType("signatureAlgorithm", SignatureAlgorithmIdentifier()),
    namedtype.NamedType("signature", SignatureValue()),
    namedtype.OptionalNamedType(
        "unsignedAttrs", UnsignedAttributes().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
)
...
EncapsulatedContentInfo.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "eContent", univ.OctetString().subtype(explicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
    ),
)
...
AuthenticatedData.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "digestAlgorithm",
        DigestAlgorithmIdentifier().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1)),
    ),
    namedtype.NamedType("encapContentInfo", EncapsulatedContentInfo()),
    namedtype.OptionalNamedType(
        "authAttrs", AuthAttributes().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2))
    ),
    namedtype.NamedType("mac", MessageAuthenticationCode()),
    namedtype.OptionalNamedType(
        "unauthAttrs", UnauthAttributes().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 3))
    ),
)
...
SignedData.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType("encapContentInfo", EncapsulatedContentInfo()),
    namedtype.OptionalNamedType(
        "certificates", CertificateSet().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
    ),
    namedtype.OptionalNamedType(
        "crls", RevocationInfoChoices().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
