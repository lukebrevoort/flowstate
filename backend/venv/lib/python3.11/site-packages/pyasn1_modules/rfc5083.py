...
AuthEnvelopedData.componentType = namedtype.NamedTypes(
    ...
    namedtype.OptionalNamedType(
        "originatorInfo",
        rfc5652.OriginatorInfo().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatConstructed, 0)),
    ),
    ...
    namedtype.OptionalNamedType(
        "authAttrs", rfc5652.AuthAttributes().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
    namedtype.NamedType("mac", rfc5652.MessageAuthenticationCode()),
    namedtype.OptionalNamedType(
        "unauthAttrs", rfc5652.UnauthAttributes().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 2))
    ),
)
