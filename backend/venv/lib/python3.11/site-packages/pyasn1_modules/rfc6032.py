...
EncryptedKeyPackage.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType(
        "enveloped", rfc5652.EnvelopedData().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 0))
    ),
    namedtype.NamedType(
        "authEnveloped", rfc5083.AuthEnvelopedData().subtype(implicitTag=tag.Tag(tag.tagClassContext, tag.tagFormatSimple, 1))
    ),
)
