...
if PYDANTIC_V2:
    ...
    def is_pv1_scalar_field(field: ModelField) -> bool:
        ...
        if field.sub_fields:  # type: ignore[attr-defined]
            if not all(is_pv1_scalar_field(f) for f in field.sub_fields):  # type: ignore[attr-defined]
                return False
        return True

    def is_pv1_scalar_sequence_field(field: ModelField) -> bool:
        if (field.shape in sequence_shapes) and not lenient_issubclass(field.type_, BaseModel):  # type: ignore[attr-defined]
