        ...
        try:
            ...
            while frame:
                ...
                for filename, functions in can_block_functions:
                    if frame_file_name.endswith(filename) and frame_info.function in functions:
                        return func(*args, **kwargs)
                frame = frame.f_back
...
class BlockBusterFunction:
    ...
    def __init__(
        ...
        *,
        ...
        self.can_block_functions: list[tuple[str, Iterable[str]]] = can_block_functions or []
    ...
    def can_block_in(self, filename: str, functions: str | Iterable[str]) -> BlockBusterFunction:
...
def _get_os_wrapped_functions(
    ...
    os_rw_kwargs = {} if platform.system() == "Windows" else {"can_block_predicate": os_rw_exclude}
