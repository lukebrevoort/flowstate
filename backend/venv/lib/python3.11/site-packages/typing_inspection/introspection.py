...
def _literal_type_check(value: Any, /) -> None:
    ...
    if not isinstance(value, (int, bytes, str, bool, Enum, typing_objects.NoneType)) and value is not typing_objects.NoneType:
        ...
        for arg in annotation.__args__:
            ...
            if typing_objects.is_typealiastype(arg):
                try:
                    ...
                    sub_args = get_literal_values(alias_value, type_check=type_check, unpack_type_aliases=unpack_type_aliases)
