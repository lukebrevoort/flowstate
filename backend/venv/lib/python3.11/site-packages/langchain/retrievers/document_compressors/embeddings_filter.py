...
class EmbeddingsFilter(BaseDocumentCompressor):
    ...
    def compress_documents(
        ...
        try:
            ...
            raise ImportError("Could not import numpy, please install with `pip install numpy`.") from e
    ...
    async def acompress_documents(
        ...
        try:
            ...
            raise ImportError("Could not import numpy, please install with `pip install numpy`.") from e
        stateful_documents = get_stateful_documents(documents)
        embedded_documents = await _aget_embeddings_from_stateful_docs(self.embeddings, stateful_documents)
