...
class VectorStoreToolkit(BaseToolkit):
    ...
    def get_tools(self) -> list[BaseTool]:
        ...
        try:
            ...
            raise ImportError("You need to install langchain-community to use this toolkit.")
        description = VectorStoreQATool.get_description(self.vectorstore_info.name, self.vectorstore_info.description)
