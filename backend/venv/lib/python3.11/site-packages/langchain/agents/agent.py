...
class MultiActionAgentOutputParser(BaseOutputParser[Union[list[AgentAction], AgentFinish]]):
...
class Agent(BaseSingleActionAgent):
    ...
    def get_full_inputs(self, intermediate_steps: list[tuple[AgentAction, str]], **kwargs: Any) -> builtins.dict[str, Any]:
...
class AgentExecutor(Chain):
    ...
    async def _aiter_next_step(
        ...
        result = await asyncio.gather(
            *[
                self._aperform_agent_action(name_to_tool_map, color_mapping, agent_action, run_manager)
                for agent_action in actions
            ],
        )
    ...
    def _call(
        ...
        output = self._action_agent.return_stopped_response(self.early_stopping_method, intermediate_steps, **inputs)
