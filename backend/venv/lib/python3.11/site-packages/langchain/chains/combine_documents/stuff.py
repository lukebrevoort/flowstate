...
def create_stuff_documents_chain(
    ...
    *,
    ...
    def format_docs(inputs: dict) -> str:
        return document_separator.join(format_document(doc, _document_prompt) for doc in inputs[document_variable_name])
    ...
    def get_default_document_variable_name(cls, values: dict) -> Any:
        ...
        if "document_variable_name" not in values:
            if len(llm_chain_variables) == 1:
                ...
                raise ValueError("document_variable_name must be provided if there are " "multiple llm_chain_variables")
        else:
