    ...
    **Security Note**: This is an implementation of a crawler that uses a browser via
    ...
    def __init__(self) -> None:
        try:
            ...
            raise ImportError(
                "Could not import playwright python package. " "Please install it with `pip install playwright`."
            )
    ...
    def crawl(self) -> List[str]:
        ...
        for index, node_name_index in enumerate(node_names):
            ...
            element_attributes = find_attributes(attributes[index], ["type", "placeholder", "aria-label", "title", "alt"])

            ancestor_exception = is_ancestor_of_anchor or is_ancestor_of_button
            ancestor_node_key = None if not ancestor_exception else str(anchor_id) if is_ancestor_of_anchor else str(button_id)
