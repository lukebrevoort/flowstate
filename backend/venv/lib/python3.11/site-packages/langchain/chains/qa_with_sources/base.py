...
class BaseQAWithSourcesChain(Chain, ABC):
    ...
    def from_chain_type(
        ...
        **kwargs: Any,
        ...
        combine_documents_chain = load_qa_with_sources_chain(llm, chain_type=chain_type, **_chain_kwargs)
    ...
    def _split_sources(self, answer: str) -> tuple[str, str]:
        ...
        if re.search(r"SOURCES?:", answer, re.IGNORECASE):
            answer, sources = re.split(r"SOURCES?:|QUESTION:\s", answer, flags=re.IGNORECASE)[:2]
            sources = re.split(r"\n", sources)[0].strip()
        else:
            sources = ""
    ...
    def _call(
        ...
        answer = self.combine_documents_chain.run(input_documents=docs, callbacks=_run_manager.get_child(), **inputs)
