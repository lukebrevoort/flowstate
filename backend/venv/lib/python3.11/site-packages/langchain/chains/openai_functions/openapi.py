...
def openapi_spec_to_openai_fn(
    ...
    try:
        ...
        raise ImportError(
            "Could not import langchain_community.tools. " "Please install it with `pip install langchain-community`."
        )
...
def get_openapi_chain(
    ...
    **kwargs: Any,
    ...
    request_chain = request_chain or SimpleRequestChain(
        request_method=lambda name, args: call_api_fn(name, args, headers=headers, params=params),
        verbose=verbose,
    )
