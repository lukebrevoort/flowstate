...
def create_citation_fuzzy_match_runnable(llm: BaseChatModel) -> Runnable:
    ...
    if llm.bind_tools is BaseChatModel.bind_tools:
        raise ValueError("Language model must implement bind_tools to use this function.")
    prompt = ChatPromptTemplate(
        [
            SystemMessage("You are a world class algorithm to answer " "questions with correct and exact citations."),
...
def create_citation_fuzzy_match_chain(llm: BaseLanguageModel) -> LLMChain:
    ...
    messages = [
        SystemMessage(content=("You are a world class algorithm to answer " "questions with correct and exact citations.")),
