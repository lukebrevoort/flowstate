...
class TransformChain(Chain):
    ...
    atransform_cb: Optional[Callable[[dict[str, Any]], Awaitable[dict[str, Any]]]] = Field(None, alias="atransform")
    ...
    async def _acall(
        ...
        if self.atransform_cb is not None:
            ...
            self._log_once("TransformChain's atransform is not provided, falling" " back to synchronous transform")
            return self.transform_cb(inputs)
