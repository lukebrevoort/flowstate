...
class HypotheticalDocumentEmbedder(Chain, Embeddings):
    ...
    def _call(
        ...
        return self.llm_chain.invoke(inputs, config={"callbacks": _run_manager.get_child()})
    ...
    def from_llm(
        ...
        **kwargs: Any,
        ...
        if custom_prompt is not None:
            ...
            raise ValueError(
                f"Must specify prompt_key if custom_prompt not provided. Should be one " f"of {list(PROMPT_MAP.keys())}."
            )
