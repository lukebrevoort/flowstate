...
def create_structured_output_runnable(
    ...
    **kwargs: Any,
    ...
    if mode == "openai-tools":
        ...
        raise ValueError(f"Invalid mode {mode}. Expected one of 'openai-tools', 'openai-functions', " f"'openai-json'.")
...
def _get_openai_tool_output_parser(
    ...
    *,
    ...
    if isinstance(tool, type) and is_basemodel_subclass(tool):
        ...
        output_parser = JsonOutputKeyToolsParser(first_tool_only=first_tool_only, key_name=key_name)
...
def get_openai_output_parser(
    ...
    if isinstance(functions[0], type) and is_basemodel_subclass(functions[0]):
        ...
        output_parser: Union[BaseOutputParser, BaseGenerationOutputParser] = PydanticOutputFunctionsParser(
