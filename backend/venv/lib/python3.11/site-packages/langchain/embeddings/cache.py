...
class CacheBackedEmbeddings(Embeddings):
    ...
    async def aembed_documents(self, texts: list[str]) -> list[list[float]]:
        ...
        for missing_indices in batch_iterate(self.batch_size, all_missing_indices):
            ...
            await self.document_embedding_store.amset(list(zip(missing_texts, missing_vectors)))
            for index, updated_vector in zip(missing_indices, missing_vectors):
                vectors[index] = updated_vector
    ...
    def from_bytes_store(
        ...
        *,
        ...
        key_encoder: Union[Callable[[str], str], Literal["sha1", "blake2b", "sha256", "sha512"]] = "sha1",
        ...
        if isinstance(key_encoder, str):
            ...
            raise ValueError(
                "key_encoder must be either 'blake2b', 'sha1', 'sha256', 'sha512' " "or a callable that encodes keys."
            )
