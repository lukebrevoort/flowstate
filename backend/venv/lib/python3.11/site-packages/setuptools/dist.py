...
class Distribution(_Distribution):
    ...
    def _enforce_option_lowercase(self, opt: str, section: str) -> str:
        ...
        affected = f"(Affected: {self.metadata.name})." if self.metadata.name else ""
        SetuptoolsDeprecationWarning.emit(
            f"Invalid uppercase key {opt!r} in {section!r} (setup.cfg), " f"please use lowercase {lowercase_opt!r} instead.",
            f"""
        ...
        for option, (source, value) in option_dict.items():
            ...
            try:
                ...
                if option in neg_opt and is_string:
                    ...
                    raise DistutilsOptionError(f"error in {source}: command '{command_name}' has no such option '{option}'")
            except ValueError as e:
                raise DistutilsOptionError(e) from e
