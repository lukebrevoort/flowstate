        ...
        with self._use_memo(node):
            ...
            if arg_annotations:
                annotations_dict = Dict(
                    ...
                    values=[
                        Tuple([Name(key, ctx=Load()), annotation], ctx=Load()) for key, annotation in arg_annotations.items()
                    ],
                )
            ...
            if (
                ...
                and (not isinstance(self._memo.return_annotation, Constant) or self._memo.return_annotation.value is not None)
            ):
