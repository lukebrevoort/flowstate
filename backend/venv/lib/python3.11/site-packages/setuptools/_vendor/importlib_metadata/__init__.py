...
class Distribution(metaclass=abc.ABCMeta):
    ...
    def files(self) -> Optional[List[PackagePath]]:
        ...
        return skip_missing_files(
            make_files(
                self._read_files_distinfo() or self._read_files_egginfo_installed() or self._read_files_egginfo_sources()
            )
        )
    ...
    def _read_files_egginfo_installed(self):
        ...
        paths = (
            py311.relative_fix((subdir / name).resolve()).relative_to(self.locate_file("").resolve(), walk_up=True).as_posix()
