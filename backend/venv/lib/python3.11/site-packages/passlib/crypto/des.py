...
from passlib.utils.compat import join_byte_values, byte_elem_value, irange, irange, int_types
...
def des_encrypt_int_block(key, input, salt=0, rounds=1):
    ...
    salt = ((salt & 0x00003F) << 26) | ((salt & 0x000FC0) << 12) | ((salt & 0x03F000) >> 2) | ((salt & 0xFC0000) >> 16)
