...
class scrypt(uh.ParallelismMixin, uh.HasRounds, uh.HasRawSalt, uh.HasRawChecksum, uh.HasManyIdents, uh.GenericHandler):
    ...
    def __init__(self, block_size=None, **kwds):
        ...
        if block_size is None:
            assert uh.validate_default_value(self, self.block_size, self._norm_block_size, param="block_size")
        else:
    ...
    def _calc_checksum(self, secret):
        ...
        return _scrypt.scrypt(
            secret, self.salt, n=(1 << self.rounds), r=self.block_size, p=self.parallelism, keylen=self.checksum_size
        )
