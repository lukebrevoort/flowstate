...
class AppsTest(TestCase):
    ...
    def test_custom_app_context(self):
        ...
        for hash in [
            ...
            ("$5$rounds=31817$iZGmlyBQ99JSB5n6$p4E.pdPBWx19OajgjLRiOW0itGny" "xDGgMlDcOsfaI17"),
        ]:
    ...
    def test_ldap_nocrypt_context(self):
        ...
        self.assertIs(
            ctx.identify("{CRYPT}$5$rounds=31817$iZGmlyBQ99JSB5" "n6$p4E.pdPBWx19OajgjLRiOW0itGnyxDGgMlDcOsfaI17"), None
        )

    def test_ldap_context(self):
        ctx = apps.ldap_context
        for hash in [
            ("{CRYPT}$5$rounds=31817$iZGmlyBQ99JSB5n6$p4E.pdPBWx19OajgjLRiOW0" "itGnyxDGgMlDcOsfaI17"),
            "{SSHA}cPusOzd6d5n3OjSVK3R329ZGCNyFcC7F",
            "test",
        ]:
            self.assertTrue(ctx.verify("test", hash))
