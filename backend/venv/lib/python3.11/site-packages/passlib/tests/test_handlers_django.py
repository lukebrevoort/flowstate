...
class django_bcrypt_sha256_test(HandlerCase, _DjangoHelper):
    ...
    known_correct_hashes = [
        ...
        (repeat_string("abc123", 72) + "qwr", "bcrypt_sha256$$2a$06$Tg/oYyZTyAf.Nb3qSgN61Ocy0BEz1RK6xslSNi8PlaLX2pe7x/KQG"),
        (repeat_string("abc123", 72) + "xyz", "bcrypt_sha256$$2a$06$Tg/oYyZTyAf.Nb3qSgN61OvY2zoRVUa2Pugv2ExVOUT2YmhvxUFUa"),
    ]
