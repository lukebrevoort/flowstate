...
class MiscTest(TestCase):
    ...
    def test_utf8_truncate(self):
        ...
        self.assertEqual(utf8_truncate(source, 4), b"MN\xff\xa0\xa1\xa2\xaa")  # index="\xa1", runs out after index+3="\xaa"
...
class _Base64Test(TestCase):
    ...
    def test_int24(self):
        ...
        m = self.m
        self.check_int_pair(
            24, [(0, m(0, 0, 0, 0)), (63, m(0, 0, 0, 63) if engine.big else m(63, 0, 0, 0)), (0xFFFFFF, m(63, 63, 63, 63))]
        )
