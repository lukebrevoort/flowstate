...
if sys.version_info >= (3, 7) or typing.TYPE_CHECKING:
    ...
    class SchemaF(Schema, typing.Generic[A]):
        ...
        def dump(self, obj: TOneOrMulti, many: typing.Optional[bool] = None) -> TOneOrMultiEncoded:  # type: ignore
            pass
        ...
        def dumps(self, obj: TOneOrMulti, many: typing.Optional[bool] = None, *args, **kwargs) -> str:  # type: ignore
            pass
