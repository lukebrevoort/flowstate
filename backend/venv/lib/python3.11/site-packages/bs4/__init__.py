...
from .builder import builder_registry, ParserRejectedMarkup, XMLParsedAsHTMLWarning, HTMLParserTreeBuilder
...
class BeautifulSoup(Tag):
        ...
        **kwargs,
        ...
        def deprecated_argument(old_name, new_name):
            if old_name in kwargs:
                warnings.warn(
                    'The "%s" argument to the BeautifulSoup constructor ' 'has been renamed to "%s."' % (old_name, new_name),
                    DeprecationWarning,
                    stacklevel=3,
                )
        ...
        if builder is None:
            ...
            if (
                ...
                and not (original_features == builder.NAME or original_features in builder.ALTERNATE_NAMES)
                and markup
            ):
                ...
                if filename:
                    ...
                    values = dict(filename=filename, line_number=line_number, parser=builder.NAME, markup_type=markup_type)
                    warnings.warn(self.NO_PARSER_SPECIFIED_WARNING % values, GuessedAtParserWarning, stacklevel=2)
        else:
            if kwargs:
                warnings.warn(
        ...
        if hasattr(markup, "read"):  # It's a file-type object.
            ...
            (isinstance(markup, bytes) and not b"<" in markup) or (isinstance(markup, str) and not "<" in markup)
        ):
    ...
    def new_tag(self, name, namespace=None, nsprefix=None, attrs={}, sourceline=None, sourcepos=None, **kwattrs):
        ...
        return self.element_classes.get(Tag, Tag)(
            None, self.builder, name, namespace, nsprefix, kwattrs, sourceline=sourceline, sourcepos=sourcepos
        )
    ...
    def endData(self, containerClass=None):
        ...
        if self.current_data:
            ...
            if (
                ...
                and (not self.parse_only.text or not self.parse_only.search(current_data))
            ):
                return
    ...
    def decode(self, pretty_print=False, eventual_encoding=DEFAULT_OUTPUT_ENCODING, formatter="minimal", iterator=None):
