...
class PageElement(object):
    ...
    def find_all_previous(self, name=None, attrs={}, string=None, limit=None, **kwargs):
        ...
        """
        _stacklevel = kwargs.pop("_stacklevel", 2)
        return self._find_all(name, attrs, string, limit, self.previous_elements, _stacklevel=_stacklevel + 1, **kwargs)
        ...
        if string is None and not limit and not attrs and not kwargs:
            if name is True or name is None:
                ...
                result = (
                    ...
                    or (element.name == local_name and (prefix is None or element.prefix == prefix))
                )
                return ResultSet(strainer, result)
...
class Tag(PageElement):
    ...
    def decode(self, indent_level=None, eventual_encoding=DEFAULT_OUTPUT_ENCODING, formatter="minimal", iterator=None):
        ...
        for event, element in self._event_stream(iterator):
            ...
            if event is Tag.START_ELEMENT_EVENT and not string_literal_tag and not element._should_pretty_print():
    ...
    def has_key(self, key):
        ...
        """
        warnings.warn("has_key is deprecated. Use has_attr(key) instead.", DeprecationWarning, stacklevel=2)
