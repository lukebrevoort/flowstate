...
class tzwin(tzwinbase):
    ...
    def __init__(self, name):
        ...
        (self._stdmonth, self._stddayofweek, self._stdweeknumber, self._stdhour, self._stdminute) = (  # Sunday = 0  # Last = 5
            tup[4:9]
        )

        (self._dstmonth, self._dstdayofweek, self._dstweeknumber, self._dsthour, self._dstminute) = (  # Sunday = 0  # Last = 5
            tup[12:17]
        )
