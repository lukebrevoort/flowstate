        ...
        **kw: Any,
        ...
        if not retval:
            if identifier == "before_execute":
                ...
                def wrap_before_execute(conn, clauseelement, multiparams, params, execution_options):  # type: ignore
                    orig_fn(
                        conn,
                        clauseelement,
                        multiparams,
                ...
                def wrap_before_cursor_execute(conn, cursor, statement, parameters, context, executemany):  # type: ignore
                    orig_fn(
                        conn,
                        cursor,
                        statement,
