...
class HasDescriptionCode:
    ...
    def _code_str(self) -> str:
        if not self.code:
            ...
            return f"(Background on this {self._what_are_we} at: " f"https://sqlalche.me/e/{_version_token}/{self.code})"
...
class UnsupportedCompilationError(CompileError):
    ...
    def __init__(
        ...
        super().__init__(
            "Compiler %r can't render element of type %s%s" % (compiler, element_type, ": %s" % message if message else "")
        )
