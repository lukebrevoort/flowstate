                ...
                # if they are empty
                    ...
                    if meth is CACHE_IN_PLACE:
                        ...
                        result += (
                            ...
                            obj["plugin_subject"]._gen_cache_key(anon_map, bindparams) if obj["plugin_subject"] else None,
                        )
...
class _CacheKeyTraversal(HasTraversalDispatch):
    ...
    def visit_multi_list(
        ...
        return (
            attrname,
            tuple(elem._gen_cache_key(anon_map, bindparams) if isinstance(elem, HasCacheKey) else elem for elem in obj),
        )
