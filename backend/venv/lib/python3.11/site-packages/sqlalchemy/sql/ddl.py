...
class SchemaGenerator(InvokeCreateDDLBase):
    ...
    def _can_create_sequence(self, sequence):
        ...
        return self.dialect.supports_sequences and (
            ...
            and (not self.checkfirst or not self.dialect.has_sequence(self.connection, sequence.name, schema=effective_schema))
        )
...
class SchemaDropper(InvokeDropDDLBase):
    ...
    def _can_drop_sequence(self, sequence):
        ...
        return self.dialect.supports_sequences and (
            (not self.dialect.sequences_optional or not sequence.optional)
            and (not self.checkfirst or self.dialect.has_sequence(self.connection, sequence.name, schema=effective_schema))
        )
