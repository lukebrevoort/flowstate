    ...
    def prettyIn(self, value):
        try:
            ...
            try:
                ...
                raise error.PyAsn1Error("Can't coerce %r into integer: %s" % (value, exc))
    ...
    def prettyIn(self, value):
        if isinstance(value, ObjectIdentifier):
            ...
            try:
                ...
                raise error.PyAsn1Error("Malformed Object ID %s at %s: %s" % (value, self.__class__.__name__, exc))
    ...
    def prettyIn(self, value):
        if isinstance(value, RelativeOID):
            ...
            try:
                ...
                raise error.PyAsn1Error("Malformed RELATIVE-OID %s at %s: %s" % (value, self.__class__.__name__, exc))
...
class Real(base.SimpleAsn1Type):
    ...
    def prettyIn(self, value):
        if isinstance(value, tuple) and len(value) == 3:
            if not isinstance(value[0], (int, float)) or not isinstance(value[1], int) or not isinstance(value[2], int):
