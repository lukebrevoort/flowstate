        ...
        if asn1Spec.typeId in (univ.Sequence.typeId, univ.Set.typeId):
            ...
            while substrate.tell() - original_position < length:
                ...
                asn1Object.setComponentByPosition(
                    idx, component, verifyConstraints=False, matchTags=False, matchConstraints=False
                )
            ...
            if namedTypes:
                ...
                if inconsistency:
                    raise error.PyAsn1Error(f"ASN.1 object {asn1Object.__class__.__name__} is inconsistent")
            ...
            if state is stDecodeValue:
                ...
                if length == -1:  # indef length
                    ...
                    if not substrateFun and bytesRead != length:
                        ...
                        raise PyAsn1Error("Read %s bytes are more than expected %s." % (bytesRead, length))
