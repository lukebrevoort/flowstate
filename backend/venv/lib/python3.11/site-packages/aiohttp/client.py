        ...
        try:
            with timer:
                ...
                while True:
                    ...
                    effective_middlewares = self._middlewares if middlewares is None else middlewares

                    if effective_middlewares:
                        handler = build_client_middlewares(_connect_and_send_request, effective_middlewares)
                    else:
                    ...
                    if resp._raw_cookie_headers:
                        self._cookie_jar.update_cookies_from_headers(resp._raw_cookie_headers, resp.url)
