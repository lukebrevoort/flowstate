...
class RequestHandler(BaseProtocol):
    ...
    def ssl_context(self) -> Optional["ssl.SSLContext"]:
        ...
        return None if self.transport is None else self.transport.get_extra_info("sslcontext")
    ...
    def peername(
        ...
        return None if self.transport is None else self.transport.get_extra_info("peername")
    ...
    def log_access(self, request: BaseRequest, response: StreamResponse, time: Optional[float]) -> None:
