...
class ZepCloudChatMessageHistory(BaseChatMessageHistory):
    ...
    def __init__(
        ...
        *,
        ...
        try:
            ...
            raise ImportError("Could not import zep-cloud package. " "Please install it with `pip install zep-cloud`.")
    ...
    def add_user_message(self, message: str, metadata: Optional[Dict[str, Any]] = None) -> None:  # type: ignore[override]
    ...
    def add_ai_message(self, message: str, metadata: Optional[Dict[str, Any]] = None) -> None:  # type: ignore[override]
