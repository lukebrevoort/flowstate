        ...
        *,
        ...
        if boto3_session:
            ...
            try:
                ...
                raise ImportError("Unable to import boto3, please install with `pip install boto3`.") from e
            if endpoint_url:
    ...
    def add_messages(self, messages: Sequence[BaseMessage]) -> None:
        ...
        if self.ttl:
            ...
            self.table.update_item(
                Key={**self.key},
                UpdateExpression=(f"set {self.history_messages_key} = :h, {self.ttl_key_name} = :t"),
