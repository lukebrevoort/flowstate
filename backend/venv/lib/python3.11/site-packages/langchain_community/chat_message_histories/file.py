...
class FileChatMessageHistory(BaseChatMessageHistory):
    ...
    def __init__(
        ...
        *,
        ...
        if not self.file_path.exists():
            ...
            self.file_path.write_text(json.dumps([], ensure_ascii=self.ensure_ascii), encoding=self.encoding)
    ...
    def add_message(self, message: BaseMessage) -> None:
        ...
        self.file_path.write_text(json.dumps(messages, ensure_ascii=self.ensure_ascii), encoding=self.encoding)
