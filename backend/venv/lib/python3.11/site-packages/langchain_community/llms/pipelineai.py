...
class PipelineAI(LLM, BaseModel):
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        pipeline_api_key = convert_to_secret_str(get_from_dict_or_env(values, "pipeline_api_key", "PIPELINE_API_KEY"))
    ...
    def _call(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            raise AttributeError(f"A pipeline run should have a `result_preview` attribute." f"Run was: {run}")
        if stop is not None:
