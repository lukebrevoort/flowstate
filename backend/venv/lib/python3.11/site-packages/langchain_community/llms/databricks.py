    ...
    * an automatically generated temporary token if running inside a Databricks
    ...
    def _default_params(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "task": self.task,
            "transform_input_fn": (
                None if self.transform_input_fn is None else _pickle_fn_to_hex_string(self.transform_input_fn)
            ),
            "transform_output_fn": (
                None if self.transform_output_fn is None else _pickle_fn_to_hex_string(self.transform_output_fn)
            ),
        }
