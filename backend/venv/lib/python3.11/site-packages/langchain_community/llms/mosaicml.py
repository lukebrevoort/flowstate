...
class MosaicML(LLM):
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        mosaicml_api_token = get_from_dict_or_env(values, "mosaicml_api_token", "MOSAICML_API_TOKEN")
        ...
        try:
            ...
            if isinstance(parsed_response, dict):
                ...
                for key in output_keys:
                    ...
                    raise ValueError(f"No valid key ({', '.join(output_keys)}) in response:" f" {parsed_response}")
