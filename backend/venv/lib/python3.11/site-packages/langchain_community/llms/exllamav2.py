...
class ExLlamaV2(LLM):
    ...
    def validate_environment(cls, values: Dict[str, Any]) -> Dict[str, Any]:
        try:
            ...
            raise ImportError("Unable to import torch, please install with `pip install torch`.") from e
        ...
        if values["settings"]:
            ...
            raise NotImplementedError("settings is required. Custom settings are not supported yet.")
    ...
    def _call(
        ...
        **kwargs: Any,
        ...
        if self.streaming:
            ...
            for chunk in self._stream(prompt=prompt, stop=stop, run_manager=run_manager, kwargs=kwargs):
