...
class Banana(LLM):
    ...
    banana_api_key: Optional[SecretStr] = Field(default_factory=secret_from_env("BANANA_API_KEY", default=None))
    ...
    def _call(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            raise ImportError(
                "Could not import banana-dev python package. " "Please install it with `pip install banana-dev`."
            )
