...
def completion_with_retry(
    ...
    **kwargs: Any,
    ...
    @retry_decorator
    def _completion_with_retry(prompt: List[Union[str, "Image"]], is_gemini: bool = False, **kwargs: Any) -> Any:
        if is_gemini:
...
class VertexAIModelGarden(_VertexAIBase, BaseLLM):
    ...
    async_client: "PredictionServiceAsyncClient" = None  #: :meta private:  # type: ignore[assignment]
    endpoint_id: str
