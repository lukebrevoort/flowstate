...
class NLPCloud(LLM):
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        try:
            ...
            raise ImportError("Could not import nlpcloud python package. " "Please install it with `pip install nlpcloud`.")
        return values
    ...
    def _call(
        ...
        **kwargs: Any,
        ...
        if stop and len(stop) > 1:
            raise ValueError("NLPCloud only supports a single stop sequence per generation." "Pass in a list of length 1.")
