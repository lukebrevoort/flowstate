...
class OpaquePrompts(LLM):
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        if op.__package__ is None:
            raise ValueError("Could not properly import `opaqueprompts`, " "opaqueprompts.__package__ is None.")

        api_key = get_from_dict_or_env(values, "opaqueprompts_api_key", "OPAQUEPROMPTS_API_KEY", default="")
        if not api_key:
            raise ValueError(
