...
class GPT2ContentFormatter(ContentFormatterBase):
    ...
    def format_response_payload(self, output: bytes, api_type: AzureMLEndpointApiType) -> Generation:  # type: ignore[override]
        try:
...
class AzureMLBaseEndpoint(BaseModel):
    ...
    def validate_endpoint_api_type(cls, field_value: Any, values: Dict) -> AzureMLEndpointApiType:
        ...
        if (
            field_value == AzureMLEndpointApiType.dedicated or field_value == AzureMLEndpointApiType.realtime
