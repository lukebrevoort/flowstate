...
class AI21(LLM):
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        ai21_api_key = convert_to_secret_str(get_from_dict_or_env(values, "ai21_api_key", "AI21_API_KEY"))
    ...
    def _call(
        ...
        **kwargs: Any,
        ...
        if response.status_code != 200:
            ...
            raise ValueError(
                f"AI21 /complete call failed with status code {response.status_code}." f" Details: {optional_detail}"
            )
