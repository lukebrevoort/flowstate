...
class SteamshipImageGenerationTool(BaseTool):
    ...
    def validate_environment(cls, values: Dict) -> Any:
        ...
        try:
            ...
            raise ImportError("steamship is not installed. " "Please install it with `pip install steamship`")
    ...
    def _run(
        ...
        image_generator = self.steamship.use_plugin(plugin_handle=self.model_name.value, config={"n": 1, "size": self.size})
