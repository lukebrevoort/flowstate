...
class AzureAiServicesTextToSpeechTool(BaseTool):
    ...
    description: str = (
        "A wrapper around Azure AI Services Text to Speech API. " "Useful for when you need to convert text to speech. "
    )
    ...
    def validate_environment(cls, values: Dict) -> Any:
        ...
        azure_ai_services_region = get_from_dict_or_env(values, "azure_ai_services_region", "AZURE_AI_SERVICES_REGION")
