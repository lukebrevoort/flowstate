...
class AzureAiServicesTextAnalyticsForHealthTool(BaseTool):
    ...
    def validate_environment(cls, values: Dict) -> Any:
        ...
        azure_ai_services_key = get_from_dict_or_env(values, "azure_ai_services_key", "AZURE_AI_SERVICES_KEY")

        azure_ai_services_endpoint = get_from_dict_or_env(values, "azure_ai_services_endpoint", "AZURE_AI_SERVICES_ENDPOINT")
        ...
        try:
            ...
            raise ImportError(
                "azure-ai-textanalytics is not installed. " "Run `pip install azure-ai-textanalytics` to install."
            )
    ...
    def _run(
        ...
        try:
            ...
            raise RuntimeError(f"Error while running AzureAiServicesTextAnalyticsForHealthTool: {e}")
