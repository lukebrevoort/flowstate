...
class AzureCogsImageAnalysisTool(BaseTool):
    ...
    def validate_environment(cls, values: Dict) -> Any:
        ...
        azure_cogs_endpoint = get_from_dict_or_env(values, "azure_cogs_endpoint", "AZURE_COGS_ENDPOINT")

        try:
            import azure.ai.vision as sdk

            values["vision_service"] = sdk.VisionServiceOptions(endpoint=azure_cogs_endpoint, key=azure_cogs_key)
            ...
            raise ImportError("azure-ai-vision is not installed. " "Run `pip install azure-ai-vision` to install.")
    ...
    def _image_analysis(self, image_path: str) -> Dict:
        ...
        image_analyzer = sdk.ImageAnalyzer(self.vision_service, vision_source, self.analysis_options)
