...
class CogniswitchKnowledgeStatus(BaseTool):
    ...
    OAI_token: str
    apiKey: str
    knowledge_status_url: str = "https://api.cogniswitch.ai:8243/cs-api/0.0.1/cs/knowledgeSource/status"
...
class CogniswitchKnowledgeSourceFile(BaseTool):
    ...
    OAI_token: str
    apiKey: str
    knowledgesource_file: str = "https://api.cogniswitch.ai:8243/cs-api/0.0.1/cs/knowledgeSource/file"
