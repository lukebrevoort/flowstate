    ...
    def _run(
        ...
        **kwargs: Any,
        ...
        if error is not None and "TokenExpired" in error:
            self.session_cache[tool_input] = "Authentication token expired or invalid, please try reauthenticate."
            return self.session_cache[tool_input]
        ...
        self.session_cache[tool_input] = result if result else BAD_REQUEST_RESPONSE.format(error=error)
        return self.session_cache[tool_input]
