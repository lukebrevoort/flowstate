...
class DuckDuckGoSearchResults(BaseTool):
    ...
    def _run(
        ...
        results = [{k: v for k, v in d.items() if not self.keys_to_include or k in self.keys_to_include} for d in raw_results]
        ...
        if self.output_format == "list":
            ...
            raise ValueError(f"Invalid output_format: {self.output_format}. " "Needs to be one of 'string', 'json', 'list'.")
...
def DuckDuckGoSearchTool(*args: Any, **kwargs: Any) -> DuckDuckGoSearchRun:
    ...
    """
    warnings.warn(
        "DuckDuckGoSearchTool will be deprecated in the future. " "Please use DuckDuckGoSearchRun instead.",
        DeprecationWarning,
    )
