...
def import_google() -> Tuple[Request, Credentials]:
    ...
    return (
        ...
        guard_import(module_name="google.oauth2.credentials", pip_name="google-auth-httplib2").Credentials,
    )
...
def import_installed_app_flow() -> InstalledAppFlow:
    ...
    """
    return guard_import(module_name="google_auth_oauthlib.flow", pip_name="google-auth-oauthlib").InstalledAppFlow
...
def import_googleapiclient_resource_builder() -> build_resource:
    ...
    """
    return guard_import(module_name="googleapiclient.discovery", pip_name="google-api-python-client").build
