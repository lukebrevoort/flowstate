...
class KuzuGraph:
    ...
    *Security note*: Make sure that the database connection uses credentials
    ...
    def __init__(self, db: Any, database: str = "kuzu", allow_dangerous_requests: bool = False) -> None:
        ...
        try:
            ...
            raise ImportError("Could not import Kùzu python package." "Please install Kùzu with `pip install kuzu`.")
        self.db = db
