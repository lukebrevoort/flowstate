    ...
    *Security note*: Make sure that the database connection uses credentials
    ...
    def __init__(
        ...
        try:
            ...
            raise ImportError("Could not import rdflib python package. " "Please install it with `pip install rdflib`.")
        ...
        if local_file:
            ...
            ontology_schema_graph = self._load_ontology_schema_with_query(query_ontology)  # type: ignore[arg-type]
    ...
    @staticmethod
    def _load_ontology_schema_from_file(local_file: str, local_file_format: Optional[str] = None) -> "rdflib.ConjunctiveGraph":
        """
