    ...
    *Security note*: Make sure that the database connection uses credentials
    ...
    def __init__(self, graph_name: str, conf: Dict[str, Any], create: bool = True) -> None:
        ...
        try:
            ...
            raise ImportError("Could not import psycopg2 python package. " "Please install it with `pip install psycopg2`.")
        ...
        with self._get_cursor() as curs:
            ...
            if data is None:
                if create:
                    ...
                    raise Exception(
                        ('Graph "{}" does not exist in the database ' + 'and "create" is set to False').format(graph_name)
                    )
    ...
    def _get_cursor(self) -> psycopg2.extras.NamedTupleCursor:
        ...
        try:
            ...
            raise ImportError("Unable to import psycopg2, please install with " "`pip install -U psycopg2`.") from e
    ...
    def _get_labels(self) -> Tuple[List[str], List[str]]:
        ...
        e_labels_records = self.query("""MATCH ()-[e]-() RETURN collect(distinct label(e)) as labels""")
        ...
        for doc in graph_documents:
            ...
            if include_source:
                if not doc.source.metadata.get("id"):
                    doc.source.metadata["id"] = md5(doc.source.page_content.encode("utf-8")).hexdigest()
