        ...
        "edges": [
            {
                ...
                "properties": [{"key": prop[0], "types": [{"type": prop[1].lower()}]} for prop in rel["properties_info"]],
    ...
    def __init__(
        ...
        *,
        ...
        try:
            ...
            raise ValueError("Could not connect to Memgraph database. " "Please ensure that the url is correct")
        except neo4j.exceptions.AuthError:
            raise ValueError(
                "Could not connect to Memgraph database. " "Please ensure that the username and password are correct"
            )
