...
class ChatSnowflakeCortex(BaseChatModel):
    ...
    test_tools: Dict[str, Union[Dict[str, Any], Type, Callable, BaseTool]] = Field(default_factory=dict)
    ...
    def _generate(
        ...
        **kwargs: Any,
        ...
        for message in messages:
            if isinstance(message.content, dict) and isinstance(message, SystemMessage) and "invoke_tool" in message.content:
        ...
        if tool_output:
            message_dicts.append({"tool_output": str(tool_output)})  # Ensure tool_output is a string
    ...
    def _stream(
        ...
        **kwargs: Any,
        ...
        for message in messages:
            if isinstance(message, str) and isinstance(message, SystemMessage) and "invoke_tool" in message.content:
        ...
        try:
            ...
            raise ChatSnowflakeCortexError(f"Error while making request to Snowflake Cortex stream: {e}")
