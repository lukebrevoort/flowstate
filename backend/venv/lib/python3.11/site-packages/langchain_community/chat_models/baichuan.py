...
class ChatBaichuan(BaseChatModel):
    ...
    async def _astream(
        ...
        **kwargs: Any,
        ...
        async with httpx.AsyncClient(headers=headers, timeout=self.request_timeout) as client:
            async with aconnect_httpx_sse(client, "POST", self.baichuan_api_base, json=payload) as event_source:
    ...
    def _create_payload_parameters(self, messages: List[BaseMessage], **kwargs: Any) -> Dict[str, Any]:
