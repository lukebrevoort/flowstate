    ...
    for message in messages:
        ...
        if isinstance(message, HumanMessage):
            ...
            if message.tool_calls:
                tool_calls = [{"name": tool_call["name"], "arguments": tool_call["args"]} for tool_call in message.tool_calls]
...
class ChatCloudflareWorkersAI(BaseChatModel):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        if self.ai_gateway:
            self.url = f"{self.gateway_url}/{self.account_id}/" f"{self.ai_gateway}/workers-ai/run/{self.model}"
        else:
    ...
    def _generate(
        ...
        **kwargs: Any,
        ...
        ai_message = AIMessage(content=str(response.json()), tool_calls=cast(AIMessageChunk, tool_calls))
