...
class ChatMlflow(BaseChatModel):
    ...
    def _validate_uri(self) -> None:
        ...
        if urlparse(self.target_uri).scheme not in allowed:
            raise ValueError(f"Invalid target URI: {self.target_uri}. " f"The scheme must be one of {allowed}.")
        ...
        **kwargs: Any,
        ...
        for chunk in chunk_iter:
            if chunk["choices"]:
                ...
                chunk_message = ChatMlflow._convert_delta_to_message_chunk(chunk_delta, first_chunk_role)
        ...
        if isinstance(message, ChatMessage):
            ...
            if message.tool_calls or message.invalid_tool_calls:
                ...
                message_dict["tool_calls"] = [
                    {k: v for k, v in tool_call.items() if k in tool_call_supported_props}  # type: ignore[union-attr]
