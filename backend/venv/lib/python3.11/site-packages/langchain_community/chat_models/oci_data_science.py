...
class ChatOCIModelDeployment(BaseChatModel, BaseOCIModelDeployment):
    ...
    def with_structured_output(
        ...
        **kwargs: Any,
        ...
        if method == "json_mode":
            ...
            raise ValueError(f"Unrecognized method argument. Expected `json_mode`." f"Received: `{method}`.")
    ...
    def _handle_sse_line(self, line: str, default_chunk_cls: Type[BaseMessageChunk] = AIMessageChunk) -> ChatGenerationChunk:
