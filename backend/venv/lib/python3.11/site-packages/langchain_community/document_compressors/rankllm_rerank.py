...
class RankLLMRerank(BaseDocumentCompressor):
    ...
    def validate_environment(cls, values: Dict) -> Any:
        ...
        if not values.get("client"):
            ...
            try:
                ...
                raise ImportError(
                    "Could not import rank_llm python package. " "Please install it with `pip install rank_llm`."
                )
    ...
    def compress_documents(
        ...
        request = Request(
            ...
            candidates=[
                Candidate(doc={"text": doc.page_content}, docid=index, score=1) for index, doc in enumerate(documents)
            ],
        )
