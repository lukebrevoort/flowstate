...
class MongoDBByteStore(BaseStore[str, bytes]):
    ...
    def __init__(
        ...
        *,
        ...
        try:
            ...
            raise ImportError(
                "The MongoDBStore requires the pymongo library to be " "installed. " "pip install pymongo"
            ) from e
    ...
    def mset(self, key_value_pairs: Sequence[Tuple[str, bytes]]) -> None:
        ...
        self.collection.bulk_write([UpdateOne({"_id": u["_id"]}, {"$set": u}, upsert=True) for u in updates])
