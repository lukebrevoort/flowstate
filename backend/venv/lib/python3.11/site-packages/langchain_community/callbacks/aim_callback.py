...
class AimCallbackHandler(BaseMetadataCallbackHandler, BaseCallbackHandler):
    ...
    def on_llm_end(self, response: LLMResult, **kwargs: Any) -> None:
        ...
        generated = [aim.Text(generation.text) for generations in response_res.generations for generation in generations]
        self._run.track(
            generated,
            name="on_llm_end",
            context=resp,
    ...
    def flush_tracker(
        ...
        if reset:
            ...
            self.log_system_params = log_system_params if log_system_params else self.log_system_params
