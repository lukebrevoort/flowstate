    ...
    def __init__(
        ...
        *,
        ...
        if not any([token_ratelimit, request_ratelimit]):
            raise ValueError(
                "You must pass at least one of input_token_ratelimit or" " request_ratelimit parameters for handler to work."
            )
    ...
    def on_chain_start(self, serialized: Dict[str, Any], inputs: Dict[str, Any], **kwargs: Any) -> Any:
        ...
        if self.request_ratelimit and not self._checked:
            ...
            if not response.allowed:
                raise UpstashRatelimitError("Request limit reached!", "request", response.limit, response.reset)
            self._checked = True
    ...
    def on_llm_end(self, response: LLMResult, **kwargs: Any) -> None:
        ...
        if self.token_ratelimit:
            try:
                ...
                token_count = token_usage["total_tokens"] if self.include_output_tokens else token_usage["prompt_tokens"]
            except KeyError:
                raise ValueError(
