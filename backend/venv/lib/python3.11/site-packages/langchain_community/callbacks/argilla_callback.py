...
class ArgillaCallbackHandler(BaseCallbackHandler):
    ...
    def __init__(
        ...
        if api_key is None and os.getenv("ARGILLA_API_KEY") is None:
            self.DEFAULT_API_KEY = "admin.apikey" if parse(self.ARGILLA_VERSION) < parse("1.11.0") else "owner.apikey"
        ...
        try:
            ...
            if parse(self.ARGILLA_VERSION) < parse("1.14.0"):
                warnings.warn(
                    f"You have Argilla {self.ARGILLA_VERSION}, but Argilla 1.14.0 or" " higher is recommended.",
                    UserWarning,
                )
