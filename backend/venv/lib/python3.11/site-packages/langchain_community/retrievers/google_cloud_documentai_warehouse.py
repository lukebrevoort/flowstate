...
class GoogleDocumentAIWarehouseRetriever(BaseRetriever):
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        values["client"] = DocumentServiceClient(client_info=get_client_info(module="document-ai-warehouse"))
        return values
    ...
    def _prepare_search_request(self, query: str, **kwargs: Any) -> "SearchDocumentsRequest":
        ...
        return SearchDocumentsRequest(
            ...
            document_query=DocumentQuery(query=query, is_nl_query=True, document_schema_names=schemas),
