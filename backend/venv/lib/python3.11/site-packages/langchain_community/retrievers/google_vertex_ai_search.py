...
class _BaseGoogleVertexAISearchRetriever(BaseModel):
    ...
    def client_options(self) -> "ClientOptions":
        ...
        return ClientOptions(
            api_endpoint=(f"{self.location_id}-discoveryengine.googleapis.com" if self.location_id != "global" else None)
        )
    ...
    def _create_search_request(self, query: str) -> SearchRequest:
        ...
        if self.engine_data_type == 0:
            ...
            raise NotImplementedError(
                ...
                "2 (Website), or 3 (Blended) are supported currently." + f" Got {self.engine_data_type}"
            )
    ...
    def __init__(self, **kwargs: Any):
        ...
        if self.engine_data_type == 1 or self.engine_data_type == 3:
            raise NotImplementedError(
                ...
                "is not currently supported for multi-turn search." + f" Got {self.engine_data_type}"
            )
