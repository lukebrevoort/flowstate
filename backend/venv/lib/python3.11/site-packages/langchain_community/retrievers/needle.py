...
class NeedleRetriever(BaseRetriever, BaseModel):
    ...
    top_k: Optional[int] = Field(default=None, description="Maximum number of search results to return")
    ...
    def _search_collection(self, query: str) -> List[Document]:
        ...
        results = self.client.collections.search(collection_id=self.collection_id, text=query, top_k=self.top_k)
