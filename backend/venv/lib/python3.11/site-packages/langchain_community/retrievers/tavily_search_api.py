...
class TavilySearchAPIRetriever(BaseRetriever):
    ...
    def _get_relevant_documents(self, query: str, *, run_manager: CallbackManagerForRetrieverRun) -> List[Document]:
        try:
            ...
            raise ImportError("Tavily python package not found. " "Please install it with `pip install tavily-python`.")
        ...
        docs = [
            Document(
                page_content=result.get("content", "") if not self.include_raw_content else (result.get("raw_content") or ""),
                metadata={
                    "title": result.get("title", ""),
                    "source": result.get("url", ""),
                    **{k: v for k, v in result.items() if k not in ("content", "title", "url", "raw_content")},
