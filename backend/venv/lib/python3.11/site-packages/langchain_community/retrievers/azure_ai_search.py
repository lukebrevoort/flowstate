...
class AzureAISearchRetriever(BaseRetriever):
    ...
    def validate_environment(cls, values: Dict) -> Any:
        ...
        values["service_name"] = get_from_dict_or_env(values, "service_name", "AZURE_AI_SEARCH_SERVICE_NAME")
        values["index_name"] = get_from_dict_or_env(values, "index_name", "AZURE_AI_SEARCH_INDEX_NAME")
        values["azure_ad_token"] = get_from_dict_or_env(values, "azure_ad_token", "AZURE_AI_SEARCH_AD_TOKEN", default="")
        values["api_key"] = get_from_dict_or_env(values, "api_key", "AZURE_AI_SEARCH_API_KEY", default="")
    ...
    def _get_relevant_documents(self, query: str, *, run_manager: CallbackManagerForRetrieverRun) -> List[Document]:
        ...
        return [Document(page_content=result.pop(self.content_key), metadata=result) for result in search_results]
