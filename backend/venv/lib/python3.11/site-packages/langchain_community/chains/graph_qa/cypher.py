...
def construct_schema(
    ...
    filtered_schema: Dict[str, Any] = {
        ...
        "relationships": [
            r for r in structured_schema.get("relationships", []) if all(filter_func(r[t]) for t in ["start", "end", "type"])
        ],
    }
    ...
    *Security note*: Make sure that the database connection uses credentials
    ...
    def from_llm(
        ...
        **kwargs: Any,
        ...
        if validate_cypher:
            corrector_schema = [
                Schema(el["start"], el["type"], el["end"]) for el in kwargs["graph"].structured_schema.get("relationships")
            ]
