...
class SQLSegmenter(TreeSitterSegmenter):
    ...
    def extract_functions_classes(self) -> list[str]:
        ...
        return [stmt.strip() + ";" if not stmt.strip().endswith(";") else stmt.strip() for stmt in extracted]
    ...
    def simplify_code(self) -> str:
        ...
        """
        return "\n".join([f"-- Code for: {stmt.strip()}" for stmt in self.extract_functions_classes()])
