...
class MongodbLoader(BaseLoader):
    ...
    def __init__(
        ...
        *,
        ...
        try:
            ...
            raise ImportError("Cannot import from motor, please install with `pip install motor`.") from e
    ...
    async def aload(self) -> List[Document]:
        ...
        if len(result) != total_docs:
            logger.warning(
                f"Only partial collection of documents returned. " f"Loaded {len(result)} docs, expected {total_docs}."
            )
