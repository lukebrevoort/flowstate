...
class SharePointLoader(O365BaseLoader, BaseLoader):
    ...
    def authorized_identities(self, file_id: str) -> List:
        ...
        url = "https://graph.microsoft.com/v1.0/drives" f"/{self.document_library_id}/items/{file_id}/permissions"
    ...
    def get_extended_metadata(self, file_id: str) -> Dict:
        ...
        staged_metadata = {
            ...
            "full_path": metadata.get("parentReference", {}).get("path", "").split(":")[-1] + "/" + metadata.get("name", ""),
        }
