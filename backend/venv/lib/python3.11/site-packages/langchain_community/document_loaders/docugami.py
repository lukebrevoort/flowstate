...
class DocugamiLoader(BaseLoader, BaseModel):
    ...
    def _parse_dgml(
        ...
        try:
            ...
            raise ImportError(
                "Could not import from dgml-utils python package. " "Please install it with `pip install dgml-utils`."
            )
            ...
            if artifact_name == "report-values.xml" and artifact_url and artifact_doc:
                ...
                if response.ok:
                    try:
                        ...
                        raise ImportError(
                            "Could not import lxml python package. " "Please install it with `pip install lxml`."
                        )
