...
class NewsURLLoader(BaseLoader):
    ...
    def __init__(
        ...
        **newspaper_kwargs: Any,
        ...
        try:
            ...
            raise ImportError("newspaper package not found, please install it with " "`pip install newspaper3k`")
    ...
    def lazy_load(self) -> Iterator[Document]:
        try:
            ...
            raise ImportError("Cannot import newspaper, please install with `pip install newspaper3k`") from e
