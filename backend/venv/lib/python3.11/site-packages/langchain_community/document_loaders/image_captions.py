...
class ImageCaptionLoader(BaseLoader):
    ...
    def load(self) -> List[Document]:
        ...
        try:
            ...
            raise ImportError("`transformers` package not found, please install with " "`pip install transformers`.")
        ...
        for image in self.images:
            caption, metadata = self._get_captions_and_metadata(model=model, processor=processor, image=image)
