...
class AzureAIDocumentIntelligenceLoader(BaseLoader):
    ...
    def __init__(
        ...
        *,
        ...
        assert api_key is not None or azure_credential is not None, "Either api_key or azure_credential must be provided."

        assert api_key is None or azure_credential is None, "Only one of api_key or azure_credential should be provided."
