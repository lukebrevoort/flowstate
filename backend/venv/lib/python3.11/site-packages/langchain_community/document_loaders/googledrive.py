...
class GoogleDriveLoader(BaseLoader, BaseModel):
    ...
    def _load_credentials(self) -> Any:
        ...
        if self.service_account_key.exists():
            return service_account.Credentials.from_service_account_file(str(self.service_account_key), scopes=SCOPES)
    ...
    def _load_sheet_from_id(self, id: str) -> List[Document]:
        ...
        for sheet in sheets:
            ...
            for i, row in enumerate(values[1:], start=1):
                metadata = {
                    "source": (f"https://docs.google.com/spreadsheets/d/{id}/" f"edit?gid={sheet['properties']['sheetId']}"),
    ...
    def _load_documents_from_folder(self, folder_id: str, *, file_types: Optional[Sequence[str]] = None) -> List[Document]:
