...
class DropboxLoader(BaseLoader, BaseModel):
    ...
    *Dropbox Paper* files.
    ...
    def validate_inputs(cls, values: Dict[str, Any]) -> Any:
        ...
        if values.get("dropbox_folder_path") is not None and values.get("dropbox_file_paths") is not None:
    ...
    def _load_file_from_path(self, file_path: str) -> Optional[Document]:
        ...
        try:
            ...
            raise ValueError(f"Could not load file: {file_path}. Please verify the file path" "and try again.") from ex
        ...
        try:
            ...
            if file_extension == ".pdf":
                ...
                print(f"File {file_path} could not be decoded as pdf or text. Skipping.")  # noqa: T201
    ...
    def _load_documents_from_paths(self) -> List[Document]:
        ...
        return [
            doc for doc in (self._load_file_from_path(file_path) for file_path in self.dropbox_file_paths) if doc is not None
        ]
