...
class GeoDataFrameLoader(BaseLoader):
    ...
    def __init__(self, data_frame: Any, page_content_column: str = "geometry"):
        ...
        try:
            ...
            raise ImportError("geopandas package not found, please install it with " "`pip install geopandas`")

        if not isinstance(data_frame, gpd.GeoDataFrame):
            raise ValueError(f"Expected data_frame to be a gpd.GeoDataFrame, got {type(data_frame)}")
