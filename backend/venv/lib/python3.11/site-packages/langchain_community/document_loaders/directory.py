...
FILE_LOADER_TYPE = Union[Type[UnstructuredFileLoader], Type[TextLoader], Type[BSHTMLLoader], Type[CSVLoader]]
...
class DirectoryLoader(BaseLoader):
    ...
    def lazy_load(self) -> Iterator[Document]:
        ...
        items = [
            path for path in paths if not (self.exclude and any(path.match(glob) for glob in self.exclude)) and path.is_file()
        ]
