...
class UnstructuredBaseLoader(BaseLoader, ABC):
    ...
    def _check_if_both_mode_and_chunking_strategy_are_by_page(self, mode: str, unstructured_kwargs: dict[str, Any]) -> None:
        if mode == "paged" and unstructured_kwargs.get("chunking_strategy") == "by_page":
            raise ValueError(
                "Only one of `chunking_strategy='by_page'` or `mode='paged'` may be" " set. `chunking_strategy` is preferred."
            )
