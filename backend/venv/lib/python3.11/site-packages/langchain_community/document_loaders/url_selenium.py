...
class SeleniumURLLoader(BaseLoader):
    ...
    def __init__(
        ...
        try:
            ...
            raise ImportError("selenium package not found, please install it with " "`pip install selenium`")
    ...
    def _build_metadata(self, url: str, driver: Union["Chrome", "Firefox"]) -> dict:
        ...
        try:
            if description := driver.find_element(By.XPATH, '//meta[@name="description"]'):
                metadata["description"] = description.get_attribute("content") or "No description found."
