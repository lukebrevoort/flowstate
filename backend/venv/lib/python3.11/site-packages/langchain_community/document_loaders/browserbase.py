...
class BrowserbaseLoader(BaseLoader):
    ...
    def __init__(
        ...
        try:
            ...
            raise ImportError(
                "You must run " "`pip install --upgrade " "browserbase playwright` " "to use the Browserbase loader."
            )
    ...
    def lazy_load(self) -> Iterator[Document]:
        ...
        try:
            ...
            raise ImportError(
                "playwright is required for BrowserbaseLoader. " "Please run `pip install --upgrade playwright`."
            )
