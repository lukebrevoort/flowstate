...
class SurrealDBLoader(BaseLoader):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if "table" in self.filter_criteria:
            raise ValueError("key `table` is not a valid criteria for `filter_criteria` argument.")
    ...
    async def aload(self) -> List[Document]:
        ...
        results = await self.sdb.query(query, {"table": self.table, **self.filter_criteria})
