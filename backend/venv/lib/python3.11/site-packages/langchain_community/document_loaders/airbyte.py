...
class AirbyteTypeformLoader(AirbyteCDKLoader):
    ...
    def __init__(
        ...
        Args:
            ...
            state: The state to pass to the source connector. Defaults to None.
        """
        source_class = guard_import("source_typeform", pip_name="airbyte-source-typeform").SourceTypeform
        super().__init__(
            config=config,
            source_class=source_class,
            stream_name=stream_name,
...
class AirbyteZendeskSupportLoader(AirbyteCDKLoader):
    ...
    def __init__(
        ...
        Args:
            ...
            state: The state to pass to the source connector. Defaults to None.
        """
        source_class = guard_import("source_zendesk_support", pip_name="airbyte-source-zendesk-support").SourceZendeskSupport
        super().__init__(
            config=config,
            source_class=source_class,
            stream_name=stream_name,
...
class AirbyteShopifyLoader(AirbyteCDKLoader):
    ...
    def __init__(
        ...
        Args:
            ...
            state: The state to pass to the source connector. Defaults to None.
        """
        source_class = guard_import("source_shopify", pip_name="airbyte-source-shopify").SourceShopify
        super().__init__(
            config=config,
            source_class=source_class,
            stream_name=stream_name,
...
class AirbyteSalesforceLoader(AirbyteCDKLoader):
    ...
    def __init__(
        ...
        Args:
            ...
            state: The state to pass to the source connector. Defaults to None.
        """
        source_class = guard_import("source_salesforce", pip_name="airbyte-source-salesforce").SourceSalesforce
        super().__init__(
            config=config,
            source_class=source_class,
            stream_name=stream_name,
