...
class KineticaLoader(BaseLoader):
    ...
    def _execute_query(self) -> List[Dict[str, Any]]:
        try:
            ...
            raise ImportError("Could not import Kinetica python API. " "Please install it with `pip install gpudb==7.2.0.9`.")
    ...
    def lazy_load(self) -> Iterator[Document]:
        ...
        for row in query_result:
            page_content = "\n".join(f"{k}: {v}" for k, v in row.items() if k in page_content_columns)
