...
class TrelloLoader(BaseLoader):
    ...
    def from_credentials(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            raise ImportError(
                "Could not import trello python package. " "Please install it with `pip install py-trello`."
            ) from ex
    ...
    def lazy_load(self) -> Iterator[Document]:
        ...
        try:
            ...
            raise ImportError("`beautifulsoup4` package not found, please run" " `pip install beautifulsoup4`") from ex
