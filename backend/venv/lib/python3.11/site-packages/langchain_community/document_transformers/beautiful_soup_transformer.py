...
class BeautifulSoupTransformer(BaseDocumentTransformer):
    ...
    @staticmethod
    def remove_unwanted_classnames(html_content: str, unwanted_classnames: Union[List[str], Tuple[str, ...]]) -> str:
        """
    ...
    @staticmethod
    def remove_unwanted_tags(html_content: str, unwanted_tags: Union[List[str], Tuple[str, ...]]) -> str:
        """
