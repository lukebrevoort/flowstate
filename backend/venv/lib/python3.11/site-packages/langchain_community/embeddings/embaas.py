...
class EmbaasEmbeddings(BaseModel, Embeddings):
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        embaas_api_key = convert_to_secret_str(get_from_dict_or_env(values, "embaas_api_key", "EMBAAS_API_KEY"))
    ...
    def _generate_embeddings(self, texts: List[str]) -> List[List[float]]:
        ...
        try:
            ...
            if "message" in parsed_response:
                raise ValueError("Validation Error raised by embaas embeddings API:" f"{parsed_response['message']}")
            raise
