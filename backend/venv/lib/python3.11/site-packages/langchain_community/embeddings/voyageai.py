...
class VoyageEmbeddings(BaseModel, Embeddings):
    ...
    def validate_environment(cls, values: Dict) -> Any:
        ...
        values["voyage_api_key"] = convert_to_secret_str(get_from_dict_or_env(values, "voyage_api_key", "VOYAGE_API_KEY"))
        ...
        if "batch_size" not in values:
            values["batch_size"] = 72 if "model" in values and (values["model"] in ["voyage-2", "voyage-02"]) else 7
