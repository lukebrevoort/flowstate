...
class HuggingFaceBgeEmbeddings(BaseModel, Embeddings):
    ...
    def __init__(self, **kwargs: Any):
        ...
        extra_model_kwargs_dict = {k: self.model_kwargs.pop(k) for k in extra_model_kwargs if k in self.model_kwargs}
        self.client = sentence_transformers.SentenceTransformer(
            self.model_name,
...
class HuggingFaceInferenceAPIEmbeddings(BaseModel, Embeddings):
    ...
    def _default_api_url(self) -> str:
        return "https://api-inference.huggingface.co" "/pipeline" "/feature-extraction" f"/{self.model_name}"
