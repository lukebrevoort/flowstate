...
class VertexAIEmbeddings(_VertexAICommon, Embeddings):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.instance["embeddings_task_type_supported"] = not self.client._endpoint_name.endswith("/textembedding-gecko@001")
    ...
    def embed(
        ...
        if batch_size > 0:
            ...
            first_batch_result, batches = self._prepare_and_validate_batches(texts, embeddings_task_type)
