    ...
    def from_credentials(
        ...
        *,
        ...
        try:
            ...
            raise ImportError("elasticsearch package not found, please install with 'pip install " "elasticsearch'")
    ...
    def _embedding_func(self, texts: List[str]) -> List[List[float]]:
        ...
        Returns:
            List[List[float]]: A list of embeddings, one for each text in the input
                list.
        """
        response = self.client.infer_trained_model(model_id=self.model_id, docs=[{self.input_field: text} for text in texts])
