...
class AzureOpenAIEmbeddings(OpenAIEmbeddings):
    ...
    def validate_environment(cls, values: Dict) -> Any:
        ...
        values["openai_api_key"] = (
            values.get("openai_api_key") or os.getenv("AZURE_OPENAI_API_KEY") or os.getenv("OPENAI_API_KEY")
        )
        ...
        values["openai_organization"] = (
            values.get("openai_organization") or os.getenv("OPENAI_ORG_ID") or os.getenv("OPENAI_ORGANIZATION")
        )
        ...
        values["azure_endpoint"] = values.get("azure_endpoint") or os.getenv("AZURE_OPENAI_ENDPOINT")
        values["azure_ad_token"] = values.get("azure_ad_token") or os.getenv("AZURE_OPENAI_AD_TOKEN")
