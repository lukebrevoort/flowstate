...
class QuantizedBgeEmbeddings(BaseModel, Embeddings):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if importlib.util.find_spec("torch") is None:
            raise ImportError("Could not import torch python package. " "Please install it with `pip install -U torch`.")

        # check onnx python package
        if importlib.util.find_spec("onnx") is None:
            raise ImportError("Could not import onnx python package. " "Please install it with `pip install -U onnx`.")
    ...
    def load_model(self) -> None:
        ...
        self.transformer_model = AutoModel.from_pretrained(onnx_model_path, use_embedding_runtime=True)
    ...
    def embed_documents(self, texts: List[str]) -> List[List[float]]:
        ...
        try:
            ...
            raise ImportError("Unable to import pandas, please install with `pip install -U pandas`.") from e
