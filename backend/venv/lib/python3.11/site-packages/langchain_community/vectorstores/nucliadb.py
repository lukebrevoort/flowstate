...
class NucliaDB(VectorStore):
    ...
    def __init__(
        ...
        try:
            ...
            raise ImportError("nuclia python package not found. " "Please install it with `pip install nuclia`.")
    ...
    def similarity_search(self, query: str, k: int = 4, **kwargs: Any) -> List[Document]:
        ...
        return [Document(page_content=paragraph["text"], metadata=paragraph["metadata"]) for paragraph in sorted_paragraphs]
