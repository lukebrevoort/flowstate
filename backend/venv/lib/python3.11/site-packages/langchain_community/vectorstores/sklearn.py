...
class SKLearnVectorStore(VectorStore):
    ...
    def persist(self) -> None:
        if self._serializer is None:
            raise SKLearnVectorStoreException("You must specify a persist_path on creation to persist the collection.")
        data = {
            "ids": self._ids,
            "texts": self._texts,
    ...
    def _load(self) -> None:
        if self._serializer is None:
            raise SKLearnVectorStoreException("You must specify a persist_path on creation to load the collection.")
    ...
    def similarity_search_with_score(self, query: str, *, k: int = DEFAULT_K, **kwargs: Any) -> List[Tuple[Document, float]]:
    ...
    def max_marginal_relevance_search(
        ...
        **kwargs: Any,
        ...
        docs = self.max_marginal_relevance_search_by_vector(embedding, k, fetch_k, lambda_mul=lambda_mult)
        return docs
