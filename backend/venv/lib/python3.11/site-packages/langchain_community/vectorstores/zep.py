...
class ZepVectorStore(VectorStore):
    ...
    def search(
        ...
        **kwargs: Any,
        ...
        if search_type == "similarity":
            ...
            raise ValueError(f"search_type of {search_type} not allowed. Expected " "search_type to be 'similarity' or 'mmr'.")
    ...
    async def asearch(
        ...
        **kwargs: Any,
        ...
        if search_type == "similarity":
            ...
            return await self.amax_marginal_relevance_search(query, k=k, metadata=metadata, **kwargs)
        else:
            raise ValueError(f"search_type of {search_type} not allowed. Expected " "search_type to be 'similarity' or 'mmr'.")
    ...
    def similarity_search_with_score(
        ...
        **kwargs: Any,
        ...
        return self._similarity_search_with_relevance_scores(query, k=k, metadata=metadata, **kwargs)
    ...
    def _similarity_search_with_relevance_scores(
        ...
        **kwargs: Any,
        ...
        if not self._collection.is_auto_embedded and self._embedding:
            ...
            results = self._collection.search(embedding=query_vector, limit=k, metadata=metadata, **kwargs)
        else:
    ...
    async def asimilarity_search_with_relevance_scores(
        ...
        **kwargs: Any,
        ...
        if not self._collection.is_auto_embedded and self._embedding:
            query_vector = self._embedding.embed_query(query)
            results = await self._collection.asearch(embedding=query_vector, limit=k, metadata=metadata, **kwargs)
        else:
    ...
    async def asimilarity_search(
        ...
        **kwargs: Any,
        ...
        results = await self.asimilarity_search_with_relevance_scores(query, k, metadata=metadata, **kwargs)
