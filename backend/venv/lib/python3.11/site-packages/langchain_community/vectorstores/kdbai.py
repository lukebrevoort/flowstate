...
class KDBAI(VectorStore):
    ...
    def __init__(
        ...
        try:
            ...
            raise ImportError(
                "Could not import kdbai_client python package. " "Please install it with `pip install kdbai_client`."
            )
        self._table = table
    ...
    def add_documents(self, documents: List[Document], batch_size: int = 32, **kwargs: Any) -> List[str]:
    ...
    def similarity_search_with_score(
        ...
        **kwargs: Any,
        ...
        """
        return self.similarity_search_by_vector_with_score(self._embed_query(query), k=k, filter=filter, **kwargs)
