...
class SparseRetrievalStrategy(BaseRetrievalStrategy):
    ...
    def index(
        ...
        return {
            "mappings": {"properties": {vector_query_field: {"properties": {"tokens": {"type": "rank_features"}}}}},
...
class ElasticsearchStore(VectorStore):
    ...
    def _create_index_if_not_exists(self, index_name: str, dims_length: Optional[int] = None) -> None:
    ...
    def from_texts(
        ...
        **kwargs: Any,
        ...
        elasticsearchStore = ElasticsearchStore._create_cls_from_kwargs(embedding=embedding, **kwargs)
