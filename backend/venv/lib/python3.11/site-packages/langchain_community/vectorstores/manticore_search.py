    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            raise ImportError(
                "Could not import manticoresearch python package. " "Please install it with `pip install manticoresearch-dev`."
            )
...
"""
    ...
    def __repr__(self) -> str:
        ...
        for r in self.client["utils"].sql(f"DESCRIBE {self.config.table}")[0]["data"]:
            _repr += f"|\033[94m{r['Field']:24s}\033[0m|\033[" f"96m{r['Type'] + ' ' + r['Properties']:24s}\033[0m|\n"
        _repr += "-" * 51 + "\n"
        return _repr
