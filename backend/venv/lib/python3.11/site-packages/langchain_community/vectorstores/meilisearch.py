...
def _create_client(
    ...
    try:
        ...
        raise ImportError("Could not import meilisearch python package. " "Please install it with `pip install meilisearch`.")
    if not client:
...
class Meilisearch(VectorStore):
    ...
    def __init__(
        ...
        *,
        ...
        self._embedders_settings = self._client.index(str(self._index_name)).update_embedders(embedders)
