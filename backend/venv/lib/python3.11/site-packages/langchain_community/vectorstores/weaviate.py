...
class Weaviate(VectorStore):
    ...
    def similarity_search(self, query: str, k: int = 4, **kwargs: Any) -> List[Document]:
        ...
        if self._by_text:
            ...
            if self._embedding is None:
                raise ValueError("_embedding cannot be None for similarity_search when " "_by_text=False")
    ...
    def max_marginal_relevance_search(
        ...
        **kwargs: Any,
        ...
        return self.max_marginal_relevance_search_by_vector(embedding, k=k, fetch_k=fetch_k, lambda_mult=lambda_mult, **kwargs)
    ...
    def max_marginal_relevance_search_by_vector(
        ...
        **kwargs: Any,
        ...
        if kwargs.get("tenant"):
            query_obj = query_obj.with_tenant(kwargs.get("tenant"))
        results = query_obj.with_additional("vector").with_near_vector(vector).with_limit(fetch_k).do()
