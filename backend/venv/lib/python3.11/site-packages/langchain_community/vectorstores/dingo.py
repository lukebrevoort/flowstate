...
class Dingo(VectorStore):
    ...
    def __init__(
        ...
        *,
        ...
        try:
            ...
            raise ImportError("Could not import dingo python package. " "Please install it with `pip install dingodb.")
    ...
    def add_texts(
        ...
        **kwargs: Any,
        ...
        for i in range(0, len(list(texts)), batch_size):
            j = i + batch_size
            add_res = self._client.vector_add(self._index_name, metadatas_list[i:j], embeds[i:j], ids[i:j])
            if not add_res:
    ...
    def similarity_search(
        ...
        **kwargs: Any,
        ...
        """
        docs_and_scores = self.similarity_search_with_score(query, k=k, search_params=search_params, **kwargs)
    ...
    def max_marginal_relevance_search_by_vector(
        ...
        **kwargs: Any,
        ...
        """
        results = self._client.vector_search(self._index_name, [embedding], search_params=search_params, top_k=k)
    ...
    def max_marginal_relevance_search(
        ...
        **kwargs: Any,
        ...
        return self.max_marginal_relevance_search_by_vector(embedding, k, fetch_k, lambda_mult, search_params)
    ...
    def from_texts(
        ...
        **kwargs: Any,
        ...
        for i in range(0, len(list(texts)), batch_size):
            j = i + batch_size
            add_res = dingo_client.vector_add(index_name, metadatas_list[i:j], embeds[i:j], ids[i:j])
            if not add_res:
                raise Exception("vector add fail")
