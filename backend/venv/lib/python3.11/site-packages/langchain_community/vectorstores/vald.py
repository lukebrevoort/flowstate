...
class Vald(VectorStore):
    ...
    def _get_channel(self) -> Any:
        try:
            ...
            raise ImportError("Could not import grpcio python package. " "Please install it with `pip install grpcio`.")
        return (
    ...
    def similarity_search(
        ...
        **kwargs: Any,
        ...
        docs_and_scores = self.similarity_search_with_score(query, k, radius, epsilon, timeout, grpc_metadata)
    ...
    def similarity_search_with_score(
        ...
        **kwargs: Any,
        ...
        docs_and_scores = self.similarity_search_with_score_by_vector(emb, k, radius, epsilon, timeout, grpc_metadata)
    ...
    def similarity_search_by_vector(
        ...
        **kwargs: Any,
        ...
        docs_and_scores = self.similarity_search_with_score_by_vector(embedding, k, radius, epsilon, timeout, grpc_metadata)
