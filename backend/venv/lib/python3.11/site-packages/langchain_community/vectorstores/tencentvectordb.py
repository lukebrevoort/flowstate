...
class TencentVectorDB(VectorStore):
        ...
        **kwargs: Any,
        ...
        for start in range(0, total_count, batch_size):
            ...
            for id in range(start, end, 1):
                ...
                doc_attrs: Dict[str, Any] = {"id": doc_id or "{}-{}-{}".format(time.time_ns(), hash(texts[id]), id)}
                if embeddings:
    ...
    def max_marginal_relevance_search(
        ...
        **kwargs: Any,
        ...
        docs = self.similarity_search_with_score(query=query, k=fetch_k, param=param, expr=expr, timeout=timeout, **kwargs)
        return [doc for doc, _ in docs]
    ...
    def _select_relevance_score_fn(self) -> Callable[[float], float]:
        ...
        if metric_type == "COSINE":
            ...
            raise ValueError("No supported normalization function" f" for distance metric of type: {metric_type}.")
