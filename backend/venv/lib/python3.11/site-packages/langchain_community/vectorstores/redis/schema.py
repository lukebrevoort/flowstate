...
class RedisModel(BaseModel):
    ...
    def add_vector_field(self, vector_field: Dict[str, Any]) -> None:
        ...
        if vector_field["algorithm"] == "FLAT":
            ...
            raise ValueError(f"algorithm must be either FLAT or HNSW. Got " f"{vector_field['algorithm']}")
...
def read_schema(
    ...
    if isinstance(index_schema, dict):
        ...
        raise TypeError(f"index_schema must be a dict, or path to a yaml file " f"Got {type(index_schema)}")
