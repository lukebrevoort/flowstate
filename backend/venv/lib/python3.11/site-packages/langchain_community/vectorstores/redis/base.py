    ...
    def _check_deprecated_kwargs(self, kwargs: Mapping[str, Any]) -> None:
        ...
        for key, value in kwargs.items():
            if key in deprecated_kwargs:
                raise ValueError(f"Keyword argument '{key}' is deprecated. " f"Please use '{deprecated_kwargs[key]}' instead.")
...
class RedisVectorStoreRetriever(VectorStoreRetriever):
    ...
    def _get_relevant_documents(
        ...
        if self.search_type == "similarity":
            ...
            docs_and_similarities = self.vectorstore.similarity_search_with_relevance_scores(query, **_kwargs)
    ...
    async def _aget_relevant_documents(
        ...
        **kwargs: Any,
        ...
        if self.search_type == "similarity":
            ...
            docs_and_similarities = await self.vectorstore.asimilarity_search_with_relevance_scores(query, **_kwargs)
            docs = [doc for doc, _ in docs_and_similarities]
        elif self.search_type == "mmr":
