...
class BigQueryVectorSearch(VectorStore):
    ...
    def __init__(
        ...
        try:
            ...
            raise ImportError(
                "Please, install or upgrade the google-cloud-bigquery library: " "pip install google-cloud-bigquery"
            )
    ...
    async def adelete(self, ids: Optional[List[str]] = None, **kwargs: Any) -> Optional[bool]:
        ...
        Returns:
            ...
            False otherwise, None if not implemented.
        """
        return await asyncio.get_running_loop().run_in_executor(None, partial(self.delete, **kwargs), ids)
    ...
    def _search_with_score_and_embeddings_by_vector(
        ...
        if brute_force:
            ...
            options_string = ',options => \'{"fraction_lists_to_search":' f"{fraction_lists_to_search}}}'"
        else:
            options_string = ""
        query = f"""
            SELECT
    ...
    def similarity_search_with_score(
        ...
        **kwargs: Any,
        ...
        return self.similarity_search_with_score_by_vector(emb, k, filter, brute_force, fraction_lists_to_search, **kwargs)
    ...
    def similarity_search(
        ...
        **kwargs: Any,
        ...
        Returns:
            List of Documents most similar to the query vector.
        """
        tuples = self.similarity_search_with_score(query, k, filter, brute_force, fraction_lists_to_search, **kwargs)
        return [i[0] for i in tuples]
    ...
    def _select_relevance_score_fn(self) -> Callable[[float], float]:
        if self.distance_strategy == DistanceStrategy.COSINE:
            ...
            raise ValueError("Relevance score is not supported " f"for `{self.distance_strategy}` distance.")
    ...
    def max_marginal_relevance_search(
        ...
        **kwargs: Any,
        ...
        mmr_doc_indexes = maximal_marginal_relevance(np.array(query_embedding), doc_embeddings, lambda_mult=lambda_mult, k=k)
    ...
    def max_marginal_relevance_search_by_vector(
        ...
        **kwargs: Any,
        ...
        doc_embeddings = [d[1] for d in doc_tuples]
        mmr_doc_indexes = maximal_marginal_relevance(np.array(embedding), doc_embeddings, lambda_mult=lambda_mult, k=k)
        return [doc_tuples[i][0] for i in mmr_doc_indexes]
