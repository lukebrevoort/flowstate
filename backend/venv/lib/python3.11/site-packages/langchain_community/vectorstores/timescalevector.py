...
class TimescaleVector(VectorStore):
    ...
    async def aadd_texts(
        ...
        **kwargs: Any,
        ...
        """
        embeddings = self.embedding.embed_documents(list(texts))
        return await self.aadd_embeddings(texts=texts, embeddings=embeddings, metadatas=metadatas, ids=ids, **kwargs)
    ...
    def create_index(self, index_type: Union[IndexType, str] = DEFAULT_INDEX_TYPE, **kwargs: Any) -> None:
        try:
            from timescale_vector import client
        except ImportError:
            raise ImportError(
