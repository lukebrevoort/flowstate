...
class SQLiteVSS(VectorStore):
    ...
    def __init__(
        ...
        try:
            ...
            raise ImportError(
                "Could not import sqlite-vss python package. " "Please install it with `pip install sqlite-vss`."
            )
    ...
    def add_texts(
        ...
        **kwargs: Any,
        ...
        data_input = [
            (text, json.dumps(metadata), json.dumps(embed)) for text, metadata, embed in zip(texts, metadatas, embeds)
        ]
