...
class PGVecto_rs(VectorStore):
    ...
    def __init__(
        ...
        try:
            ...
            raise ImportError(
                "Unable to import pgvector_rs.sdk , please install with " '`pip install "pgvecto_rs[sdk]"`.'
            ) from e
    ...
    def add_texts(
        ...
        **kwargs: Any,
        ...
        records = [
            Record.from_text(text, embedding, meta) for text, embedding, meta in zip(texts, embeddings, metadatas or [])
        ]
    ...
    def similarity_search_by_vector(
        ...
        **kwargs: Any,
        ...
        return [doc for doc, _score in self.similarity_search_with_score_by_vector(embedding, k, distance_func, **kwargs)]
    ...
    def similarity_search(
        ...
        **kwargs: Any,
        ...
        query_vector = self._embedding.embed_query(query)
        return [doc for doc, _score in self.similarity_search_with_score_by_vector(query_vector, k, distance_func, **kwargs)]
