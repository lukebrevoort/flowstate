        ...
        if self.flag:
            ...
            if embeddings is not None and metadatas is not None:
                for text, metadata, embed in zip(texts, metadatas, embeddings):
                    ...
                    insert_res = self.vearch.insert_one(self.using_db_name, self.using_table_name, profiles)
                    if insert_res["status"] == 200:
                        docid.append(insert_res["_id"])
                        continue
                    else:
                        retry_insert = self.vearch.insert_one(self.using_db_name, self.using_table_name, profiles)
    ...
    def get(
        ...
        **kwargs: Any,
        ...
        if self.flag:
            ...
            docs_detail = self.vearch.mget_by_ids(self.using_db_name, self.using_table_name, query_data)
