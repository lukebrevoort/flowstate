    ...
    def _similarity_search_with_relevance_scores(
        ...
        **kwargs: Any,
        ...
        if relevance_score_fn is None:
            raise ValueError("normalize_score_fn must be provided to" " ScaNN constructor to normalize scores")
        ...
        if score_threshold is not None:
            docs_and_rel_scores = [
                (doc, similarity) for doc, similarity in docs_and_rel_scores if similarity >= score_threshold
            ]
