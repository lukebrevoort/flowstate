...
class SurrealDBStore(VectorStore):
        ...
        **kwargs: Any,
        ...
        return [
            ...
            for document, similarity, _ in (
                await self._asimilarity_search_by_vector_with_score(query_embedding, k, filter=filter, **kwargs)
            )
        ]
    ...
    def similarity_search_with_relevance_scores(
        ...
        **kwargs: Any,
        ...
        async def _similarity_search_with_relevance_scores() -> List[Tuple[Document, float]]:
            await self.initialize()
            return await self.asimilarity_search_with_relevance_scores(query, k, filter=filter, **kwargs)
    ...
    async def asimilarity_search_by_vector(
        ...
        **kwargs: Any,
        ...
        return [
            document
            for document, _, _ in await self._asimilarity_search_by_vector_with_score(embedding, k, filter=filter, **kwargs)
        ]
    ...
    async def amax_marginal_relevance_search_by_vector(
        ...
        **kwargs: Any,
        ...
        result = await self._asimilarity_search_by_vector_with_score(embedding, fetch_k, filter=filter, **kwargs)
    ...
    async def amax_marginal_relevance_search(
        ...
        **kwargs: Any,
        ...
        docs = await self.amax_marginal_relevance_search_by_vector(embedding, k, fetch_k, lambda_mult, filter=filter, **kwargs)
        return docs
    ...
    def max_marginal_relevance_search(
        ...
        **kwargs: Any,
        ...
        async def _max_marginal_relevance_search() -> List[Document]:
            await self.initialize()
            return await self.amax_marginal_relevance_search(query, k, fetch_k, lambda_mult, filter=filter, **kwargs)
