...
class AwaDB(VectorStore):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            raise ImportError("Could not import awadb python package. " "Please install it with `pip install awadb`.")
    ...
    def max_marginal_relevance_search_by_vector(
        ...
        **kwargs: Any,
        ...
        selected_docs = maximal_marginal_relevance(np.array(embedding, dtype=np.float32), embedding_list=top_embeddings)
    ...
    def update(
        ...
        **kwargs: Any,
        ...
        return self.awadb_client.UpdateTexts(ids=ids, text_field_name="embedding_text", texts=texts, metadatas=metadatas)
