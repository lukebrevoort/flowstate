...
class Annoy(VectorStore):
    ...
    def similarity_search_with_score_by_vector(
        ...
        """
        idxs, dists = self.index.get_nns_by_vector(embedding, k, search_k=search_k, include_distances=True)
    ...
    def similarity_search_with_score(self, query: str, k: int = 4, search_k: int = -1) -> List[Tuple[Document, float]]:
        """Return docs most similar to query.
    ...
    def similarity_search(self, query: str, k: int = 4, search_k: int = -1, **kwargs: Any) -> List[Document]:
        """Return docs most similar to query.
    ...
    def max_marginal_relevance_search_by_vector(
        ...
        **kwargs: Any,
        ...
        """
        idxs = self.index.get_nns_by_vector(embedding, fetch_k, search_k=-1, include_distances=False)
