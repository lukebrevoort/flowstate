...
class Typesense(VectorStore):
    ...
    def __init__(
        ...
        *,
        ...
        try:
            ...
            raise ImportError("Could not import typesense python package. " "Please install it with `pip install typesense`.")
        if not isinstance(typesense_client, Client):
            raise ValueError(f"typesense_client should be an instance of typesense.Client, " f"got {type(typesense_client)}")
    ...
    def from_client_params(
        ...
        **kwargs: Any,
        ...
        typesense_api_key = typesense_api_key or get_from_env("typesense_api_key", "TYPESENSE_API_KEY")
        client_config = {
            "nodes": [node],
