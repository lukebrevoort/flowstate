...
class Jaguar(VectorStore):
    ...
    def similarity_search_with_score(
        ...
        **kwargs: Any,
        ...
        podstore = self._pod + "." + self._store
        q = "select similarity(" + vcol + ",'" + qv_comma + "','topk=" + str(k) + ",fetch_k=" + str(fetch_k) + ",type=" + vtype
    ...
    def similarity_search(
        ...
        **kwargs: Any,
        ...
        """
        docs_and_scores = self.similarity_search_with_score(query, k=k, where=where, metadatas=metadatas, **kwargs)
