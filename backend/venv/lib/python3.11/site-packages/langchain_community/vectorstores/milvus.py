...
class Milvus(VectorStore):
    ...
    def __init__(
        ...
        *,
        ...
        try:
            ...
            raise ImportError("Could not import pymilvus python package. " "Please install it with `pip install pymilvus`.")
            ...
            if metadatas is not None:
                for d in metadatas:
                    for key, value in d.items():
                        keys = (
                            [x for x in self.fields if x != self._primary_field] if self.auto_id else [x for x in self.fields]
                        )
                        if key in keys:
    ...
    def delete(self, ids: Optional[List[str]] = None, expr: Optional[str] = None, **kwargs: Any) -> MutationResult:
