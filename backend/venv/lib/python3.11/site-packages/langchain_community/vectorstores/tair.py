...
class Tair(VectorStore):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            raise ImportError("Could not import tair python package. " "Please install it with `pip install tair`.")
        try:
    ...
    def similarity_search(self, query: str, k: int = 4, **kwargs: Any) -> List[Document]:
        ...
        keys_and_scores = self.client.tvs_knnsearch(self.index_name, k, embedding, False, None, **kwargs)
    ...
    def from_documents(
        ...
        **kwargs: Any,
        ...
        return cls.from_texts(texts, embedding, metadatas, index_name, content_key, metadata_key, **kwargs)
