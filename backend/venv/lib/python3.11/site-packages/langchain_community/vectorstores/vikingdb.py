...
class VikingDB(VectorStore):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            raise ImportError(
                "Could not import volcengine python package. " "Please install it with `pip install --upgrade volcengine`."
            )
        ...
        if metadatas:
            for key, value in metadatas[0].items():
                ...
                if isinstance(value, str):
                    ...
                    raise ValueError("metadatas value is invalidplease change the type of metadatas.")
    ...
    def similarity_search_with_score(
        ...
        **kwargs: Any,
        ...
        res = self.similarity_search_with_score_by_vector(embedding=embedding, params=params, **kwargs)
        return res
    ...
    def max_marginal_relevance_search_by_vector(  # type: ignore[override]
        ...
        **kwargs: Any,
        ...
        for item in res:
            if "vector" not in item.fields or "primary_key" not in item.fields or "text" not in item.fields:
                continue
