...
class DocumentDBVectorSearch(VectorStore):
    ...
    def _insert_texts(self, texts: List[str], metadatas: List[Dict[str, Any]]) -> List:
        ...
        to_insert = [
            {self._text_key: t, self._embedding_key: embedding, **m} for t, m, embedding in zip(texts, metadatas, embeddings)
        ]
    ...
    def similarity_search(
        ...
        **kwargs: Any,
        ...
        docs = self._similarity_search_without_score(embeddings=embeddings, k=k, ef_search=ef_search, filter=filter)
