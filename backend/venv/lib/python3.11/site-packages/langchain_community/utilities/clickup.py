...
class Space(Component):
    ...
    def from_data(cls, data: Dict[str, Any]) -> "Space":
        ...
        enabled_features = {feature: value for feature, value in space_data["features"].items() if value["enabled"]}
        return cls(
            id=space_data["id"],
...
def parse_dict_through_component(data: dict, component: Type[Component], fault_tolerant: bool = False) -> Dict:
