...
class MerriamWebsterAPIWrapper(BaseModel):
    ...
    def validate_environment(cls, values: Dict) -> Any:
        ...
        merriam_webster_api_key = get_from_dict_or_env(values, "merriam_webster_api_key", "MERRIAM_WEBSTER_API_KEY")
    ...
    def run(self, query: str) -> str:
        ...
        request_url = f"{MERRIAM_WEBSTER_API_URL}/{quoted_query}" f"?key={self.merriam_webster_api_key}"
