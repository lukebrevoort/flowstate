...
class DataheraldAPIWrapper(BaseModel):
    ...
    def validate_environment(cls, values: Dict) -> Any:
        ...
        dataherald_api_key = get_from_dict_or_env(values, "dataherald_api_key", "DATAHERALD_API_KEY")
        ...
        try:
            ...
            raise ImportError("dataherald is not installed. " "Please install it with `pip install dataherald`")
