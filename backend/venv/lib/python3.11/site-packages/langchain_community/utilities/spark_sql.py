...
class SparkSQL:
    ...
    def __init__(
        ...
        try:
            ...
            raise ImportError("pyspark is not installed. Please install it with `pip install pyspark`")
    ...
    @classmethod
    def from_uri(cls, database_uri: str, engine_args: Optional[dict] = None, **kwargs: Any) -> SparkSQL:
