...
class SerpAPIWrapper(BaseModel):
    ...
    def validate_environment(cls, values: Dict) -> Any:
        ...
        try:
            ...
            raise ImportError(
                "Could not import serpapi python package. " "Please install it with `pip install google-search-results`."
            )
        return values
    ...
    def _process_response(res: dict) -> str:
        ...
        elif "popular_destinations" in res.keys() and "destinations" in res["popular_destinations"].keys():
