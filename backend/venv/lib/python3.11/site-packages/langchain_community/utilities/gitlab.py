...
class GitLabAPIWrapper(BaseModel):
    ...
    def validate_environment(cls, values: Dict) -> Any:
        ...
        gitlab_url = get_from_dict_or_env(values, "gitlab_url", "GITLAB_URL", default="https://gitlab.com")
    ...
    def create_branch(self, proposed_branch_name: str) -> str:
        ...
        for i in range(max_attempts):
            try:
                ...
                return f"Branch '{response.name}' " "created successfully, and set as current active branch."
