...
class PubMedAPIWrapper(BaseModel):
    ...
    def validate_environment(cls, values: Dict) -> Any:
        ...
        try:
            ...
            raise ImportError("Could not import xmltodict python package. " "Please install it with `pip install xmltodict`.")
        return values
        ...
        while True:
            try:
                ...
                if e.code == 429 and retry < self.max_retry:
                    ...
                    print(f"Too Many Requests, " f"waiting for {self.sleep_time:.2f} seconds...")  # noqa: T201
