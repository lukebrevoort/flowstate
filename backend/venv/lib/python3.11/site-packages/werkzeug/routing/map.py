...
class Map:
    ...
    def __init__(
        ...
        if encoding_errors is not None:
            warnings.warn(
                "The 'encoding_errors' parameter is deprecated and will be" " removed in Werkzeug 3.0.",
                DeprecationWarning,
                stacklevel=2,
            )
        else:
    ...
    def bind_to_environ(
        ...
        if subdomain is None and not self.host_matching:
            ...
            if cur_server_name[offset:] != real_server_name:
                ...
                warnings.warn(
                    f"Current server name {wsgi_server_name!r} doesn't match configured" f" server name {server_name!r}",
                    stacklevel=2,
                )
                subdomain = "<invalid>"
            else:
...
class MapAdapter:
    ...
    def match(
        ...
        try:
            ...
            new_path = quote(e.path_info, safe="!$&'()*+,/:;=@", encoding=self.map.charset)
