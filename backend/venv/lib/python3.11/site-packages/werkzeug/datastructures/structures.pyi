...
class MultiDict(TypeConversionDict[K, V]):
    ...
    def update(self, mapping: Mapping[K, Iterable[V] | V] | Iterable[tuple[K, V]]) -> None: ...  # type: ignore
    @overload
...
class OrderedMultiDict(MultiDict[K, V]):
    ...
    def setlist(self, key: K, new_list: Iterable[V]) -> None: ...
    def setlistdefault(self, key: K, default_list: Iterable[V] | None = None) -> list[V]: ...
    def update(self, mapping: Mapping[K, V] | Iterable[tuple[K, V]]) -> None: ...  # type: ignore
    def poplist(self, key: K) -> list[V]: ...
    @overload
    def pop(self, key: K) -> V: ...
    @overload
...
class ImmutableMultiDict(ImmutableMultiDictMixin[K, V], MultiDict[K, V]):  # type: ignore
    def copy(self) -> MultiDict[K, V]: ...
    def __copy__(self) -> ImmutableMultiDict[K, V]: ...

class ImmutableOrderedMultiDict(ImmutableMultiDictMixin[K, V], OrderedMultiDict[K, V]):  # type: ignore
