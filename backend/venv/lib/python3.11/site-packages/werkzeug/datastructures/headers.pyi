...
class Headers(dict[str, str]):
    ...
    def __init__(
        self,
        defaults: Mapping[str, str | Iterable[str]] | Iterable[tuple[str, str]] | None = None,
    ) -> None: ...
    @overload
    ...
    def items(self, lower: bool = False) -> Iterator[tuple[str, str]]: ...  # type: ignore
...
class EnvironHeaders(ImmutableHeadersMixin, Headers):
    ...
    def __eq__(self, other: object) -> bool: ...
    def __getitem__(self, key: str, _get_mode: Literal[False] = False) -> str: ...  # type: ignore
    def __iter__(self) -> Iterator[tuple[str, str]]: ...  # type: ignore
