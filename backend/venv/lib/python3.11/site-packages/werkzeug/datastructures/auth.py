...
class WWWAuthenticate:
    ...
    def __init__(
        ...
        self._parameters: dict[str, str] = CallbackDict(values, lambda _: self._trigger_on_update())  # type: ignore[misc]
        self._token = token
    ...
    def parameters(self, value: dict[str, str]) -> None:
        self._parameters = CallbackDict(value, lambda _: self._trigger_on_update())  # type: ignore[misc]
        self._trigger_on_update()
    ...
    def stale(self, value: bool | str | None) -> None:
        ...
        if isinstance(value, bool):
            warnings.warn(
                "Setting the 'stale' property to a boolean is deprecated and will be" " removed in Werkzeug 3.0.",
                DeprecationWarning,
                stacklevel=2,
            )
