...
class Request(_SansIORequest):
    ...
    def from_values(cls, *args: t.Any, **kwargs: t.Any) -> Request:
        ...
        kwargs.setdefault("charset", cls.charset if not isinstance(cls.charset, property) else None)
    ...
    def stream(self) -> t.IO[bytes]:
        ...
        """
        if self.shallow:
            raise RuntimeError("This request was created with 'shallow=True', reading" " from the input stream is disabled.")
