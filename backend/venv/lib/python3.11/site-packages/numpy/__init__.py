...
if __NUMPY_SETUP__:
    ...
    _type_info = [
        ...
        (
            "object0",
            object_,
            "`np.object0` is a deprecated alias for `np.object_`. " "`object` can be used instead.  (Deprecated NumPy 1.24)",
        ),
    ]
    ...
    def __getattr__(attr):
        ...
        if attr in __future_scalars__:
            ...
            # the AttributeError
            warnings.warn(
                f"In the future `np.{attr}` will be defined as the " "corresponding NumPy scalar.", FutureWarning, stacklevel=2
            )
    ...
    core._set_promotion_state(os.environ.get("NPY_PROMOTION_STATE", "weak" if _using_numpy2_behavior() else "legacy"))
