...
""",
    ...
    {"decl": {isintent_out: "    PyObject *#varname#_capi = Py_None;"}, "_check": l_and(iscomplex, isintent_hide)},  # Hidden
    {
        "frompyobj": {hasinitvalue: "    #varname#.r = #init.r#, #varname#.i = #init.i#;"},
    ...
    # String
    {  # Common
        "decl": ["    #ctype# #varname# = NULL;", "    int slen(#varname#);", "    PyObject *#varname#_capi = Py_None;"],
        "callfortran": "#varname#,",
    ...
    },
    {
        "frompyobj": [
            ...
            ('    const char * capi_errmess = "#modulename#.#pyname#:' ' failed to create array from the #nth# `#varname#`";'),
            {
