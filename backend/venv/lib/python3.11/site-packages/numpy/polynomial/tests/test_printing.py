...
class TestLatexRepr:
    ...
    def test_simple_polynomial(self):
        ...
        assert_equal(self.as_latex(p), r"$x \mapsto 1.0 + 2.0\,\left(1.0 + 2.0x\right) + 3.0\,\left(1.0 + 2.0x\right)^{2}$")
    ...
    def test_basis_func(self):
        ...
        assert_equal(
            self.as_latex(p), r"$x \mapsto 1.0\,{T}_{0}(1.0 + 2.0x) + 2.0\,{T}_{1}(1.0 + 2.0x) + 3.0\,{T}_{2}(1.0 + 2.0x)$"
        )
...
class TestPrintOptions:
    ...
    def test_latex(self):
        ...
        with printoptions(precision=3):
            assert_equal(
                p._repr_latex_(),
                r"$x \mapsto \text{0.5} + \text{0.143}\,x + " r"\text{14285714.286}\,x^{2} + \text{(1.429e+08)}\,x^{3}$",
            )
