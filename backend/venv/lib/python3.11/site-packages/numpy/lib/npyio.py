...
@set_module("numpy")
def load(
    file, mmap_mode=None, allow_pickle=False, fix_imports=True, encoding="ASCII", *, max_header_size=format._MAX_HEADER_SIZE
):
    """
    ...
    with contextlib.ExitStack() as stack:
        ...
        if magic.startswith(_ZIP_PREFIX) or magic.startswith(_ZIP_SUFFIX):
            ...
            stack.pop_all()
            ret = NpzFile(
                fid, own_fid=own_fid, allow_pickle=allow_pickle, pickle_kwargs=pickle_kwargs, max_header_size=max_header_size
            )
            return ret
