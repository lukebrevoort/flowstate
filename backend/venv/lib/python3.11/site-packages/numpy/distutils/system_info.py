...
class fftw_info(system_info):
    ...
    ver_info = [
        ...
        {"name": "fftw2", "libs": ["rfftw", "fftw"], "includes": ["fftw.h", "rfftw.h"], "macros": [("SCIPY_FFTW_H", None)]},
    ]
...
class openblas_info(blas_info):
    ...
    def check_symbols(self, info):
        ...
        prototypes = "\n".join(
            "void %s%s%s();" % (self.symbol_prefix, symbol_name, self.symbol_suffix) for symbol_name in self._require_symbols
        )
        calls = "\n".join(
