...
def temp_file_name():
    # 2019-01-30, 1.17
    warnings.warn(
        "temp_file_name is deprecated since NumPy v1.17, use " "tempfile.mkstemp instead", DeprecationWarning, stacklevel=1
    )
...
def exec_command(command, execute_in="", use_shell=None, use_tee=None, _with_python=1, **env):
    ...
    # 2019-01-30, 1.17
    warnings.warn(
        "exec_command is deprecated since NumPy v1.17, use " "subprocess.Popen instead", DeprecationWarning, stacklevel=1
    )
