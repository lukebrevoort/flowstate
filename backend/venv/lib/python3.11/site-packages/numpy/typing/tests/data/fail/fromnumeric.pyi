...
np.searchsorted(A[0], 0, side="bob")  # E: No overload variant of "searchsorted" matches argument type
np.searchsorted(A[0], 0, sorter=1.0)  # E: No overload variant of "searchsorted" matches argument type
