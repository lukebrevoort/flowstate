...
class MachArLike:
    ...
    def smallest_subnormal(self):
        ...
        if self.ftype(0) == value:
            warnings.warn(
                "The value of the smallest subnormal for {} type " "is zero.".format(self.ftype), UserWarning, stacklevel=2
            )
...
class finfo:
    ...
    def __new__(cls, dtype):
        ...
        if dtype is None:
            ...
            warnings.warn(
                "finfo() dtype cannot be None. This behavior will " "raise an error in the future. (Deprecated in NumPy 1.25)",
                DeprecationWarning,
                stacklevel=2,
            )
