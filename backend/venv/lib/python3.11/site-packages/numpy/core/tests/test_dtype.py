...
from numpy.testing import assert_, assert_equal, assert_array_equal, assert_raises, HAS_REFCOUNT, IS_PYSTON, _OLD_PROMOTION
...
@pytest.mark.skipif(
    sys.version_info >= (3, 12), reason="Python 3.12 has immortal refcounts, this test will no longer " "work. See gh-23986"
)
@pytest.mark.skipif(not HAS_REFCOUNT, reason="Python lacks refcounts")
...
class TestString:
    ...
    def test_repr_structured(self):
        ...
        assert_equal(
            repr(dt),
            "dtype([(('Red pixel', 'r'), 'u1'), " "(('Green pixel', 'g'), 'u1'), " "(('Blue pixel', 'b'), 'u1')], align=True)",
        )
