...
class TestNonzero:
    ...
    def test_nonzero_twodim(self):
        ...
        x = np.array(
            [[(0, 1), (0, 0), (1, 11)], [(1, 1), (1, 0), (0, 0)], [(0, 0), (1, 5), (0, 1)]], dtype=[("a", "f4"), ("b", "u1")]
        )
...
class TestCreationFuncs:
    ...
    def setup_method(self):
        ...
        self.dtypes = sorted(
            dtypes - variable_sized | {np.dtype(tp.str.replace("0", str(i))) for tp in variable_sized for i in range(1, 10)},
