...
class TestDateTime:
    ...
    def test_days_creation(self):
        ...
        assert_equal(
            np.array("2001-03-22", dtype="M8[D]").astype("i8"), (2000 - 1970) * 365 + (2000 - 1972) // 4 + 366 + 31 + 28 + 21
        )
    ...
    def test_string_parser_variants(self):
        ...
        with assert_warns(DeprecationWarning):
            assert_equal(
                np.array(["+1980-02-29T01:02:03"], np.dtype("M8[s]")), np.array(["+1980-02-29 01:02:03Z"], np.dtype("M8[s]"))
            )
        with assert_warns(DeprecationWarning):
            assert_equal(
                np.array(["-1980-02-29T01:02:03"], np.dtype("M8[s]")), np.array(["-1980-02-29 01:02:03Z"], np.dtype("M8[s]"))
        ...
        with assert_warns(DeprecationWarning):
            assert_equal(
                np.array(["1980-02-29T02:02:03"], np.dtype("M8[s]")), np.array(["1980-02-29 00:32:03-0130"], np.dtype("M8[s]"))
            )
        with assert_warns(DeprecationWarning):
            assert_equal(
    ...
    def test_datetime_as_string(self):
        ...
        # unit='auto' parameter
        assert_equal(
            np.datetime_as_string(np.datetime64("2032-07-18T12:23:34.123456", "us"), unit="auto"), "2032-07-18T12:23:34.123456"
        )
        assert_equal(
            np.datetime_as_string(np.datetime64("2032-07-18T12:23:34.12", "us"), unit="auto"), "2032-07-18T12:23:34.120"
        )
        assert_equal(np.datetime_as_string(np.datetime64("2032-07-18T12:23:34", "us"), unit="auto"), "2032-07-18T12:23:34")
    ...
    def test_datetime_busday_holidays_offset(self):
        ...
        assert_equal(
            np.busday_offset("2011-11-10", 1, holidays=["2011-10-10", "2011-11-11", "2011-11-24"]), np.datetime64("2011-11-14")
        )
        assert_equal(
