...
POSITIONAL_SET = frozenset([POSITIONAL_WARNING, POSITIONAL_EXCEPTION, POSITIONAL_IGNORE])
        ...
        def positional_wrapper(*args, **kwargs):
            if len(args) > max_positional_args:
                ...
                if max_positional_args != 1:
                    plural_s = "s"
                message = "{function}() takes at most {args_max} positional " "argument{plural} ({args_given} given)".format(
