...
class HttpRequest(object):
    ...
    def execute(self, http=None, num_retries=0):
        ...
        if len(self.uri) > MAX_URI_LENGTH and self.method == "GET":
            ...
            self.uri = urllib.parse.urlunparse((parsed.scheme, parsed.netloc, parsed.path, parsed.params, None, None))
    ...
    def next_chunk(self, http=None, num_retries=0):
        ...
        for retry_num in range(num_retries + 1):
            if retry_num > 0:
                ...
                LOGGER.warning(
                    "Retry #%d for media upload: %s %s, following status: %d" % (retry_num, self.method, self.uri, resp.status)
                )
...
class BatchHttpRequest(object):
    ...
    def _serialize_request(self, request):
        ...
        request_line = urllib.parse.urlunparse(("", "", parsed.path, parsed.params, parsed.query, ""))
