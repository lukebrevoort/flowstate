        ...
        try:
            ...
            for decl in iterator:
                ...
                if isinstance(decl, pycparser.c_ast.Decl):
                    ...
                    quals = 0
                    if isinstance(decl.type.type, pycparser.c_ast.IdentifierType) and decl.type.type.names[-1].startswith(
                        "__dotdotdot"
                    ):
                    ...
                    raise CDefError(
                        "unexpected <%s>: this construct is valid " "C but not valid in cdef()" % decl.__class__.__name__, decl
                    )
    ...
    def _parse_constant(self, exprnode, partial_length_ok=False):
        ...
        if isinstance(exprnode, pycparser.c_ast.ID) and exprnode.name == "__dotdotdotarray__":
            if partial_length_ok:
                ...
                return "..."
            raise FFIError(
                ":%d: unsupported '[...]' here, cannot derive " "the actual array length in this context" % exprnode.coord.line
            )
        #
