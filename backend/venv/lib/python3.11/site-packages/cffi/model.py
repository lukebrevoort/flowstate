...
class EnumType(StructOrUnionOrEnum):
    ...
    def build_backend_type(self, ffi, finishlist):
        ...
        return global_cache(
            self, ffi, "new_enum_type", self.get_official_name(), self.enumerators, self.enumvalues, base_btype, key=self
        )
    ...
    def build_baseinttype(self, ffi, finishlist):
        ...
        if self.enumvalues:
            ...
            try:
                ...
                pass
            warnings.warn(
                "%r has no values explicitly defined; " "guessing that it is equivalent to 'unsigned int'" % self._get_c_name()
            )
