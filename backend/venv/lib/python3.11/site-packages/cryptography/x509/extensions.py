...
class PolicyInformation:
    ...
    def __repr__(self) -> str:
        return (
            f"<PolicyInformation(policy_identifier={self.policy_identifier}, " f"policy_qualifiers={self.policy_qualifiers})>"
        )
...
class NameConstraints(ExtensionType):
    ...
    def __repr__(self) -> str:
        return (
            f"<NameConstraints(permitted_subtrees={self.permitted_subtrees}, " f"excluded_subtrees={self.excluded_subtrees})>"
        )
...
class IssuingDistributionPoint(ExtensionType):
    ...
    def __init__(
        ...
        if only_some_reasons and (
            not isinstance(only_some_reasons, frozenset) or not all(isinstance(x, ReasonFlags) for x in only_some_reasons)
        ):
