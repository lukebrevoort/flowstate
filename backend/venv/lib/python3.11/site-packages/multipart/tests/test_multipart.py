...
class TestFormParser(unittest.TestCase):
    ...
    def test_octet_stream_max_size(self):
        ...
        f = FormParser(
            "application/octet-stream", on_field, on_file, on_end=on_end, file_name=b"foo.txt", config={"MAX_BODY_SIZE": 10}
        )
...
class TestHelperFunctions(unittest.TestCase):
    ...
    def test_parse_form_content_length(self):
        ...
        parse_form(
            {"Content-Type": "application/octet-stream", "Content-Length": "10"}, BytesIO(b"123456789012345"), None, on_file
        )
