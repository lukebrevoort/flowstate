...
class FormParser:
    ...
    def __init__(
        ...
        if content_type == "application/octet-stream":
            ...
            # Instantiate parser.
            parser = QuerystringParser(callbacks=callbacks, max_size=self.config["MAX_BODY_SIZE"])
            ...
            parser = MultipartParser(boundary, callbacks, max_size=self.config["MAX_BODY_SIZE"])
