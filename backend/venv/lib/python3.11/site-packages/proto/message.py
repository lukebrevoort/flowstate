...
class MessageMeta(type):
    ...
    def __new__(mcls, name, bases, attrs):
        ...
        desc = descriptor_pb2.DescriptorProto(
            ...
            oneof_decl=[descriptor_pb2.OneofDescriptorProto(name=i) for i in oneofs.keys()],
            options=opts,
        )
    ...
    def _normalize_print_fields_without_presence(
        ...
        cls._warn_if_including_default_value_fields_is_used_protobuf_5(including_default_value_fields)
        ...
        return (
            (always_print_fields_with_no_presence is None and including_default_value_fields is None)
...
class Message(metaclass=MessageMeta):
        ...
        **kwargs,
        ...
        for key, value in mapping.items():
            ...
            if pb_type is None:
                ...
                raise ValueError("Unknown field for {}: {}".format(self.__class__.__name__, key))
    ...
    def __getattr__(self, key):
        ...
        (key, pb_type) = self._get_pb_type_from_key(key)
        if pb_type is None:
            raise AttributeError("Unknown field for {}: {}".format(self.__class__.__name__, key))
        pb_value = getattr(self._pb, key)
        marshal = self._meta.marshal
