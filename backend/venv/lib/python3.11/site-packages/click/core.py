...
class Command:
    ...
    def get_short_help_str(self, limit: int = 45) -> str:
        ...
        if self.deprecated:
            deprecated_message = f"(DEPRECATED: {self.deprecated})" if isinstance(self.deprecated, str) else "(DEPRECATED)"
...
class Parameter:
    ...
    def handle_parse_result(self, ctx: Context, opts: cabc.Mapping[str, t.Any], args: list[str]) -> tuple[t.Any, list[str]]:
