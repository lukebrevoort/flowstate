...
Authenticator = Callable[
    ...,
    Awaitable[typing.Union[MinimalUser, str, BaseUser, MinimalUserDict, typing.Mapping[str, typing.Any]],],
]
...
class on:
    ...
    class threads:
        ...
        value = typing.Union[ThreadsCreate, ThreadsRead, ThreadsUpdate, ThreadsDelete, ThreadsSearch]
    ...
    class crons:
        ...
        value = typing.Union[CronsCreate, CronsRead, CronsUpdate, CronsDelete, CronsSearch]
    ...
    class store:
        ...
        value = typing.Union[StoreGet, StoreSearch, StoreListNamespaces, StorePut, StoreDelete]
