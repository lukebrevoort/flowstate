...
def _get_headers(api_key: str | None, custom_headers: dict[str, str] | None) -> dict[str, str]:
...
_RUN_METADATA_PATTERN = re.compile(r"(\/threads\/(?P<thread_id>.+))?\/runs\/(?P<run_id>.+)")
...
def get_client(
    *,
    ...
    client = httpx.AsyncClient(
        base_url=url,
        transport=transport,
        timeout=(httpx.Timeout(timeout) if timeout is not None else httpx.Timeout(connect=5, read=300, write=300, pool=5)),
...
class HttpClient:
    ...
    async def stream(
        ...
        *,
        ...
        async with self.client.stream(method, path, headers=request_headers, content=content, params=params) as res:
            if on_response:
                on_response(res)
            # check status
            try:
            ...
            if "text/event-stream" not in content_type:
                raise httpx.TransportError(
                    "Expected response header Content-Type to contain 'text/event-stream', " f"got {content_type!r}"
                )
            # parse SSE
            decoder = SSEDecoder()
...
async def _adecode_json(r: httpx.Response) -> Any:
    body = await r.aread()
    return await asyncio.get_running_loop().run_in_executor(None, orjson.loads, body) if body else None
...
class AssistantsClient:
    ...
    async def get(self, assistant_id: str, *, headers: dict[str, str] | None = None) -> Assistant:
    ...
    async def get_graph(
        ...
        *,
        ...
        """  # noqa: E501
        return await self.http.get(f"/assistants/{assistant_id}/graph", params={"xray": xray}, headers=headers)

    async def get_schemas(self, assistant_id: str, *, headers: dict[str, str] | None = None) -> GraphSchema:
        ...
        """  # noqa: E501
        return await self.http.get(f"/assistants/{assistant_id}/schemas", headers=headers)
    ...
    async def get_versions(
        ...
        *,
        ...
        if metadata:
            payload["metadata"] = metadata
        return await self.http.post(f"/assistants/{assistant_id}/versions", json=payload, headers=headers)
    ...
    async def set_latest(
        ...
        *,
        ...
        return await self.http.post(f"/assistants/{assistant_id}/latest", json=payload, headers=headers)
...
class ThreadsClient:
    ...
    async def get(self, thread_id: str, *, headers: dict[str, str] | None = None) -> Thread:
        """Get a thread by ID.
    ...
    async def update(
        ...
        *,
        ...
        ???+ example "Example Usage"
            ...
            ```
        """  # noqa: E501
        return await self.http.patch(f"/threads/{thread_id}", json={"metadata": metadata}, headers=headers)

    async def delete(self, thread_id: str, *, headers: dict[str, str] | None = None) -> None:
        """Delete a thread.
    ...
    async def copy(self, thread_id: str, *, headers: dict[str, str] | None = None) -> None:
        """Copy a thread.
        ...
        """  # noqa: E501
        return await self.http.post(f"/threads/{thread_id}/copy", json=None, headers=headers)
    ...
    async def update_state(
        ...
        *,
        ...
        return await self.http.post(f"/threads/{thread_id}/state", json=payload, headers=headers)
    ...
    async def get_history(
        ...
        *,
        ...
        if checkpoint:
            payload["checkpoint"] = checkpoint
        return await self.http.post(f"/threads/{thread_id}/history", json=payload, headers=headers)
...
class RunsClient:
    ...
    def stream(
        ...
        *,
        ...
        payload = {
            "input": input,
            "command": ({k: v for k, v in command.items() if v is not None} if command else None),
            "config": config,
            "metadata": metadata,
        ...
        endpoint = f"/threads/{thread_id}/runs/stream" if thread_id is not None else "/runs/stream"
    ...
    async def wait(
        ...
        *,
        ...
        endpoint = f"/threads/{thread_id}/runs/wait" if thread_id is not None else "/runs/wait"
        ...
        if raise_error and isinstance(response, dict) and "__error__" in response and isinstance(response["__error__"], dict):
            raise Exception(f"{response['__error__'].get('error')}: {response['__error__'].get('message')}")
        return response
    ...
    async def list(
        ...
        *,
        ...
        return await self.http.get(f"/threads/{thread_id}/runs", params=params, headers=headers)

    async def get(self, thread_id: str, run_id: str, *, headers: dict[str, str] | None = None) -> Run:
        """Get a run.
        ...
        return await self.http.get(f"/threads/{thread_id}/runs/{run_id}", headers=headers)
    ...
    async def join(self, thread_id: str, run_id: str, *, headers: dict[str, str] | None = None) -> dict:
        ...
        """  # noqa: E501
        return await self.http.get(f"/threads/{thread_id}/runs/{run_id}/join", headers=headers)
    ...
    async def delete(self, thread_id: str, run_id: str, *, headers: dict[str, str] | None = None) -> None:
        """Delete a run.
...
class CronClient:
    ...
    async def create_for_thread(
        ...
        *,
        ...
        payload = {k: v for k, v in payload.items() if v is not None}
        return await self.http.post(f"/threads/{thread_id}/runs/crons", json=payload, headers=headers)
...
class StoreClient:
    ...
    async def put_item(
        ...
        for label in namespace:
            if "." in label:
                raise ValueError(f"Invalid namespace label '{label}'. Namespace labels cannot contain periods ('.').")
        payload = {
            "namespace": namespace,
            "key": key,
            "value": value,
        ...
        await self.http.put("/store/items", json=_provided_vals(payload), headers=headers)
...
class SyncHttpClient:
    ...
    def stream(
        ...
        *,
        ...
        if headers:
            request_headers.update(headers)
        with self.client.stream(method, path, headers=request_headers, content=content, params=params) as res:
            if on_response:
                on_response(res)
            # check status
            try:
...
class SyncAssistantsClient:
    ...
    def get_graph(
        ...
        *,
        ...
        """  # noqa: E501
        return self.http.get(f"/assistants/{assistant_id}/graph", params={"xray": xray}, headers=headers)
    ...
    def get_versions(
        ...
        *,
        ...
        if metadata:
            payload["metadata"] = metadata
        return self.http.post(f"/assistants/{assistant_id}/versions", json=payload, headers=headers)
    ...
    def set_latest(
        ...
        *,
        ...
        return self.http.post(f"/assistants/{assistant_id}/latest", json=payload, headers=headers)
...
class SyncThreadsClient:
    ...
    def update(
        ...
        *,
        ...
        ???+ example "Example Usage"
            ...
            ```
        """  # noqa: E501
        return self.http.patch(f"/threads/{thread_id}", json={"metadata": metadata}, headers=headers)
    ...
    def update_state(
        ...
        *,
        ...
        if as_node:
            payload["as_node"] = as_node
        return self.http.post(f"/threads/{thread_id}/state", json=payload, headers=headers)
    ...
    def get_history(
        ...
        *,
        ...
        if checkpoint:
            payload["checkpoint"] = checkpoint
        return self.http.post(f"/threads/{thread_id}/history", json=payload, headers=headers)
...
class SyncRunsClient:
    ...
    def create_batch(self, payloads: list[RunCreate], *, headers: dict[str, str] | None = None) -> list[Run]:
        """Create a batch of stateless background runs."""
    ...
    def list(
        ...
        *,
        ...
        """  # noqa: E501
        return self.http.get(f"/threads/{thread_id}/runs?limit={limit}&offset={offset}", headers=headers)
    ...
    def join(
        ...
        *,
        ...
        """  # noqa: E501
        return self.http.get(f"/threads/{thread_id}/runs/{run_id}/join", headers=headers)
...
class SyncCronClient:
    ...
    def create_for_thread(
        ...
        *,
        ...
        payload = {k: v for k, v in payload.items() if v is not None}
        return self.http.post(f"/threads/{thread_id}/runs/crons", json=payload, headers=headers)
...
class SyncStoreClient:
    ...
    def delete_item(
        ...
        ???+ example "Example Usage"
            ...
            ```
        """
        self.http.delete("/store/items", json={"key": key, "namespace": namespace}, headers=headers)
    ...
    def search_items(
        ...
        return self.http.post("/store/items/search", json=_provided_vals(payload), headers=headers)
    ...
    def list_namespaces(
        ...
        return self.http.post("/store/namespaces", json=_provided_vals(payload), headers=headers)
