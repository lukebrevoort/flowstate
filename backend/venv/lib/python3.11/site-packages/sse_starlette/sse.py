...
Content = Union[str, bytes, dict, ServerSentEvent, Any]  # https://github.com/sysid/sse-starlette/issues/101#issue-2340755790
...
class EventSourceResponse(Response):
    ...
    async def _ping(self, send: Send) -> None:
        ...
        while self.active:
            ...
            ping = (
                ServerSentEvent(comment=f"ping - {datetime.now(timezone.utc)}", sep=self.sep).encode()
