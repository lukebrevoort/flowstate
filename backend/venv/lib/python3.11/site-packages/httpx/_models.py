...
class Headers(typing.MutableMapping[str, str]):
    ...
    def get_list(self, key: str, split_commas: bool = False) -> typing.List[str]:
        ...
        values = [
            item_value.decode(self.encoding) for _, item_key, item_value in self._list if item_key.lower() == get_header_key
        ]
    ...
    def __getitem__(self, key: str) -> str:
        ...
        items = [
            header_value.decode(self.encoding) for _, header_key, header_value in self._list if header_key == normalized_key
        ]
...
class Request:
    def __init__(
        ...
        *,
        ...
        self.method = method.decode("ascii").upper() if isinstance(method, bytes) else method.upper()
        self.url = URL(url)
