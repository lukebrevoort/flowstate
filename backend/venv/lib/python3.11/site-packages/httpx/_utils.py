...
def normalize_header_value(value: typing.Union[str, bytes], encoding: typing.Optional[str] = None) -> bytes:
    """
...
def is_https_redirect(url: "URL", location: "URL") -> bool:
    ...
    return (
        url.scheme == "http" and port_or_default(url) == 80 and location.scheme == "https" and port_or_default(location) == 443
    )
