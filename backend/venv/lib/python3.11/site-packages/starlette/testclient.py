...
class TestClient(httpx.Client):
    ...
    def __enter__(self) -> Self:
        with contextlib.ExitStack() as stack:
            ...
            send: anyio.create_memory_object_stream[MutableMapping[str, Any] | None] = anyio.create_memory_object_stream(
                math.inf
            )
            receive: anyio.create_memory_object_stream[MutableMapping[str, Any]] = anyio.create_memory_object_stream(math.inf)
