    ...
    def __init__(
        ...
        *,
        ...
        if _schema_format not in {"original", "streaming_events"}:
            msg = f"Invalid schema format: {_schema_format}. " f"Expected one of 'original', 'streaming_events'."
            ...
            ops.extend(
                [
                    ...
                    },
                    {
                        ...
                        "value": run.end_time.isoformat(timespec="milliseconds") if run.end_time is not None else None,
                    },
                ]
            )
        ...
        try:
            ...
            async for chunk in runnable.astream(value, config, **kwargs):
                ...
                patches.extend(
                    ...
                    for op in jsonpatch.JsonPatch.from_diff(prev_final_output, final_output, dumps=dumps)
                )
