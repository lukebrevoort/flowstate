...
class BaseTracer(_TracerCore, BaseCallbackHandler, ABC):
    ...
    def on_llm_error(
        ...
        **kwargs: Any,
        ...
        # "chat_model" is only used for the experimental new streaming_events format.
        # This change should not affect any existing tracers.
        llm_run = self._errored_llm_run(error=error, run_id=run_id, response=kwargs.pop("response", None))
        self._end_trace(llm_run)
    ...
    @override
    def on_retriever_end(self, documents: Sequence[Document], *, run_id: UUID, **kwargs: Any) -> Run:
