...
class RunnableWithMessageHistory(RunnableBindingBase):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        """
        history_chain: Runnable = RunnableLambda(self._enter_history, self._aenter_history).with_config(
    ...
    def _get_input_messages(self, input_val: Union[str, BaseMessage, Sequence[BaseMessage], dict]) -> list[BaseMessage]:
        from langchain_core.messages import BaseMessage
        ...
        if isinstance(input_val, (list, tuple)):
            ...
            if isinstance(input_val[0], list):
                ...
                return input_val[0]
            return list(input_val)
        msg = f"Expected str, BaseMessage, list[BaseMessage], or tuple[BaseMessage]. " f"Got {input_val}."
        raise ValueError(msg)
    ...
    def _get_output_messages(self, output_val: Union[str, BaseMessage, Sequence[BaseMessage], dict]) -> list[BaseMessage]:
        ...
        msg = f"Expected str, BaseMessage, list[BaseMessage], or tuple[BaseMessage]. " f"Got {output_val}."
        raise ValueError(msg)
    ...
    async def _aenter_history(self, value: dict[str, Any], config: RunnableConfig) -> list[BaseMessage]:
        hist: BaseChatMessageHistory = config["configurable"]["message_history"]
