...
class RouterRunnable(RunnableSerializable[RouterInput, Output]):
    ...
    def config_specs(self) -> list[ConfigurableFieldSpec]:
        return get_unique_config_specs(spec for step in self.runnables.values() for spec in step.config_specs)
    ...
    def __init__(
        ...
        """
        super().__init__(runnables={key: coerce_to_runnable(r) for key, r in runnables.items()})  # type: ignore[call-arg]
    ...
    @override
    def invoke(self, input: RouterInput, config: Optional[RunnableConfig] = None, **kwargs: Any) -> Output:
        key = input["key"]
    ...
    def batch(
        ...
        **kwargs: Optional[Any],
        ...
        def invoke(runnable: Runnable, input_: Input, config: RunnableConfig) -> Union[Output, Exception]:
    ...
    async def abatch(
        ...
        **kwargs: Optional[Any],
        ...
        async def ainvoke(runnable: Runnable, input_: Input, config: RunnableConfig) -> Union[Output, Exception]:
            if return_exceptions:
                try:
