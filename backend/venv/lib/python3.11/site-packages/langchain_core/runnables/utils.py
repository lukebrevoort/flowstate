...
def coro_with_context(coro: Awaitable[Any], context: Context, *, create_task: bool = False) -> Awaitable[Any]:
...
def get_unique_config_specs(
    ...
    for spec_id, dupes in grouped:
        ...
        if len(others) == 0 or all(o == first for o in others):
            ...
            msg = "RunnableSequence contains conflicting config specs" f"for {spec_id}: {[first, *others]}"
