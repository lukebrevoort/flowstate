...
class BaseRetriever(RunnableSerializable[RetrieverInput, RetrieverOutput], ABC):
    ...
    def __init_subclass__(cls, **kwargs: Any) -> None:
        ...
        if cls.get_relevant_documents != BaseRetriever.get_relevant_documents:
            ...
            cls.get_relevant_documents = BaseRetriever.get_relevant_documents  # type: ignore[method-assign]
        ...
        if hasattr(cls, "aget_relevant_documents") and cls.aget_relevant_documents != BaseRetriever.aget_relevant_documents:
            ...
            cls.aget_relevant_documents = BaseRetriever.aget_relevant_documents  # type: ignore[method-assign]
    ...
    async def ainvoke(
        ...
        **kwargs: Any,
        ...
        try:
            kwargs_ = kwargs if self._expects_other_args else {}
            if self._new_arg_supported:
                result = await self._aget_relevant_documents(input, run_manager=run_manager, **kwargs_)
            else:
