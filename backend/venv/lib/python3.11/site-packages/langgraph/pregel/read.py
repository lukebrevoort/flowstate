    ...
    def do_read(
        ...
        *,
        ...
        try:
            ...
            raise RuntimeError("Not configured with a read function" "Make sure to call in the context of a Pregel process")
        if mapper:
...
class PregelNode:
    ...
    def flat_writers(self) -> list[Runnable]:
        ...
        while len(writers) > 1 and isinstance(writers[-1], ChannelWrite) and isinstance(writers[-2], ChannelWrite):
    ...
    def input_cache_key(self) -> INPUT_CACHE_KEY_TYPE:
        ...
        return (
            self.mapper,
            tuple(self.channels) if isinstance(self.channels, list) else (self.channels,),
        )
