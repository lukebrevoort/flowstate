...
class Property(RegexBase):
    ...
    def dump(self, indent, reverse):
        ...
        print(
            "{}PROPERTY {} {}:{}{}".format(INDENT * indent, POS_TEXT[self.positive], name, value, CASE_TEXT[self.case_flags])
        )
...
class Scanner:
    def __init__(self, lexicon, flags=0):
        ...
        self.scanner = _regex.compile(
            None, (flags & GLOBAL_FLAGS) | version, code, {}, {}, {}, [], req_offset, req_chars, req_flags, len(patterns)
        )
