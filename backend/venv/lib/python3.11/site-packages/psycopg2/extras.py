...
from psycopg2._json import json, Json, register_json, register_default_json, register_default_jsonb  # noqa
    ...
    def parse(self, s, curs):
        ...
        if len(tokens) != len(self.atttypes):
            raise psycopg2.DataError(
                "expecting %d components for the type %s, %d found instead" % (len(self.atttypes), self.name, len(tokens))
            )
