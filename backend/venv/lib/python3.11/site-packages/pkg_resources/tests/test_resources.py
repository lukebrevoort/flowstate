...
class TestParsing:
    ...
    def test_requirements_with_markers(self):
        ...
        assert Requirement.parse("name==1.1;python_version=='2.7'") != Requirement.parse("name==1.1;python_version=='3.6'")
        assert Requirement.parse("name==1.0;python_version=='2.7'") != Requirement.parse("name==1.2;python_version=='2.7'")
