...
class CancelScope(BaseCancelScope):
    ...
    def __exit__(
        ...
        return self.__original.__exit__(exc_type, exc_val, exc_tb)  # type: ignore[func-returns-value]
...
current_default_worker_process_limiter: RunVar = RunVar("current_default_worker_process_limiter")
    ...
    while nurseries:
        ...
        for nursery in nurseries:
            for task in nursery.child_tasks:
                task_infos.append(TaskInfo(id(task), id(nursery.parent_task), task.name, task.coro))
...
class TestRunner(abc.TestRunner):
    ...
    def _call(self, func: Callable[..., Awaitable[T_Retval]], *args: object, **kwargs: object) -> T_Retval:
