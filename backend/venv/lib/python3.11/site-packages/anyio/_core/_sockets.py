...
async def create_connected_udp_socket(
    ...
    *,
    ...
    return await get_asynclib().create_udp_socket(family, local_address, remote_address, reuse_port)
...
async def getaddrinfo(
    ...
    *,
    ...
    gai_res = await get_asynclib().getaddrinfo(encoded_host, port, family=family, type=type, proto=proto, flags=flags)
    return [
