...
class BlockingPortal:
    ...
    async def _call_func(self, func: Callable, args: tuple, kwargs: dict[str, Any], future: Future) -> None:
    ...
    def call(self, func: Callable[..., Awaitable[T_Retval] | T_Retval], *args: object) -> T_Retval:
        """
...
def create_blocking_portal() -> BlockingPortal:
    ...
    """
    warn(
        "create_blocking_portal() has been deprecated -- use anyio.from_thread.BlockingPortal() " "directly",
        DeprecationWarning,
    )
