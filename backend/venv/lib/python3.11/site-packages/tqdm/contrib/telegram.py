    ...
    def write(self, s):
        ...
        try:
            future = self.submit(
                ...
                data={"text": "`" + s + "`", "chat_id": self.chat_id, "message_id": message_id, "parse_mode": "MarkdownV2"},
            )
        except Exception as e:
            tqdm_auto.write(str(e))
        else:
    ...
    def __init__(self, *args, **kwargs):
        ...
        if not kwargs.get("disable"):
            ...
            self.tgio = TelegramIO(
                kwargs.pop("token", getenv("TQDM_TELEGRAM_TOKEN")), kwargs.pop("chat_id", getenv("TQDM_TELEGRAM_CHAT_ID"))
            )
