...
worker_config: contextvars.ContextVar[dict[str, typing.Any] | None] = contextvars.ContextVar("worker_config", default=None)
...
class AddPrefixedEnvVars:
    def __init__(self, prefix: str) -> None:
        self.kv = {key.removeprefix(prefix).lower(): value for key, value in os.environ.items() if key.startswith(prefix)}
