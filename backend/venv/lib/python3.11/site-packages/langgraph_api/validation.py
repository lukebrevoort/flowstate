...
AssistantSearchRequest = jsonschema_rs.validator_for(openapi["components"]["schemas"]["AssistantSearchRequest"])
ThreadSearchRequest = jsonschema_rs.validator_for(openapi["components"]["schemas"]["ThreadSearchRequest"])
AssistantCreate = jsonschema_rs.validator_for(openapi["components"]["schemas"]["AssistantCreate"])
AssistantPatch = jsonschema_rs.validator_for(openapi["components"]["schemas"]["AssistantPatch"])
AssistantVersionChange = jsonschema_rs.validator_for(openapi["components"]["schemas"]["AssistantVersionChange"])
ThreadCreate = jsonschema_rs.validator_for(
    {
        **openapi["components"]["schemas"]["ThreadCreate"],
        "components": {
            "schemas": {
                "ThreadSuperstepUpdate": openapi["components"]["schemas"]["ThreadSuperstepUpdate"],
...
ThreadPatch = jsonschema_rs.validator_for(openapi["components"]["schemas"]["ThreadPatch"])
ThreadStateUpdate = jsonschema_rs.validator_for(
    {
        **openapi["components"]["schemas"]["ThreadStateUpdate"],
        "components": {"schemas": {"CheckpointConfig": openapi["components"]["schemas"]["CheckpointConfig"]}},
    }
)
...
RunBatchCreate = jsonschema_rs.validator_for(
    {
        **openapi["components"]["schemas"]["RunBatchCreate"],
        "components": {
            "schemas": {
                "RunCreateStateless": openapi["components"]["schemas"]["RunCreateStateless"],
                "Command": openapi["components"]["schemas"]["Command"],
                "Send": openapi["components"]["schemas"]["Send"],
            }
        },
...
StorePutRequest = jsonschema_rs.validator_for(openapi["components"]["schemas"]["StorePutRequest"])
StoreSearchRequest = jsonschema_rs.validator_for(openapi["components"]["schemas"]["StoreSearchRequest"])
StoreDeleteRequest = jsonschema_rs.validator_for(openapi["components"]["schemas"]["StoreDeleteRequest"])
StoreListNamespacesRequest = jsonschema_rs.validator_for(openapi["components"]["schemas"]["StoreListNamespacesRequest"])
