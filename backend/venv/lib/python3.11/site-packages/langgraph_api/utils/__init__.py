...
AuthContext = contextvars.ContextVar[Auth.types.BaseAuthContext | None]("AuthContext", default=None)


@asynccontextmanager
async def with_user(user: BaseUser | None = None, auth: AuthCredentials | list[str] | None = None):
...
def set_auth_ctx(user: BaseUser | None, auth: AuthCredentials | list[str] | None) -> None:
...
async def fetchone(
    ...
    *,
    ...
    try:
        ...
        raise HTTPException(status_code=not_found_code, detail=not_found_detail) from None
