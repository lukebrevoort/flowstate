    ...
    def sign(self, uri, http_method="GET", body=None, headers=None, realm=None):
        ...
        #       header field set to "application/x-www-form-urlencoded".
            ...
            raise ValueError(
                ...
                "instead of {}".format(content_type or "not set", CONTENT_TYPE_FORM_URLENCODED)
            )
        ...
        elif self.signature_type == SIGNATURE_TYPE_BODY and not (should_have_params and has_params and not multipart):
        ...
        uri, headers, body = self._render(request, formencode=True, realm=(realm or self.realm))
