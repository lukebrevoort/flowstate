...
def sign_hmac_sha1_with_client(sig_base_str, client):
    return _sign_hmac("SHA-1", sig_base_str, client.client_secret, client.resource_owner_secret)
...
def sign_hmac_sha1(base_string, client_secret, resource_owner_secret):
    ...
    it can be removed.
    """
    warnings.warn("use sign_hmac_sha1_with_client instead of sign_hmac_sha1", DeprecationWarning)
    ...
    base_string = base_string.decode("ascii") if isinstance(base_string, bytes) else base_string
...
def sign_hmac_sha256_with_client(sig_base_str, client):
    return _sign_hmac("SHA-256", sig_base_str, client.client_secret, client.resource_owner_secret)
...
def sign_hmac_sha256(base_string, client_secret, resource_owner_secret):
    ...
    it can be removed.
    """
    warnings.warn("use sign_hmac_sha256_with_client instead of sign_hmac_sha256", DeprecationWarning)
...
def sign_rsa_sha1_with_client(sig_base_str, client):
    ...
    sig_base_str = sig_base_str.decode("ascii") if isinstance(sig_base_str, bytes) else sig_base_str
...
def sign_rsa_sha1(base_string, rsa_private_key):
    ...
    it can be removed.
    """
    warnings.warn('use _sign_rsa("SHA-1", ...) instead of sign_rsa_sha1', DeprecationWarning)
