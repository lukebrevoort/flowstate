...
class Client:
    ...
    def add_token(self, uri, http_method="GET", body=None, headers=None, token_placement=None, **kwargs):
        ...
        case_insensitive_token_types = {k.lower(): v for k, v in self.token_types.items()}
    ...
    def prepare_authorization_request(self, authorization_url, state=None, redirect_url=None, scope=None, **kwargs):
        ...
        auth_url = self.prepare_request_uri(
            authorization_url, redirect_uri=self.redirect_url, scope=scope, state=self.state, **kwargs
        )
    ...
    def prepare_token_request(self, token_url, authorization_response=None, redirect_url=None, state=None, body="", **kwargs):
        ...
        self.redirect_url = redirect_url or self.redirect_url
        body = self.prepare_request_body(body=body, redirect_uri=self.redirect_url, **kwargs)
    ...
    def prepare_refresh_token_request(self, token_url, refresh_token=None, body="", scope=None, **kwargs):
        ...
        # do not assign scope to self automatically anymore
        scope = self.scope if scope is None else scope
        body = self.prepare_refresh_body(body=body, refresh_token=refresh_token, scope=scope, **kwargs)
        return token_url, FORM_ENC_HEADERS, body

    def prepare_token_revocation_request(
        self, revocation_url, token, token_type_hint="access_token", body="", callback=None, **kwargs
    ):
    ...
    def _populate_attributes(self, response):
        warnings.warn("Please switch to the public method " "populate_token_attributes.", DeprecationWarning)
