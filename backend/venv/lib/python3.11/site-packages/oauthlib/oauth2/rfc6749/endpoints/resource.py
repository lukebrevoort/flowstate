...
class ResourceEndpoint(BaseEndpoint):
    ...
    def verify_request(self, uri, http_method="GET", body=None, headers=None, scopes=None):
        ...
        token_type_handler = self.tokens.get(request.token_type, self.default_token_type_handler)
        log.debug("Dispatching token_type %s request to %r.", request.token_type, token_type_handler)
