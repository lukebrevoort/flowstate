...
class DeviceClient(Client):
    ...
    def prepare_request_body(self, device_code, body="", scope=None, include_client_id=False, **kwargs):
        ...
        scope = self.scope if scope is None else scope
        return prepare_token_request(self.grant_type, body=body, device_code=device_code, scope=scope, **kwargs)
