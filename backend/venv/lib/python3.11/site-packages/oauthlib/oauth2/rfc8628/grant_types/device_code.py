...
class DeviceCodeGrant(GrantTypeBase):
    def create_authorization_response(self, request: common.Request, token_handler: Callable) -> tuple[dict, str, int]:
        """
    ...
    def create_token_response(self, request: common.Request, token_handler: Callable) -> tuple[dict, str, int]:
