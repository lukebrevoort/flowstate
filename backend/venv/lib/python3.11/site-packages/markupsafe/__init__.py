...
class Markup(str):
    ...
    def split(self, /, sep: str | None = None, maxsplit: t.SupportsIndex = -1) -> list[te.Self]:  # type: ignore[override]
        return [self.__class__(v) for v in super().split(sep, maxsplit)]

    def rsplit(self, /, sep: str | None = None, maxsplit: t.SupportsIndex = -1) -> list[te.Self]:  # type: ignore[override]
