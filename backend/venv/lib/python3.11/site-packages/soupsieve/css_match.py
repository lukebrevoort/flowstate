...
class _DocumentNav:
    ...
    def get_tag_children(
        self, el: bs4.Tag | None, start: int | None = None, reverse: bool = False, no_iframe: bool = False
    ) -> Iterator[bs4.Tag]:
        """Get tag children."""
    ...
    def get_children(
        self, el: bs4.Tag | None, start: int | None = None, reverse: bool = False, tags: bool = False, no_iframe: bool = False
...
class CSSMatch(_DocumentNav):
    ...
    def __init__(
        self, selectors: ct.SelectorList, scope: bs4.Tag | None, namespaces: ct.Namespaces | None, flags: int
    ) -> None:
        """Initialize."""
    ...
    def filter(self) -> list[bs4.Tag]:  # noqa A001
        ...
        return [tag for tag in self.get_contents(self.tag) if isinstance(tag, bs4.Tag) and self.match(tag)]
