...
class GetRequest:
    ...
    def to_json(self) -> str:
        ...
        return json.dumps({"type": "get", "origin": self.origin, "requestData": req_options})
...
class GetResponse:
    ...
    def from_json(json_str: str):
        ...
        if resp_json.get("type") != "getResponse":
            raise exceptions.MalformedError("Invalid Get response type: {}".format(resp_json.get("type")))
        ...
        if pk_cred.get("type") != "public-key":
            raise exceptions.MalformedError("Invalid credential type: {}".format(pk_cred.get("type")))
