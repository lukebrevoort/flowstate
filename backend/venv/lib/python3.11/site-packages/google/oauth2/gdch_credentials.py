...
class ServiceAccountCredentials(credentials.Credentials):
    ...
    def __init__(self, signer, service_identity_name, project, audience, token_uri, ca_cert_path):
        """
        Args:
    ...
    def refresh(self, request):
        ...
        self.token, _, self.expiry, _ = _client._handle_refresh_grant_response(response_data, None)
