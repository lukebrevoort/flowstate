...
class Credentials(
    ...
    def _from_signer_and_info(cls, signer, info, **kwargs):
        ...
        return cls(
            ...
            universe_domain=info.get("universe_domain", credentials.DEFAULT_UNIVERSE_DOMAIN),
    ...
    def with_always_use_jwt_access(self, always_use_jwt_access):
        ...
        """
        cred = self._make_copy()
        if cred._universe_domain != credentials.DEFAULT_UNIVERSE_DOMAIN and not always_use_jwt_access:
            raise exceptions.InvalidValue("always_use_jwt_access should be True for non-default universe domain")
    ...
    def refresh(self, request):
        ...
        if self._universe_domain != credentials.DEFAULT_UNIVERSE_DOMAIN and self._subject:
            raise exceptions.RefreshError("domain wide delegation is not supported for non-default universe domain")
...
class IDTokenCredentials(
    ...
    def __init__(
        ...
        self._iam_id_token_endpoint = iam._IAM_IDTOKEN_ENDPOINT.replace("googleapis.com", self._universe_domain)
    ...
    def _with_use_iam_endpoint(self, use_iam_endpoint):
        ...
        """
        cred = self._make_copy()
        if cred._universe_domain != credentials.DEFAULT_UNIVERSE_DOMAIN and not use_iam_endpoint:
            raise exceptions.InvalidValue("use_iam_endpoint should be True for non-default universe domain")
