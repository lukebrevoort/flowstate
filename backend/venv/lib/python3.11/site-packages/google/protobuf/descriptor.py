...
class FieldDescriptor(DescriptorBase):
    ...
    def is_required(self):
        ...
        return self._GetFeatures().field_presence == _FEATURESET_FIELD_PRESENCE_LEGACY_REQUIRED
    ...
    def has_presence(self):
        ...
        if self.is_repeated:
            return False
        if self.cpp_type == FieldDescriptor.CPPTYPE_MESSAGE or self.is_extension or self.containing_oneof:
            return True
