...
class DescriptorDatabase(object):
    ...
    def Add(self, file_desc_proto):
        ...
        for enum in file_desc_proto.enum_type:
            ...
            for enum_value in enum.value:
                self._file_desc_protos_by_symbol[".".join((package, enum_value.name)) if package else enum_value.name] = (
                    file_desc_proto
                )
    ...
    def FindFileContainingSymbol(self, symbol):
        ...
        if symbol.count(".") == 1 and symbol[0] == ".":
            ...
            warnings.warn(
                'Please remove the leading "." when ' "FindFileContainingSymbol, this will turn to error " "in 2026 Jan.",
                RuntimeWarning,
            )
        try:
