...
class BoolValueChecker(object):
    ...
    def CheckValue(self, proposed_value):
        if not hasattr(proposed_value, "__index__") or (
            type(proposed_value).__module__ == "numpy" and type(proposed_value).__name__ == "ndarray"
        ):
...
class DoubleValueChecker(object):
    ...
    def CheckValue(self, proposed_value):
        ...
        if (not hasattr(proposed_value, "__float__") and not hasattr(proposed_value, "__index__")) or (
            type(proposed_value).__module__ == "numpy" and type(proposed_value).__name__ == "ndarray"
        ):
