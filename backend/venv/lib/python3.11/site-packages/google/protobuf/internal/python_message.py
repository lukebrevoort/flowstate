...
def _AttachFieldHelpers(cls, field_descriptor):
    ...
    if field_descriptor.is_repeated and wire_format.IsTypePackable(field_descriptor.type):
    ...
    def HasField(self, field_name):
        try:
            ...
            raise ValueError(
                ...
                "nor has presence is not available for this field." % (message_descriptor.full_name, field_name)
            ) from exc
    ...
    def InternalParse(self, buffer, pos, end, current_depth=0):
        ...
        while pos != end:
            ...
            if field_des is None:
                ...
                if new_pos == -1:
                    return pos
                self._unknown_fields.append((tag_bytes, buffer[pos + len(tag_bytes) : new_pos].tobytes()))
                pos = new_pos
            else:
...
def _UnknownFields(self):
    raise NotImplementedError(
        "Please use the add-on feaure " "unknown_fields.UnknownFieldSet(message) in " "unknown_fields.py instead."
    )
