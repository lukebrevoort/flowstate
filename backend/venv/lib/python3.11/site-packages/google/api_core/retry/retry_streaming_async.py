    ...
    **kwargs,
    ...
    while True:
        ...
        try:
            ...
            # for each attempt.
            target_output: AsyncIterable[_Y] | Awaitable[AsyncIterable[_Y]] = target(*init_args, **init_kwargs)
            try:
            ...
            while True:
                ...
                try:
                    ...
                    if target_is_generator:
                        ...
                        await cast(AsyncGenerator["_Y", None], target_iterator).athrow(cast(BaseException, sys.exc_info()[1]))
                    else:
                        raise
            return
