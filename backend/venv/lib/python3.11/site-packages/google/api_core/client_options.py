...
class ClientOptions(object):
    ...
    def __init__(
        ...
        client_encrypted_cert_source: Optional[Callable[[], Tuple[str, str, bytes]]] = None,
        ...
        if client_cert_source and client_encrypted_cert_source:
            raise ValueError("client_cert_source and client_encrypted_cert_source are mutually exclusive")
