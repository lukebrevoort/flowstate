...
class QuotaFailure(_message.Message):
    ...
    def __init__(
        self,
        violations: _Optional[_Iterable[_Union[QuotaFailure.Violation, _Mapping]]] = ...,
    ) -> None: ...
...
class PreconditionFailure(_message.Message):
    ...
    def __init__(
        self,
        violations: _Optional[_Iterable[_Union[PreconditionFailure.Violation, _Mapping]]] = ...,
    ) -> None: ...
...
class BadRequest(_message.Message):
    ...
    def __init__(
        self,
        field_violations: _Optional[_Iterable[_Union[BadRequest.FieldViolation, _Mapping]]] = ...,
    ) -> None: ...
