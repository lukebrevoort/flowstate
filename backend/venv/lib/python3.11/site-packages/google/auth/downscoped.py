    ...
    def rules(self, value):
        ...
        if len(value) > _MAX_ACCESS_BOUNDARY_RULES_COUNT:
            raise exceptions.InvalidValue(
                "Credential access boundary rules can have a maximum of {} rules.".format(_MAX_ACCESS_BOUNDARY_RULES_COUNT)
            )
...
class Credentials(credentials.CredentialsWithQuotaProject):
    ...
    def __init__(
        ...
        self._sts_client = sts.Client(_STS_TOKEN_URL_PATTERN.format(self.universe_domain))
