...
class Credentials(
    ...
    def __init__(
        ...
        if self._token_url == _DEFAULT_TOKEN_URL:
            self._token_url = self._token_url.replace("{universe_domain}", self._universe_domain)
        self._token_info_url = token_info_url
        self._credential_source = credential_source
        self._service_account_impersonation_url = service_account_impersonation_url
        self._service_account_impersonation_options = service_account_impersonation_options or {}
        ...
        if self._client_id:
            self._client_auth = utils.ClientAuthentication(utils.ClientAuthType.basic, self._client_id, self._client_secret)
        else:
    ...
    def info(self):
        ...
        config_info.update(
            ...
            service_account_impersonation=config_info.pop("service_account_impersonation_options", None),
        )
    ...
    def refresh(self, request):
        ...
        if self._mtls_required():
            request = functools.partial(request, cert=self._get_mtls_cert_and_key_paths())
    ...
    def _initialize_impersonated_credentials(self):
        ...
        return impersonated_credentials.Credentials(
            ...
            lifetime=self._service_account_impersonation_options.get("token_lifetime_seconds"),
        )
    ...
    def from_info(cls, info, **kwargs):
        ...
        return cls(
            ...
            service_account_impersonation_options=info.get("service_account_impersonation") or {},
