...
async def timeout_guard(timeout):
    ...
    async def with_timeout(coro):
        try:
            ...
            raise TimeoutError(f"The operation {coro} exceeded the configured timeout of {total_timeout}s.") from e
...
class AsyncAuthorizedSession:
    ...
    async def request(
        ...
        **kwargs,
        ...
        retries = _exponential_backoff.AsyncExponentialBackoff(total_attempts=transport.DEFAULT_MAX_RETRY_ATTEMPTS)
        async with timeout_guard(max_allowed_time) as with_timeout:
            ...
            async for _ in retries:  # pragma: no branch
                response = await with_timeout(self._auth_request(url, method, data, headers, timeout, **kwargs))
    ...
    async def get(
        ...
        **kwargs,
        ...
        return await self.request("GET", url, data, headers, max_allowed_time, timeout, **kwargs)
    ...
    async def post(
        ...
        **kwargs,
        ...
        return await self.request("POST", url, data, headers, max_allowed_time, timeout, **kwargs)
    ...
    async def put(
        ...
        **kwargs,
        ...
        return await self.request("PUT", url, data, headers, max_allowed_time, timeout, **kwargs)
    ...
    async def patch(
        ...
        **kwargs,
        ...
        return await self.request("PATCH", url, data, headers, max_allowed_time, timeout, **kwargs)
    ...
    async def delete(
        ...
        **kwargs,
        ...
        return await self.request("DELETE", url, data, headers, max_allowed_time, timeout, **kwargs)
