...
class Response(transport.Response):
    ...
    async def content(self, chunk_size: int = 1024) -> AsyncGenerator[bytes, None]:
        try:
            ...
            raise exceptions.ResponseError("Failed to read from the payload stream.") from exc
    ...
    async def __call__(
        ...
        **kwargs,
        ...
        try:
            ...
            timeout_exc = exceptions.TimeoutError(f"Request timed out after {timeout} seconds.")
