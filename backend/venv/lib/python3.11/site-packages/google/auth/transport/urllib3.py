...
class AuthorizedHttp(RequestMethods):  # type: ignore
    ...
    def configure_mtls_channel(self, client_cert_callback=None):
        ...
        try:
            found_cert_key, cert, key = transport._mtls_helper.get_client_cert_and_key(client_cert_callback)
        ...
        if self._has_user_provided_http:
            self._has_user_provided_http = False
            warnings.warn("`http` provided in the constructor is overwritten", UserWarning)
