...
class OAuth2Session(requests.Session):
    ...
    def authorization_url(self, url, state=None, **kwargs):
        ...
        return (
            self._client.prepare_request_uri(url, redirect_uri=self.redirect_uri, scope=self.scope, state=state, **kwargs),
            state,
        )
        ...
        **kwargs,
        ...
        if self._pkce:
            if self._code_verifier is None:
                raise ValueError("Code verifier is not found, authorization URL must be generated before")
        ...
        body = self._client.prepare_request_body(
            code=code, body=body, redirect_uri=self.redirect_uri, include_client_id=include_client_id, **kwargs
        )
    ...
    def request(
        ...
        **kwargs,
        ...
        return super(OAuth2Session, self).request(method, url, headers=headers, data=data, files=files, **kwargs)
