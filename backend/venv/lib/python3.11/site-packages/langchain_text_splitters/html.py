...
class HTMLHeaderTextSplitter:
    ...
    def _generate_documents(self, html_content: str) -> Any:
        ...
        try:
            ...
            raise ImportError("Unable to import BeautifulSoup. Please install via `pip install bs4`.") from e
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        if xslt_path is None:
            self.xslt_path = (pathlib.Path(__file__).parent / "xsl/converting_to_header.xslt").absolute()
        else:
...
class HTMLSemanticPreservingSplitter(BaseDocumentTransformer):
    ...
    def _reinsert_preserved_elements(self, content: str, preserved_elements: dict) -> str:
