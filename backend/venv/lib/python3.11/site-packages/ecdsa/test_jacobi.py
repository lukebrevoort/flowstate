...
class TestJacobi(unittest.TestCase):
    ...
    @given(st.integers(min_value=0, max_value=int(generator_brainpoolp160r1.order() - 1)))
    ...
    @pytest.mark.skipif(
        ...
        reason="there are no signals on Windows, and threading breaks coverage" " on PyPy",
    )
