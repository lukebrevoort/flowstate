...
class TestPublicKey(unittest.TestCase):
    ...
    def test_public_key_with_generator_without_order(self):
        gen = ellipticcurve.PointJacobi(generator_192.curve(), generator_192.x(), generator_192.y(), 1)
...
def st_random_gen_key_msg_nonce(draw):
    ...
    nonce = draw(st.integers(min_value=1, max_value=order) | st.integers(min_value=order >> 1, max_value=order))
