...
class YamlConfigSettingsSource(InitSettingsSource, ConfigFileSourceMixin):
    ...
    def __init__(
        ...
        self.yaml_file_encoding = (
            yaml_file_encoding if yaml_file_encoding is not None else settings_cls.model_config.get("yaml_file_encoding")
        )
        self.yaml_config_section = (
            yaml_config_section if yaml_config_section is not None else settings_cls.model_config.get("yaml_config_section")
        )
        ...
        if self.yaml_config_section:
            try:
                ...
                raise KeyError(f'yaml_config_section key "{self.yaml_config_section}" not found in {self.yaml_file_path}')
