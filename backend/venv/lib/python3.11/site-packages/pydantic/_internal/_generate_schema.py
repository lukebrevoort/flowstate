...
class GenerateSchema:
            ...
            with self._config_wrapper_stack.push(config_wrapper), self._ns_resolver.push(cls):
                ...
                if cls.__pydantic_root_model__:
                    ...
                    fields_schema: core_schema.CoreSchema = core_schema.model_fields_schema(
                        ...
                        computed_fields=[
                            self._computed_field_schema(d, decorators.field_serializers) for d in computed_fields.values()
                        ],
    ...
    def _common_field_schema(self, name: str, field_info: FieldInfo, decorators: DecoratorInfos) -> _CommonField:  # C901
    ...
    def _arguments_v3_schema(
        ...
        mode_lookup: dict[_ParameterKind, Literal["positional_only", "positional_or_keyword", "var_args", "keyword_only"]] = {
            Parameter.POSITIONAL_ONLY: "positional_only",
            Parameter.POSITIONAL_OR_KEYWORD: "positional_or_keyword",
        ...
        if serializers:
            ...
            if serializer.info.return_type is not PydanticUndefined:
                ...
                try:
                    ...
                    # Instead, let `get_callable_return_type` infer the globals to use, but still pass
                    # in locals that may contain a parent/rebuild namespace:
                    return_type = _decorators.get_callable_return_type(serializer.func, localns=self._types_namespace.locals)
                except NameError as e:
                    raise PydanticUndefinedAnnotation.from_name_error(e) from e
