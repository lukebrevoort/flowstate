...
class ZstdCompressionParameters(object):
    @staticmethod
    def from_level(level: int, source_size: int = ..., dict_size: int = ..., **kwargs) -> "ZstdCompressionParameters": ...
    def __init__(
        self,
        format: int = ...,
...
class ZstdCompressor(object):
    ...
    def chunker(self, size: int = ..., chunk_size: int = ...) -> ZstdCompressionChunker: ...
    def copy_stream(
        self,
        ifh: IO[bytes],
        ofh: IO[bytes],
...
class ZstdDecompressor(object):
    ...
    def decompressobj(self, write_size: int = ..., read_across_frames: bool = False) -> ZstdDecompressionObj: ...
    def read_to_iter(
        self,
        reader: Union[IO[bytes], ByteString],
        read_size: int = ...,
    ...
    def decompress_content_dict_chain(self, frames: list[ByteString]) -> bytes: ...
