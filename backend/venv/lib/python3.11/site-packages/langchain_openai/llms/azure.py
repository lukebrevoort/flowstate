...
class AzureOpenAI(BaseOpenAI):
    ...
    azure_endpoint: Optional[str] = Field(default_factory=from_env("AZURE_OPENAI_ENDPOINT", default=None))
    ...
    azure_ad_token: Optional[SecretStr] = Field(default_factory=secret_from_env("AZURE_OPENAI_AD_TOKEN", default=None))
    ...
    """
    openai_api_type: Optional[str] = Field(default_factory=from_env("OPENAI_API_TYPE", default="azure"))
    ...
    def validate_environment(self) -> Self:
        ...
        client_params: dict = {
            ...
            "azure_ad_token": self.azure_ad_token.get_secret_value() if self.azure_ad_token else None,
