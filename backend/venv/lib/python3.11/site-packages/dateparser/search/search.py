...
class _ExactLanguageSearch:
    ...
    def search_parse(self, shortname, text, settings):
        ...
        parsed, substrings = self.parse_found_objects(
            parser=parser, to_parse=to_parse, original=original, translated=translated, settings=settings
        )
...
class DateSearchWithDetection:
    ...
    def search_dates(self, text, languages=None, settings=None, detect_languages_function=None):
        ...
        return {"Language": language_shortname, "Dates": self.search.search_parse(language_shortname, text, settings=settings)}
