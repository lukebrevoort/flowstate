info = {
    ...
    "relative-type-regex": {
        "\\1 day ago": ["for (\\d+[.,]?\\d*) dag siden", "for (\\d+[.,]?\\d*) dage siden"],
        "\\1 hour ago": [
            "for (\\d+[.,]?\\d*) time siden",
            "for (\\d+[.,]?\\d*) timer siden",
            "for (\\d+[.,]?\\d*)\\s*h",
        ...
        "\\1 week ago": ["for (\\d+[.,]?\\d*) uge siden", "for (\\d+[.,]?\\d*) uger siden"],
        "\\1 year ago": ["for (\\d+[.,]?\\d*) år siden"],
        "in \\1 day": ["om (\\d+[.,]?\\d*) dag", "om (\\d+[.,]?\\d*) dage"],
        "in \\1 hour": ["om (\\d+[.,]?\\d*) time", "om (\\d+[.,]?\\d*) timer"],
        "in \\1 minute": ["om (\\d+[.,]?\\d*) min", "om (\\d+[.,]?\\d*) minut", "om (\\d+[.,]?\\d*) minutter"],
        "in \\1 month": [
            "om (\\d+[.,]?\\d*) md",
            "om (\\d+[.,]?\\d*) mdr",
            "om (\\d+[.,]?\\d*) måned",
        ...
        "in \\1 week": ["om (\\d+[.,]?\\d*) uge", "om (\\d+[.,]?\\d*) uger"],
        "in \\1 year": ["om (\\d+[.,]?\\d*) år"],
    },
    "locale_specific": {"da-GL": {"name": "da-GL"}},
    "skip": ["cirka", "d.", "kl", "kl.", " ", "'", ",", "-", ".", "/", ";", "@", "[", "]", "|", "，"],
