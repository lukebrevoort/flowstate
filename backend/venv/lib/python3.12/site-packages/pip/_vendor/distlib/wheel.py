...
def compatible_tags():
    ...
    versions = [_Version(sys.version_info.major, minor_version) for minor_version in range(sys.version_info.minor, -1, -1)]
    abis = []
            ...
            for arch in arches:
                ...
                if abi != "none" and sys.platform.startswith("linux"):
                    ...
                    if len(parts) == 2:
                        ...
                        result.append(("".join((IMP_PREFIX, version)), abi, "manylinux_%s_%s_%s" % (parts[0], parts[1], arch)))
