...
class Table(JupyterMixin):
    ...
    def __rich_measure__(self, console: "Console", options: "ConsoleOptions") -> Measurement:
        ...
        maximum_width = (
            sum(measurement.maximum for measurement in measurements) + extra_width if (self.width is None) else self.width
        )
    ...
    def _render(self, console: "Console", options: "ConsoleOptions", widths: List[int]) -> "RenderResult":
        ...
        for index, (first, last, row_cell) in enumerate(loop_first_last(row_cells)):
            ...
            if _box:
                ...
                divider = (
                    _divider if _divider.text.strip() else _Segment(_divider.text, row_style.background_style + _divider.style)
                )
